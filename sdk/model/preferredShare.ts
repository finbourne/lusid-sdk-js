...
*/
export class PreferredShare extends LusidInstrument {
    /**
    ...
    */
    'instrumentType': PreferredShare.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PreferredShareAllOfIdentifiers"
        },
        {
            "name": "domCcy",
            "baseName": "domCcy",
        ...
        {
            "name": "callSchedule",
            "baseName": "callSchedule",
            "type": "OptionalitySchedule"
        },
        {
            "name": "cfiCode",
            "baseName": "cfiCode",
        ...
        {
            "name": "firstDividendDate",
            "baseName": "firstDividendDate",
            "type": "Date"
        },
        {
            "name": "isCumulative",
        ...
        },
        {
            ...
            "type": "PreferredShare.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PreferredShare.attributeTypeMap);
    }
}

export namespace PreferredShare {
