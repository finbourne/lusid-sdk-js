...
export class WarrantsExerciseEventAllOf {
    /**
    ...
    */
    'instrumentEventType': WarrantsExerciseEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "WarrantsExerciseEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return WarrantsExerciseEventAllOf.attributeTypeMap;
    }
}

export namespace WarrantsExerciseEventAllOf {
