...
*/
export class OptionExercisePhysicalEvent extends InstrumentEvent {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "OptionExercisePhysicalEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(OptionExercisePhysicalEvent.attributeTypeMap);
    }
}
