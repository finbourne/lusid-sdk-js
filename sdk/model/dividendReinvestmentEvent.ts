...
*/
export class DividendReinvestmentEvent extends InstrumentEvent {
    /**
    ...
    */
    'securitySettlementDate'?: Date | null;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "securityElections",
            "baseName": "securityElections",
            "type": "Array<SecurityElection>"
        },
        {
            "name": "securitySettlementDate",
            "baseName": "securitySettlementDate",
            "type": "Date"
        },
        {
            "name": "instrumentEventType",
            "baseName": "instrumentEventType",
            "type": "DividendReinvestmentEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(DividendReinvestmentEvent.attributeTypeMap);
    }
}
