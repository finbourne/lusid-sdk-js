...
*/
export class ConsentEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': ConsentEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ConsentEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ConsentEvent.attributeTypeMap);
    }
}
