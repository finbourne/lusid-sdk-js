...
export class LoanPrincipalRepaymentEventAllOf {
    /**
    ...
    */
    'instrumentEventType': LoanPrincipalRepaymentEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "withInterest",
            "baseName": "withInterest",
            "type": "boolean"
        },
        {
            "name": "instrumentEventType",
            "baseName": "instrumentEventType",
            "type": "LoanPrincipalRepaymentEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return LoanPrincipalRepaymentEventAllOf.attributeTypeMap;
    }
}

export namespace LoanPrincipalRepaymentEventAllOf {
