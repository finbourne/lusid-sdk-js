...
*/
export class FundShareClass extends LusidInstrument {
    /**
    ...
    */
    'fundShareClassType'?: string | null;
    /**
    ...
    */
    'distributionPaymentType'?: string | null;
    /**
    ...
    */
    'roundingConventionUnits'?: Array<SimpleRoundingConvention> | null;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "fundShareClassType",
            "baseName": "fundShareClassType",
            "type": "string"
        },
        {
            "name": "distributionPaymentType",
            "baseName": "distributionPaymentType",
            "type": "string"
        },
        {
        ...
        {
            "name": "roundingConventions",
            "baseName": "roundingConventions",
            "type": "Array<SimpleRoundingConvention>"
        },
        {
            "name": "roundingConventionUnits",
            "baseName": "roundingConventionUnits",
            "type": "Array<SimpleRoundingConvention>"
        },
        {
            "name": "tradingConventions",
            "baseName": "tradingConventions",
            "type": "TradingConventions"
        },
        {
            "name": "timeZoneConventions",
            "baseName": "timeZoneConventions",
            "type": "TimeZoneConventions"
        },
        {
            "name": "instrumentType",
            "baseName": "instrumentType",
            "type": "FundShareClass.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FundShareClass.attributeTypeMap);
    }
}
...
export namespace FundShareClass {
    export enum InstrumentTypeEnum {
        ...
        UnsettledCash = <any> 'UnsettledCash',
        Cash = <any> 'Cash',
        MasteredInstrument = <any> 'MasteredInstrument',
        LoanFacility = <any> 'LoanFacility',
        FlexibleDeposit = <any> 'FlexibleDeposit',
        FlexibleRepo = <any> 'FlexibleRepo',
        ToBeAnnounced = <any> 'ToBeAnnounced',
        VolatilitySwap = <any> 'VolatilitySwap',
        ToBeAnnouncedOption = <any> 'ToBeAnnouncedOption',
        CommodityForward = <any> 'CommodityForward',
        BondOption = <any> 'BondOption',
        CdsOption = <any> 'CdsOption',
        CommodityCalendarSwap = <any> 'CommodityCalendarSwap',
        BondForward = <any> 'BondForward',
        PreferredShare = <any> 'PreferredShare',
        CapitalInterest = <any> 'CapitalInterest'
    }
}
