...
export class IntermediateSecuritiesDistributionEventAllOf {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "IntermediateSecuritiesDistributionEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return IntermediateSecuritiesDistributionEventAllOf.attributeTypeMap;
    }
}
