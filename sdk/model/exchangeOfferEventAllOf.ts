...
export class ExchangeOfferEventAllOf {
    'effectiveDate'?: Date;
    'settlementDate'?: Date;
    'eventSource': string;
    ...
    */
    'mixedLotConstituentsElections'?: Array<MixedLotConstituentsElection> | null;
    /**
    ...
    */
    'consentAndExchangeElections'?: Array<ConsentAndExchangeElection> | null;
    /**
    ...
    */
    'abstainElections'?: Array<AbstainElection> | null;
    /**
    ...
    */
    'unknownProceedsElections'?: Array<UnknownProceedsElection> | null;
    'minPieceSize'?: number | null;
    ...
    */
    'instrumentEventType': ExchangeOfferEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "newInstrument",
            "baseName": "newInstrument",
            "type": "NewInstrument"
        },
        {
            "name": "cashOfferElections",
            "baseName": "cashOfferElections",
            "type": "Array<CashOfferElection>"
        },
        {
            "name": "securityOfferElections",
            "baseName": "securityOfferElections",
            "type": "Array<SecurityOfferElection>"
        },
        {
            "name": "mixedLotConstituentsElections",
            "baseName": "mixedLotConstituentsElections",
            "type": "Array<MixedLotConstituentsElection>"
        },
        {
            "name": "lapseElections",
            "baseName": "lapseElections",
            "type": "Array<LapseElection>"
        },
        {
            "name": "cashAndSecurityOfferElections",
            "baseName": "cashAndSecurityOfferElections",
            "type": "Array<CashAndSecurityOfferElection>"
        },
        {
            "name": "consentAndExchangeElections",
            "baseName": "consentAndExchangeElections",
            "type": "Array<ConsentAndExchangeElection>"
        },
        {
            "name": "abstainElections",
            "baseName": "abstainElections",
            "type": "Array<AbstainElection>"
        },
        {
            "name": "unknownProceedsElections",
            "baseName": "unknownProceedsElections",
            "type": "Array<UnknownProceedsElection>"
        },
        {
            "name": "minPieceSize",
            "baseName": "minPieceSize",
            "type": "number"
        },
        {
            "name": "minIncrement",
        ...
        {
            "name": "fractionalUnitsCashPrice",
            "baseName": "fractionalUnitsCashPrice",
            "type": "number"
        },
        {
            "name": "fractionalUnitsCashCurrency",
            "baseName": "fractionalUnitsCashCurrency",
            "type": "string"
        },
        {
            "name": "fractionalUnitsRoundingConvention",
            "baseName": "fractionalUnitsRoundingConvention",
            "type": "string"
        },
        {
            "name": "fractionalUnitsDecimalPlaces",
            "baseName": "fractionalUnitsDecimalPlaces",
            "type": "number"
        },
        {
            "name": "instructionReference",
            "baseName": "instructionReference",
            "type": "string"
        },
        {
            "name": "instrumentEventType",
            "baseName": "instrumentEventType",
            "type": "ExchangeOfferEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return ExchangeOfferEventAllOf.attributeTypeMap;
    }
}

export namespace ExchangeOfferEventAllOf {
    export enum InstrumentEventTypeEnum {
        ...
        EarlyRedemptionEvent = <any> 'EarlyRedemptionEvent',
        FutureMarkToMarketEvent = <any> 'FutureMarkToMarketEvent',
        AdjustGlobalCommitmentEvent = <any> 'AdjustGlobalCommitmentEvent',
        ContractInitialisationEvent = <any> 'ContractInitialisationEvent',
        DrawdownEvent = <any> 'DrawdownEvent',
        LoanInterestRepaymentEvent = <any> 'LoanInterestRepaymentEvent',
        UpdateDepositAmountEvent = <any> 'UpdateDepositAmountEvent',
        LoanPrincipalRepaymentEvent = <any> 'LoanPrincipalRepaymentEvent',
        DepositInterestPaymentEvent = <any> 'DepositInterestPaymentEvent',
        DepositCloseEvent = <any> 'DepositCloseEvent',
        LoanFacilityContractRolloverEvent = <any> 'LoanFacilityContractRolloverEvent',
        RepurchaseOfferEvent = <any> 'RepurchaseOfferEvent',
        RepoPartialClosureEvent = <any> 'RepoPartialClosureEvent',
        RepoCashFlowEvent = <any> 'RepoCashFlowEvent',
        FlexibleRepoInterestPaymentEvent = <any> 'FlexibleRepoInterestPaymentEvent',
        FlexibleRepoCashFlowEvent = <any> 'FlexibleRepoCashFlowEvent',
        FlexibleRepoCollateralEvent = <any> 'FlexibleRepoCollateralEvent',
        ConversionEvent = <any> 'ConversionEvent',
        FlexibleRepoPartialClosureEvent = <any> 'FlexibleRepoPartialClosureEvent',
        FlexibleRepoFullClosureEvent = <any> 'FlexibleRepoFullClosureEvent',
        CapletFloorletCashFlowEvent = <any> 'CapletFloorletCashFlowEvent',
        EarlyCloseOutEvent = <any> 'EarlyCloseOutEvent',
        DepositRollEvent = <any> 'DepositRollEvent',
        ConsentEvent = <any> 'ConsentEvent',
        DrawingEvent = <any> 'DrawingEvent',
        CapitalGainsDistributionEvent = <any> 'CapitalGainsDistributionEvent',
        ExchangeOfferEvent = <any> 'ExchangeOfferEvent',
        DutchAuctionEvent = <any> 'DutchAuctionEvent',
        WorthlessEvent = <any> 'WorthlessEvent',
        PutRedemptionEvent = <any> 'PutRedemptionEvent',
        LoanFacilityDelayedCompensationPaymentEvent = <any> 'LoanFacilityDelayedCompensationPaymentEvent',
        InterestPaymentEvent = <any> 'InterestPaymentEvent',
        PriorityIssueEvent = <any> 'PriorityIssueEvent',
        ClassActionEvent = <any> 'ClassActionEvent',
        BankruptcyEvent = <any> 'BankruptcyEvent',
        LiquidationPaymentEvent = <any> 'LiquidationPaymentEvent',
        PartialDefeasanceEvent = <any> 'PartialDefeasanceEvent',
        SecurityWriteOffEvent = <any> 'SecurityWriteOffEvent',
        WarrantsExerciseEvent = <any> 'WarrantsExerciseEvent',
        PariPassuEvent = <any> 'PariPassuEvent',
        ChangeEvent = <any> 'ChangeEvent',
        PikBondCouponEvent = <any> 'PikBondCouponEvent',
        PikBondCashCouponEvent = <any> 'PikBondCashCouponEvent',
        PikBondInterestCapitalisationEvent = <any> 'PikBondInterestCapitalisationEvent',
        PikBondPrincipalEvent = <any> 'PikBondPrincipalEvent',
        DelistingEvent = <any> 'DelistingEvent',
        PikBondInterestEvent = <any> 'PikBondInterestEvent',
        CommodityForwardCashSettlementEvent = <any> 'CommodityForwardCashSettlementEvent',
        PaymentInKindEvent = <any> 'PaymentInKindEvent',
        CommodityForwardPhysicalSettlementEvent = <any> 'CommodityForwardPhysicalSettlementEvent',
        CancelSwapEvent = <any> 'CancelSwapEvent',
        BondOptionTerminationEvent = <any> 'BondOptionTerminationEvent',
        TerminationEvent = <any> 'TerminationEvent',
        CommodityCalendarSwapCashFlowEvent = <any> 'CommodityCalendarSwapCashFlowEvent',
        DepositSweepEvent = <any> 'DepositSweepEvent',
        BondForwardCashSettlementEvent = <any> 'BondForwardCashSettlementEvent',
        BondForwardTerminationEvent = <any> 'BondForwardTerminationEvent',
        AmendCommitmentEvent = <any> 'AmendCommitmentEvent',
        CapitalCallEvent = <any> 'CapitalCallEvent',
        FundDistributionEvent = <any> 'FundDistributionEvent',
        NavReportEvent = <any> 'NavReportEvent',
        DividendSuspensionEvent = <any> 'DividendSuspensionEvent',
        LoanInterestCapitalisationEvent = <any> 'LoanInterestCapitalisationEvent',
        TotalReturnSwapCashFlowEvent = <any> 'TotalReturnSwapCashFlowEvent'
    }
}
