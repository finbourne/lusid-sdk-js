...
*/
export class FxForwardCurveByQuoteReference extends ComplexMarketData {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FxForwardCurveByQuoteReference.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FxForwardCurveByQuoteReference.attributeTypeMap);
    }
}
