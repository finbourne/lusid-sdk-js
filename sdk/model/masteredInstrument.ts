...
*/
export class MasteredInstrument extends LusidInstrument {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "masteredDomCcy",
            "baseName": "masteredDomCcy",
            "type": "string"
        },
        {
            "name": "masteredInstrumentType",
            "baseName": "masteredInstrumentType",
            "type": "string"
        },
        {
            "name": "masteredLusidInstrumentId",
            "baseName": "masteredLusidInstrumentId",
            "type": "string"
        },
        {
            "name": "masteredName",
            "baseName": "masteredName",
            "type": "string"
        },
        {
            "name": "masteredScope",
            "baseName": "masteredScope",
            "type": "string"
        },
        {
            "name": "instrumentType",
            "baseName": "instrumentType",
            "type": "MasteredInstrument.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(MasteredInstrument.attributeTypeMap);
    }
}
