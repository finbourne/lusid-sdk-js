...
export class CommodityCalendarSwapCashFlowEventAllOf {
    /**
    ...
    */
    'instrumentEventType': CommodityCalendarSwapCashFlowEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "cashFlowAmount",
            "baseName": "cashFlowAmount",
            "type": "number"
        },
        {
            "name": "instrumentEventType",
            "baseName": "instrumentEventType",
            "type": "CommodityCalendarSwapCashFlowEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return CommodityCalendarSwapCashFlowEventAllOf.attributeTypeMap;
    }
}

export namespace CommodityCalendarSwapCashFlowEventAllOf {
