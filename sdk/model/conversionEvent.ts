...
*/
export class ConversionEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': ConversionEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ConversionEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ConversionEvent.attributeTypeMap);
    }
}
