...
export class BankruptcyEventAllOf {
    /**
    ...
    */
    'instrumentEventType': BankruptcyEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "BankruptcyEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return BankruptcyEventAllOf.attributeTypeMap;
    }
}

export namespace BankruptcyEventAllOf {
