...
export class Transaction {
    ...
    */
    'entityLinks'?: Array<TransactionEntityLink> | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "resolvedTransactionTypeDetails",
            "baseName": "resolvedTransactionTypeDetails",
        ...
        {
            "name": "entityLinks",
            "baseName": "entityLinks",
            "type": "Array<TransactionEntityLink>"
        }    ];
...
export namespace Transaction {
    export enum TransactionStatusEnum {
        ...
        ActiveReversal = <any> 'ActiveReversal',
        ActiveTrueUp = <any> 'ActiveTrueUp',
        CancelledTrueUp = <any> 'CancelledTrueUp'
    }
}
