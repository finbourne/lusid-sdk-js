...
export class InterestPaymentEventAllOf {
    /**
    ...
    */
    'instrumentEventType': InterestPaymentEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "InterestPaymentEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return InterestPaymentEventAllOf.attributeTypeMap;
    }
}

export namespace InterestPaymentEventAllOf {
