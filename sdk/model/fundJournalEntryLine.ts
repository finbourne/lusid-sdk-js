...
export class FundJournalEntryLine {
    ...
    */
    'custodianAccountType'?: string | null;
    /**
    ...
    */
    'bucketMemberships'?: Array<BucketMembership> | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "custodianAccountType",
            "baseName": "custodianAccountType",
            "type": "string"
        },
        {
            "name": "bucketMemberships",
            "baseName": "bucketMemberships",
            "type": "Array<BucketMembership>"
        },
        {
            "name": "links",
            "baseName": "links",
