...
*/
export class PriorityIssueEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': PriorityIssueEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PriorityIssueEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PriorityIssueEvent.attributeTypeMap);
    }
}

export namespace PriorityIssueEvent {
