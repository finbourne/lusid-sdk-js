...
export class FlowConventions {
    ...
    */
    'accrualDayCountConvention'?: string | null;
    'couponPaymentLag'?: RelativeDateOffset;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "accrualDayCountConvention",
            "baseName": "accrualDayCountConvention",
            "type": "string"
        },
        {
            "name": "couponPaymentLag",
            "baseName": "couponPaymentLag",
            "type": "RelativeDateOffset"
        },
        {
            "name": "scope",
            "baseName": "scope",
