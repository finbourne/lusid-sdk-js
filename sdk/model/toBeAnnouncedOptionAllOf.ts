...
export class ToBeAnnouncedOptionAllOf {
    /**
    ...
    */
    'instrumentType': ToBeAnnouncedOptionAllOf.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "settlementCalendars",
            "baseName": "settlementCalendars",
            "type": "Array<string>"
        },
        {
        ...
        },
        {
            ...
            "type": "ToBeAnnouncedOptionAllOf.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return ToBeAnnouncedOptionAllOf.attributeTypeMap;
    }
}

export namespace ToBeAnnouncedOptionAllOf {
