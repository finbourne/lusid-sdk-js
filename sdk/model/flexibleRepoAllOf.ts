...
export class FlexibleRepoAllOf {
    /**
    ...
    */
    'instrumentType': FlexibleRepoAllOf.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FlexibleRepoAllOf.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return FlexibleRepoAllOf.attributeTypeMap;
    }
}

export namespace FlexibleRepoAllOf {
