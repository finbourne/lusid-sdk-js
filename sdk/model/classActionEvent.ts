...
*/
export class ClassActionEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': ClassActionEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ClassActionEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ClassActionEvent.attributeTypeMap);
    }
}

export namespace ClassActionEvent {
