...
*/
export class PikBondInterestEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': PikBondInterestEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PikBondInterestEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PikBondInterestEvent.attributeTypeMap);
    }
}

export namespace PikBondInterestEvent {
