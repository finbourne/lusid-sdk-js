...
export class EarlyCloseOutEventAllOf {
    /**
    ...
    */
    'instrumentEventType': EarlyCloseOutEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "EarlyCloseOutEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return EarlyCloseOutEventAllOf.attributeTypeMap;
    }
}

export namespace EarlyCloseOutEventAllOf {
