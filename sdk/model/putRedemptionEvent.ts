...
*/
export class PutRedemptionEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': PutRedemptionEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PutRedemptionEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(PutRedemptionEvent.attributeTypeMap);
    }
}

export namespace PutRedemptionEvent {
