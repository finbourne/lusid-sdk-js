...
* Merger Event (MRGR).
*/
export class MergerEvent extends InstrumentEvent {
    /**
    ...
    */
    'cashElections'?: Array<CashOfferElection> | null;
    /**
    ...
    */
    'securityElections'?: Array<SecurityOfferElection> | null;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "MergerEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(MergerEvent.attributeTypeMap);
    }
}
