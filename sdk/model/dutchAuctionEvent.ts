...
*/
export class DutchAuctionEvent extends InstrumentEvent {
    /**
    ...
    */
    'tenderOfferElections'?: Array<TenderOfferElection> | null;
    /**
    ...
    */
    'instrumentEventType': DutchAuctionEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DutchAuctionEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(DutchAuctionEvent.attributeTypeMap);
    }
}

export namespace DutchAuctionEvent {
