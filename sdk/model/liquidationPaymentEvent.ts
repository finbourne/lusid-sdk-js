...
*/
export class LiquidationPaymentEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': LiquidationPaymentEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "LiquidationPaymentEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(LiquidationPaymentEvent.attributeTypeMap);
    }
}

export namespace LiquidationPaymentEvent {
