...
export class ChangeEventAllOf {
    ...
    */
    'instrumentEventType': ChangeEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ChangeEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return ChangeEventAllOf.attributeTypeMap;
    }
}

export namespace ChangeEventAllOf {
