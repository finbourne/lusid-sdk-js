...
*/
export class PortfolioReturnBreakdown {
    ...
    */
    'localRateOfReturn'?: number | null;
    /**
    * The opening market value in the local currency.
    */
    'localOpeningMarketValue'?: number | null;
    /**
    * The closing market value in the local currency.
    */
    'localClosingMarketValue'?: number | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "constituentsInTheComposite",
            "baseName": "constituentsInTheComposite",
            "type": "number"
        },
        {
            "name": "constituentsMissing",
            "baseName": "constituentsMissing",
            "type": "number"
        },
        {
            "name": "currency",
        ...
        {
            "name": "closeFxRate",
            "baseName": "closeFxRate",
            "type": "number"
        },
        {
            "name": "localRateOfReturn",
            "baseName": "localRateOfReturn",
            "type": "number"
        },
        {
            "name": "localOpeningMarketValue",
            "baseName": "localOpeningMarketValue",
            "type": "number"
        },
        {
            "name": "localClosingMarketValue",
            "baseName": "localClosingMarketValue",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return PortfolioReturnBreakdown.attributeTypeMap;
    }
}
