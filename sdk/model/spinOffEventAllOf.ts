...
export class SpinOffEventAllOf {
    /**
    ...
    */
    'instrumentEventType': SpinOffEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SpinOffEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return SpinOffEventAllOf.attributeTypeMap;
    }
}

export namespace SpinOffEventAllOf {
