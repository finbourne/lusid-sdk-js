...
export namespace PropertyDefinitionSearchResult {
    ...
    export enum DomainEnum {
        ...
        InvestorRecord = <any> 'InvestorRecord',
        ...
        CheckDefinition = <any> 'CheckDefinition',
        Abor = <any> 'Abor',
        AborConfiguration = <any> 'AborConfiguration',
        Fund = <any> 'Fund',
        FundConfiguration = <any> 'FundConfiguration',
        FundStructure = <any> 'FundStructure',
        Fee = <any> 'Fee',
        ...
        ClosedPeriod = <any> 'ClosedPeriod',
        AddressKeyDefinition = <any> 'AddressKeyDefinition',
        AmortisationRuleSet = <any> 'AmortisationRuleSet',
        AnalyticsSetInventory = <any> 'AnalyticsSetInventory',
        AtomUnitResult = <any> 'AtomUnitResult',
        CleardownModule = <any> 'CleardownModule',
        ComplexMarketData = <any> 'ComplexMarketData',
        ComplianceRunSummary = <any> 'ComplianceRunSummary',
        ComplianceRule = <any> 'ComplianceRule',
        ComplianceRunInfo = <any> 'ComplianceRunInfo',
        CorporateActionSource = <any> 'CorporateActionSource',
        CounterpartyAgreement = <any> 'CounterpartyAgreement',
        CustomEntityDefinition = <any> 'CustomEntityDefinition',
        DataType = <any> 'DataType',
        Dialect = <any> 'Dialect',
        EventHandler = <any> 'EventHandler',
        GeneralLedgerProfile = <any> 'GeneralLedgerProfile',
        PostingModule = <any> 'PostingModule',
        Quote = <any> 'Quote',
        RecipeComposer = <any> 'RecipeComposer',
        ReconciliationRunBreak = <any> 'ReconciliationRunBreak',
        ReferenceList = <any> 'ReferenceList',
        RelationDefinition = <any> 'RelationDefinition',
        ReturnBlockIndex = <any> 'ReturnBlockIndex',
        SrsDocument = <any> 'SRSDocument',
        SrsIndex = <any> 'SRSIndex',
        TransactionTemplate = <any> 'TransactionTemplate',
        TransactionTemplateScope = <any> 'TransactionTemplateScope',
        TransactionType = <any> 'TransactionType',
        TransactionTypeConfig = <any> 'TransactionTypeConfig',
        TranslationScript = <any> 'TranslationScript',
        TaskDefinition = <any> 'TaskDefinition',
        TaskInstance = <any> 'TaskInstance',
        Worker = <any> 'Worker',
        Workflow = <any> 'Workflow',
        StagingRuleSet = <any> 'StagingRuleSet',
        IdentifierDefinition = <any> 'IdentifierDefinition',
        SettlementInstruction = <any> 'SettlementInstruction',
        TransactionFeeType = <any> 'TransactionFeeType',
        AllocationMethod = <any> 'AllocationMethod',
        TransactionFee = <any> 'TransactionFee',
        Subscription = <any> 'Subscription',
        ScenarioDefinition = <any> 'ScenarioDefinition',
        PaymentInstruction = <any> 'PaymentInstruction',
        Transfer = <any> 'Transfer',
        CurrencyGroup = <any> 'CurrencyGroup',
        RecDefinition = <any> 'RecDefinition',
        RecResult = <any> 'RecResult'
    }
