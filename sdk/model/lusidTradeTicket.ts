...
export class LusidTradeTicket {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "counterpartyAgreementId",
            "baseName": "counterpartyAgreementId",
            "type": "ResourceId"
        },
        {
            "name": "counterparty",
        ...
        },
        {
            ...
            "baseName": "transactionProperties",
            "type": "Array<Property>"
        },
        {
            "name": "tradeTicketType",
            "baseName": "tradeTicketType",
            "type": "LusidTradeTicket.TradeTicketTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return LusidTradeTicket.attributeTypeMap;
    }
}

export namespace LusidTradeTicket {
    export enum TradeTicketTypeEnum {
        LusidTradeTicket = <any> 'LusidTradeTicket',
        ExternalTradeTicket = <any> 'ExternalTradeTicket'
    }
}
