...
export class MarketDataSpecificRule {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "fallThroughOnAccessDenied",
            "baseName": "fallThroughOnAccessDenied",
            "type": "boolean"
        }    ];
...
export namespace MarketDataSpecificRule {
    export enum QuoteTypeEnum {
        ...
        DirtyPrice = <any> 'DirtyPrice',
        PrincipalWriteOff = <any> 'PrincipalWriteOff',
        InterestDeferred = <any> 'InterestDeferred',
        InterestShortfall = <any> 'InterestShortfall'
    }
}
