...
export class PreferredShareAllOf {
    /**
    ...
    */
    'instrumentType': PreferredShareAllOf.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PreferredShareAllOf.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return PreferredShareAllOf.attributeTypeMap;
    }
}

export namespace PreferredShareAllOf {
