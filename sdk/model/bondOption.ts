...
*/
export class BondOption extends LusidInstrument {
    /**
    ...
    */
    'instrumentType': BondOption.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "BondOption.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BondOption.attributeTypeMap);
    }
}

export namespace BondOption {
