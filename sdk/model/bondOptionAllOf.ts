...
export class BondOptionAllOf {
    ...
    */
    'instrumentType': BondOptionAllOf.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "BondOptionAllOf.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return BondOptionAllOf.attributeTypeMap;
    }
}

export namespace BondOptionAllOf {
