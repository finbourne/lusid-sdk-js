...
export class ConversionEventAllOf {
    /**
    ...
    */
    'instrumentEventType': ConversionEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ConversionEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return ConversionEventAllOf.attributeTypeMap;
    }
}

export namespace ConversionEventAllOf {
