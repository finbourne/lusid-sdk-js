...
export class PartialDefeasanceEventAllOf {
    /**
    ...
    */
    'instrumentEventType': PartialDefeasanceEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PartialDefeasanceEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return PartialDefeasanceEventAllOf.attributeTypeMap;
    }
}

export namespace PartialDefeasanceEventAllOf {
