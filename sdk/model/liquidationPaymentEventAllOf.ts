...
export class LiquidationPaymentEventAllOf {
    /**
    ...
    */
    'instrumentEventType': LiquidationPaymentEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "LiquidationPaymentEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return LiquidationPaymentEventAllOf.attributeTypeMap;
    }
}

export namespace LiquidationPaymentEventAllOf {
