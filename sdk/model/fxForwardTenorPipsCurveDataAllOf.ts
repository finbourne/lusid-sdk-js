...
export class FxForwardTenorPipsCurveDataAllOf {
    ...
    */
    ...
    /**
    * Configures how to calculate the spot date from the build date using the Calendars provided.
    */
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "marketDataOptions",
            "baseName": "marketDataOptions",
            "type": "MarketDataOptions"
        },
        {
            "name": "calendars",
            "baseName": "calendars",
            "type": "Array<FxTenorConvention>"
        },
        {
            "name": "spotDaysCalculationType",
            "baseName": "spotDaysCalculationType",
            "type": "string"
        },
        {
            "name": "marketDataType",
