...
*/
export class CallOnIntermediateSecuritiesEvent extends InstrumentEvent {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "oversubscribeElections",
            "baseName": "oversubscribeElections",
            "type": "Array<OversubscribeElection>"
        },
        {
            "name": "sellEntitlementElections",
            "baseName": "sellEntitlementElections",
            "type": "Array<SellEntitlementElection>"
        },
        {
        ...
        },
        {
            ...
            "type": "CallOnIntermediateSecuritiesEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CallOnIntermediateSecuritiesEvent.attributeTypeMap);
    }
}
