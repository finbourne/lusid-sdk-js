...
export class PortfolioHolding {
    ...
    */
    ...
    'notionalCost'?: CurrencyAndAmount;
    'amortisedCost'?: CurrencyAndAmount;
    'amortisedCostPortfolioCcy'?: CurrencyAndAmount;
    'variationMargin'?: CurrencyAndAmount;
    'variationMarginPortfolioCcy'?: CurrencyAndAmount;
    /**
    * Where no. of days ahead has been specified, future dated settlements will be captured here.
    */
    'settlementSchedule'?: Array<SettlementSchedule> | null;
    /**
    ...
    */
    'holdingPropertyBalances'?: { [key: string]: number; } | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "notionalCost",
            "baseName": "notionalCost",
            "type": "CurrencyAndAmount"
        },
        {
            "name": "amortisedCost",
            "baseName": "amortisedCost",
            "type": "CurrencyAndAmount"
        },
        {
            "name": "amortisedCostPortfolioCcy",
            "baseName": "amortisedCostPortfolioCcy",
            "type": "CurrencyAndAmount"
        },
        {
            "name": "variationMargin",
            "baseName": "variationMargin",
            "type": "CurrencyAndAmount"
        },
        {
            "name": "variationMarginPortfolioCcy",
            "baseName": "variationMarginPortfolioCcy",
            "type": "CurrencyAndAmount"
        },
        {
            "name": "settlementSchedule",
            "baseName": "settlementSchedule",
            "type": "Array<SettlementSchedule>"
        },
        {
            "name": "currentFace",
            "baseName": "currentFace",
            "type": "number"
        },
        {
        ...
        {
            "name": "unsettledUnits",
            "baseName": "unsettledUnits",
            "type": "number"
        },
        {
            "name": "overdueUnits",
            "baseName": "overdueUnits",
            "type": "number"
        },
        {
        ...
        {
            "name": "resolvedCustodianAccount",
            "baseName": "resolvedCustodianAccount",
            "type": "ResolvedCustodianAccount"
        },
        {
            "name": "holdingPropertyBalances",
            "baseName": "holdingPropertyBalances",
