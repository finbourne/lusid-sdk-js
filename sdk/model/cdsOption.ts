...
*/
export class CdsOption extends LusidInstrument {
    /**
    ...
    */
    'instrumentType': CdsOption.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CdsOption.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CdsOption.attributeTypeMap);
    }
}

export namespace CdsOption {
