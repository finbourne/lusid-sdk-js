...
*/
export class TransitionEvent extends InstrumentEvent {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "Array<OutputTransition>"
        },
        {
            "name": "instrumentEventType",
            "baseName": "instrumentEventType",
            "type": "TransitionEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(TransitionEvent.attributeTypeMap);
    }
}
