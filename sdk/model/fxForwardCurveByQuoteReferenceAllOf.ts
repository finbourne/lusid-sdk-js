...
export class FxForwardCurveByQuoteReferenceAllOf {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "quoteReferences",
            "baseName": "quoteReferences",
        ...
        },
        {
            ...
            "type": "FxForwardCurveByQuoteReferenceAllOf.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return FxForwardCurveByQuoteReferenceAllOf.attributeTypeMap;
    }
}
