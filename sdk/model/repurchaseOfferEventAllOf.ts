...
export class RepurchaseOfferEventAllOf {
    /**
    ...
    */
    'instrumentEventType': RepurchaseOfferEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "RepurchaseOfferEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return RepurchaseOfferEventAllOf.attributeTypeMap;
    }
}

export namespace RepurchaseOfferEventAllOf {
