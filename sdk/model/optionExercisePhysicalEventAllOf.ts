...
export class OptionExercisePhysicalEventAllOf {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "OptionExercisePhysicalEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return OptionExercisePhysicalEventAllOf.attributeTypeMap;
    }
}
