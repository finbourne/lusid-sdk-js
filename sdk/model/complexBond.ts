...
*/
export class ComplexBond extends LusidInstrument {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "assetBacked",
            "baseName": "assetBacked",
            "type": "boolean"
        },
        {
            "name": "assetPoolIdentifier",
            "baseName": "assetPoolIdentifier",
            "type": "string"
        },
        {
        ...
        },
        {
            ...
            "type": "ComplexBond.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ComplexBond.attributeTypeMap);
    }
}
