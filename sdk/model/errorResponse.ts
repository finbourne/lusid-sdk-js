...
export namespace ErrorResponse {
    export enum CodeEnum {
        Unknown = <any> 'Unknown',
        VersionNotFound = <any> 'VersionNotFound',
        InstrumentNotFound = <any> 'InstrumentNotFound',
        PropertyNotFound = <any> 'PropertyNotFound',
        PortfolioRecursionDepth = <any> 'PortfolioRecursionDepth',
        GroupNotFound = <any> 'GroupNotFound',
        PortfolioNotFound = <any> 'PortfolioNotFound',
        PropertySchemaNotFound = <any> 'PropertySchemaNotFound',
        PortfolioAncestryNotFound = <any> 'PortfolioAncestryNotFound',
        PortfolioWithIdAlreadyExists = <any> 'PortfolioWithIdAlreadyExists',
        OrphanedPortfolio = <any> 'OrphanedPortfolio',
        MissingBaseClaims = <any> 'MissingBaseClaims',
        PropertyNotDefined = <any> 'PropertyNotDefined',
        CannotDeleteSystemProperty = <any> 'CannotDeleteSystemProperty',
        CannotModifyImmutablePropertyField = <any> 'CannotModifyImmutablePropertyField',
        PropertyAlreadyExists = <any> 'PropertyAlreadyExists',
        InvalidPropertyLifeTime = <any> 'InvalidPropertyLifeTime',
        CannotModifyDefaultDataType = <any> 'CannotModifyDefaultDataType',
        GroupAlreadyExists = <any> 'GroupAlreadyExists',
        NoSuchDataType = <any> 'NoSuchDataType',
        ValidationError = <any> 'ValidationError',
        LoopDetectedInGroupHierarchy = <any> 'LoopDetectedInGroupHierarchy',
        SubGroupAlreadyExists = <any> 'SubGroupAlreadyExists',
        PriceSourceNotFound = <any> 'PriceSourceNotFound',
        AnalyticStoreNotFound = <any> 'AnalyticStoreNotFound',
        AnalyticStoreAlreadyExists = <any> 'AnalyticStoreAlreadyExists',
        ClientInstrumentAlreadyExists = <any> 'ClientInstrumentAlreadyExists',
        DuplicateInParameterSet = <any> 'DuplicateInParameterSet',
        ResultsNotFound = <any> 'ResultsNotFound',
        OrderFieldNotInResultSet = <any> 'OrderFieldNotInResultSet',
        OperationFailed = <any> 'OperationFailed',
        ElasticSearchError = <any> 'ElasticSearchError',
        InvalidParameterValue = <any> 'InvalidParameterValue',
        CommandProcessingFailure = <any> 'CommandProcessingFailure',
        EntityStateConstructionFailure = <any> 'EntityStateConstructionFailure',
        EntityTimelineDoesNotExist = <any> 'EntityTimelineDoesNotExist',
        EventPublishFailure = <any> 'EventPublishFailure',
        InvalidRequestFailure = <any> 'InvalidRequestFailure',
        EventPublishUnknown = <any> 'EventPublishUnknown',
        EventQueryFailure = <any> 'EventQueryFailure',
        BlobDidNotExistFailure = <any> 'BlobDidNotExistFailure',
        SubSystemRequestFailure = <any> 'SubSystemRequestFailure',
        SubSystemConfigurationFailure = <any> 'SubSystemConfigurationFailure',
        FailedToDelete = <any> 'FailedToDelete',
        UpsertClientInstrumentFailure = <any> 'UpsertClientInstrumentFailure',
        IllegalAsAtInterval = <any> 'IllegalAsAtInterval',
        IllegalBitemporalQuery = <any> 'IllegalBitemporalQuery',
        InvalidAlternateId = <any> 'InvalidAlternateId',
        CannotAddSourcePortfolioPropertyExplicitly = <any> 'CannotAddSourcePortfolioPropertyExplicitly',
        EntityAlreadyExistsInGroup = <any> 'EntityAlreadyExistsInGroup',
        EntityWithIdAlreadyExists = <any> 'EntityWithIdAlreadyExists',
        DerivedPortfolioDetailsDoNotExist = <any> 'DerivedPortfolioDetailsDoNotExist',
        PortfolioWithNameAlreadyExists = <any> 'PortfolioWithNameAlreadyExists',
        InvalidTransactions = <any> 'InvalidTransactions',
        ReferencePortfolioNotFound = <any> 'ReferencePortfolioNotFound',
        DuplicateIdFailure = <any> 'DuplicateIdFailure',
        CommandRetrievalFailure = <any> 'CommandRetrievalFailure',
        DataFilterApplicationFailure = <any> 'DataFilterApplicationFailure',
        SearchFailed = <any> 'SearchFailed',
        MovementsEngineConfigurationKeyFailure = <any> 'MovementsEngineConfigurationKeyFailure',
        FxRateSourceNotFound = <any> 'FxRateSourceNotFound',
        AccrualSourceNotFound = <any> 'AccrualSourceNotFound',
        EntitlementsFailure = <any> 'EntitlementsFailure',
        InvalidIdentityToken = <any> 'InvalidIdentityToken',
        InvalidRequestHeaders = <any> 'InvalidRequestHeaders',
        PriceNotFound = <any> 'PriceNotFound',
        InvalidSubHoldingKeysProvided = <any> 'InvalidSubHoldingKeysProvided',
        DuplicateSubHoldingKeysProvided = <any> 'DuplicateSubHoldingKeysProvided',
        CutDefinitionNotFound = <any> 'CutDefinitionNotFound',
        CutDefinitionInvalid = <any> 'CutDefinitionInvalid',
        ServerConfigurationError = <any> 'ServerConfigurationError',
        InvalidUnitForDataType = <any> 'InvalidUnitForDataType',
        InvalidTypeForDataType = <any> 'InvalidTypeForDataType',
        InvalidValueForDataType = <any> 'InvalidValueForDataType',
        UnitNotDefinedForDataType = <any> 'UnitNotDefinedForDataType',
        UnitsNotSupportedOnDataType = <any> 'UnitsNotSupportedOnDataType',
        CannotSpecifyUnitsOnDataType = <any> 'CannotSpecifyUnitsOnDataType',
        UnitSchemaInconsistentWithDataType = <any> 'UnitSchemaInconsistentWithDataType',
        UnitDefinitionNotSpecified = <any> 'UnitDefinitionNotSpecified',
        DuplicateUnitDefinitionsSpecified = <any> 'DuplicateUnitDefinitionsSpecified',
        InvalidUnitsDefinition = <any> 'InvalidUnitsDefinition',
        InvalidInstrumentIdentifierUnit = <any> 'InvalidInstrumentIdentifierUnit',
        HoldingsAdjustmentDoesNotExist = <any> 'HoldingsAdjustmentDoesNotExist',
        CouldNotBuildExcelUrl = <any> 'CouldNotBuildExcelUrl',
        CouldNotGetExcelVersion = <any> 'CouldNotGetExcelVersion',
        InstrumentByCodeNotFound = <any> 'InstrumentByCodeNotFound',
        EntitySchemaDoesNotExist = <any> 'EntitySchemaDoesNotExist',
        FeatureNotSupportedOnPortfolioType = <any> 'FeatureNotSupportedOnPortfolioType',
        QuoteNotFoundFailure = <any> 'QuoteNotFoundFailure',
        ReferencePortfolioRequestNotSupported = <any> 'ReferencePortfolioRequestNotSupported',
        TransactionPortfolioRequestNotSupported = <any> 'TransactionPortfolioRequestNotSupported',
        InvalidInstrumentDefinition = <any> 'InvalidInstrumentDefinition',
        InstrumentUpsertFailure = <any> 'InstrumentUpsertFailure',
        TransactionTypeNotFound = <any> 'TransactionTypeNotFound',
        TransactionTypeDuplication = <any> 'TransactionTypeDuplication',
        InvalidPropertyValueAssignment = <any> 'InvalidPropertyValueAssignment',
        PortfolioDoesNotExistAtGivenDate = <any> 'PortfolioDoesNotExistAtGivenDate',
        QueryParserFailure = <any> 'QueryParserFailure',
        DuplicateConstituentFailure = <any> 'DuplicateConstituentFailure',
        UnresolvedInstrumentConstituentFailure = <any> 'UnresolvedInstrumentConstituentFailure',
        UnresolvedInstrumentInTransitionFailure = <any> 'UnresolvedInstrumentInTransitionFailure',
        MissingRecipeFailure = <any> 'MissingRecipeFailure',
        DependenciesFailure = <any> 'DependenciesFailure',
        PortfolioPreprocessFailure = <any> 'PortfolioPreprocessFailure',
        ValuationEngineFailure = <any> 'ValuationEngineFailure',
        TaskFactoryFailure = <any> 'TaskFactoryFailure',
        TaskEvaluationFailure = <any> 'TaskEvaluationFailure',
        InstrumentFailure = <any> 'InstrumentFailure',
        CashFlowsFailure = <any> 'CashFlowsFailure',
        ResultRetrievalFailure = <any> 'ResultRetrievalFailure',
        ResultProcessingFailure = <any> 'ResultProcessingFailure',
        VendorResultProcessingFailure = <any> 'VendorResultProcessingFailure',
        CannotSupplyTimesWithPortfoliosQuery = <any> 'CannotSupplyTimesWithPortfoliosQuery',
        AttemptToUpsertDuplicateQuotes = <any> 'AttemptToUpsertDuplicateQuotes',
        CorporateActionSourceDoesNotExist = <any> 'CorporateActionSourceDoesNotExist',
        InstrumentIdentifierAlreadyInUse = <any> 'InstrumentIdentifierAlreadyInUse',
        PortfolioInInvalidState = <any> 'PortfolioInInvalidState',
        GroupInInvalidState = <any> 'GroupInInvalidState',
        CorporateActionSourceInInvalidState = <any> 'CorporateActionSourceInInvalidState',
        LookThroughPortfolioInInvalidState = <any> 'LookThroughPortfolioInInvalidState',
        InstrumentInInvalidState = <any> 'InstrumentInInvalidState',
        PropertyDefinitionInInvalidState = <any> 'PropertyDefinitionInInvalidState'
    }
}
