...
*/
export class BankruptcyEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': BankruptcyEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "BankruptcyEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(BankruptcyEvent.attributeTypeMap);
    }
}

export namespace BankruptcyEvent {
