...
export class CapitalInterestAllOf {
    /**
    ...
    */
    'instrumentType': CapitalInterestAllOf.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CapitalInterestAllOf.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return CapitalInterestAllOf.attributeTypeMap;
    }
}

export namespace CapitalInterestAllOf {
