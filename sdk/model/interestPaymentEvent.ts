...
*/
export class InterestPaymentEvent extends InstrumentEvent {
    /**
    ...
    */
    'instrumentEventType': InterestPaymentEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "cashElections",
            "baseName": "cashElections",
            "type": "Array<CashElection>"
        },
        {
            "name": "instrumentEventType",
            "baseName": "instrumentEventType",
            "type": "InterestPaymentEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InterestPaymentEvent.attributeTypeMap);
    }
}

export namespace InterestPaymentEvent {
