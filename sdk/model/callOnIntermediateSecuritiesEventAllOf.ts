...
export class CallOnIntermediateSecuritiesEventAllOf {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CallOnIntermediateSecuritiesEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return CallOnIntermediateSecuritiesEventAllOf.attributeTypeMap;
    }
}
