...
export class FxForwardSettlementEventAllOf {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FxForwardSettlementEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return FxForwardSettlementEventAllOf.attributeTypeMap;
    }
}
