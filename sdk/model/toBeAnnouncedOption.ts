...
*/
export class ToBeAnnouncedOption extends LusidInstrument {
    /**
    ...
    */
    'instrumentType': ToBeAnnouncedOption.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ToBeAnnouncedOption.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ToBeAnnouncedOption.attributeTypeMap);
    }
}

export namespace ToBeAnnouncedOption {
