...
*/
export class FxForwardSettlementEvent extends InstrumentEvent {
    /**
    ...
    */
    'foreignToSettlementRate'?: number | null;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "domAmountPerUnit",
            "baseName": "domAmountPerUnit",
            "type": "number"
        },
        {
            "name": "domCcy",
        ...
        {
            "name": "fgnAmountPerUnit",
            "baseName": "fgnAmountPerUnit",
            "type": "number"
        },
        {
            "name": "fgnCcy",
        ...
        {
            "name": "domesticToForeignRate",
            "baseName": "domesticToForeignRate",
            "type": "number"
        },
        {
            "name": "domesticToSettlementRate",
            "baseName": "domesticToSettlementRate",
            "type": "number"
        },
        {
            "name": "foreignToSettlementRate",
            "baseName": "foreignToSettlementRate",
            "type": "number"
        },
        {
            "name": "instrumentEventType",
            "baseName": "instrumentEventType",
            "type": "FxForwardSettlementEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FxForwardSettlementEvent.attributeTypeMap);
    }
}
