...
export class FundBookmark extends FundCalendarEntries {
    /**
    ...
    */
    'entryType': FundBookmark.EntryTypeEnum;
    /**
    ...
    */
    'fundCalendarEntriesType': FundBookmark.FundCalendarEntriesTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "entryType",
            "baseName": "entryType",
            "type": "FundBookmark.EntryTypeEnum"
        },
        {
            "name": "status",
            "baseName": "status",
        ...
        {
            "name": "stagedModifications",
            "baseName": "stagedModifications",
            "type": "StagedModificationsInfo"
        },
        {
            "name": "fundCalendarEntriesType",
            "baseName": "fundCalendarEntriesType",
            "type": "FundBookmark.FundCalendarEntriesTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FundBookmark.attributeTypeMap);
    }
}

export namespace FundBookmark {
    ...
    export enum FundCalendarEntriesTypeEnum {
        FinalisedValuationPoint = <any> 'FinalisedValuationPoint',
        FundEstimateValuationPoint = <any> 'FundEstimateValuationPoint',
        FundBookmark = <any> 'FundBookmark'
    }
}
