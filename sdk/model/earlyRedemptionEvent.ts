...
*/
export class EarlyRedemptionEvent extends InstrumentEvent {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "EarlyRedemptionEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(EarlyRedemptionEvent.attributeTypeMap);
    }
}
