...
*/
export class LoanPrincipalRepaymentEvent extends InstrumentEvent {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "LoanPrincipalRepaymentEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(LoanPrincipalRepaymentEvent.attributeTypeMap);
    }
}
