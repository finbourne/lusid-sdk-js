...
*/
export class LoanInterestRepaymentEvent extends InstrumentEvent {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "LoanInterestRepaymentEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(LoanInterestRepaymentEvent.attributeTypeMap);
    }
}
