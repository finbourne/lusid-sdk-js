...
export class DutchAuctionEventAllOf {
    /**
    ...
    */
    'instrumentEventType': DutchAuctionEventAllOf.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DutchAuctionEventAllOf.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return DutchAuctionEventAllOf.attributeTypeMap;
    }
}

export namespace DutchAuctionEventAllOf {
