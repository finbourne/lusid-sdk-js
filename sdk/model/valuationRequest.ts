...
export class ValuationRequest {
    ...
    */
    ...
    /**
    * For complex results or financially meaningful results,  there is a need for a result to contain metadata about its currency and/or units  or to have a more complicated 1D or 2D structure
    */
    'returnResultAsExpandedTypes'?: boolean;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "returnResultAsExpandedTypes",
            "baseName": "returnResultAsExpandedTypes",
            "type": "boolean"
        },
        {
        ...
        {
            "name": "marketDataOverrides",
            "baseName": "marketDataOverrides",
            "type": "MarketDataOverrides"
        }    ];
