...
export class ExchangeOfferEvent extends InstrumentEvent {
    'effectiveDate'?: Date;
    'settlementDate'?: Date;
    'eventSource': string;
    ...
    */
    'instrumentEventType': ExchangeOfferEvent.InstrumentEventTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ExchangeOfferEvent.InstrumentEventTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ExchangeOfferEvent.attributeTypeMap);
    }
}

export namespace ExchangeOfferEvent {
