...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreatePropertyDefinitionRequest} opts.createPropertyDefinitionRequest The definition of the new property
    ...
    this.createPropertyDefinitionWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['createPropertyDefinitionRequest'];
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdatePropertyDefinitionRequest} opts.updatePropertyDefinitionRequest The updated definition of the property
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PropertyDefinition} and HTTP response
     */
    this.updatePropertyDefinitionWithHttpInfo = function(domain, scope, code, opts) {
      opts = opts || {};
      var postBody = opts['updatePropertyDefinitionRequest'];
