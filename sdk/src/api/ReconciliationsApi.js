...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/PortfoliosReconciliationRequest} opts.portfoliosReconciliationRequest The specifications of the inputs to the reconciliation
    ...
    this.reconcileHoldingsWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['portfoliosReconciliationRequest'];
     ...
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @param {module:model/ValuationsReconciliationRequest} opts.valuationsReconciliationRequest The specifications of the inputs to the reconciliation
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfReconciliationBreak} and HTTP response
     */
    this.reconcileValuationWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['valuationsReconciliationRequest'];
