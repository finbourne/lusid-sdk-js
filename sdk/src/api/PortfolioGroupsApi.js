...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/ResourceId} opts.resourceId The id of the portfolio
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ResourceId} opts.resourceId The id of the portfolio group being added as a sub-group
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreatePortfolioGroupRequest} opts.createPortfolioGroupRequest The definition of the new portfolio group
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.createPortfolioGroupWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['createPortfolioGroupRequest'];
     ...
     * @param {String} code The code of the portfolio group
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdatePortfolioGroupRequest} opts.updatePortfolioGroupRequest The updated definition of the portfolio group
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.updatePortfolioGroupWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['updatePortfolioGroupRequest'];
