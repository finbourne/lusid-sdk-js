...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/TransactionConfigurationDataRequest} opts.transactionConfigurationDataRequest A transaction type definition
    ...
    this.createConfigurationTransactionTypeWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['transactionConfigurationDataRequest'];
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<TransactionConfigurationDataRequest>} opts.transactionConfigurationDataRequest The complete set of transaction type definitions
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfTransactionConfigurationData} and HTTP response
     */
