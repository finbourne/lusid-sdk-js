...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<CreateCorporateAction>} opts.createCorporateAction The corporate action definitions
    ...
    this.batchUpsertCorporateActionsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['createCorporateAction'];
     ...
     * @param {module:model/CreateCorporateActionSourceRequest} createCorporateActionSourceRequest The corporate action source definition
     ...
     */
    this.createCorporateActionSourceWithHttpInfo = function(createCorporateActionSourceRequest) {
      var postBody = createCorporateActionSourceRequest;

      // verify the required parameter 'createCorporateActionSourceRequest' is set
      if (createCorporateActionSourceRequest === undefined || createCorporateActionSourceRequest === null) {
        throw new Error("Missing the required parameter 'createCorporateActionSourceRequest' when calling createCorporateActionSource");
      }
     ...
     */
    this.createCorporateActionSource = function(createCorporateActionSourceRequest) {
      return this.createCorporateActionSourceWithHttpInfo(createCorporateActionSourceRequest)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
