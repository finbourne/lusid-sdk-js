...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/InstrumentMatch', 'model/InstrumentSearchProperty', 'model/ResourceListOfPortfolioGroup', 'model/ResourceListOfPortfolioSearchResult', 'model/ResourceListOfPropertyDefinition', 'model/UNKNOWN_BASE_TYPE'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/InstrumentMatch'), require('../model/InstrumentSearchProperty'), require('../model/ResourceListOfPortfolioGroup'), require('../model/ResourceListOfPortfolioSearchResult'), require('../model/ResourceListOfPropertyDefinition'), require('../model/UNKNOWN_BASE_TYPE'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.SearchApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.ErrorResponse, root.LusidSdk.InstrumentMatch, root.LusidSdk.InstrumentSearchProperty, root.LusidSdk.ResourceListOfPortfolioGroup, root.LusidSdk.ResourceListOfPortfolioSearchResult, root.LusidSdk.ResourceListOfPropertyDefinition, root.LusidSdk.UNKNOWN_BASE_TYPE);
  }
}(this, function(ApiClient, ErrorResponse, InstrumentMatch, InstrumentSearchProperty, ResourceListOfPortfolioGroup, ResourceListOfPortfolioSearchResult, ResourceListOfPropertyDefinition, UNKNOWN_BASE_TYPE) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Date} opts.masteredEffectiveAt Optional. The effective date for searching mastered instruments. If this is not set, then the current date is taken.  This parameter has no effect on instruments that have not been mastered within LUSID.
     * @param {Boolean} opts.masteredOnly Optional. If set to true, only search over instruments that have been mastered within LUSID. Default to false (default to false)
     * @param {Array.<InstrumentSearchProperty>} opts.instrumentSearchProperty A collection of instrument symbols to search for
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/InstrumentMatch>} and HTTP response
     */
    this.instrumentsSearchWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['instrumentSearchProperty'];


      var pathParams = {
      };
      var queryParams = {
        'masteredEffectiveAt': opts['masteredEffectiveAt'],
        'masteredOnly': opts['masteredOnly'],
      };
      ...
      var returnType = [InstrumentMatch];
     ...
     * @param {Boolean} opts.masteredOnly Optional. If set to true, only search over instruments that have been mastered within LUSID. Default to false (default to false)
     * @param {Array.<InstrumentSearchProperty>} opts.instrumentSearchProperty A collection of instrument symbols to search for
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/InstrumentMatch>}
     */
    this.instrumentsSearch = function(opts) {
      return this.instrumentsSearchWithHttpInfo(opts)
     ...
     * @param {module:model/UNKNOWN_BASE_TYPE} opts.UNKNOWN_BASE_TYPE A valid Elasticsearch 5.x request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfPortfolioGroup} and HTTP response
     */
    this.portfolioGroupsSearchWithHttpInfo = function(opts) {
      opts = opts || {};
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfPortfolioGroup;
     ...
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @param {module:model/UNKNOWN_BASE_TYPE} opts.UNKNOWN_BASE_TYPE A valid Elasticsearch 5.x request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfPortfolioGroup}
     */
    this.portfolioGroupsSearch = function(opts) {
      return this.portfolioGroupsSearchWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @param {module:model/UNKNOWN_BASE_TYPE} opts.UNKNOWN_BASE_TYPE A valid Elasticsearch 5.x request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfPortfolioSearchResult} and HTTP response
     */
    this.portfoliosSearchWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['UNKNOWN_BASE_TYPE'];
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfPortfolioSearchResult;
     ...
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @param {module:model/UNKNOWN_BASE_TYPE} opts.UNKNOWN_BASE_TYPE A valid Elasticsearch 5.x request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfPortfolioSearchResult}
     */
    this.portfoliosSearch = function(opts) {
      return this.portfoliosSearchWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @param {module:model/UNKNOWN_BASE_TYPE} opts.UNKNOWN_BASE_TYPE A valid Elasticsearch 5.x request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfPropertyDefinition} and HTTP response
     */
    this.propertiesSearchWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['UNKNOWN_BASE_TYPE'];
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfPropertyDefinition;
     ...
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @param {module:model/UNKNOWN_BASE_TYPE} opts.UNKNOWN_BASE_TYPE A valid Elasticsearch 5.x request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfPropertyDefinition}
     */
    this.propertiesSearch = function(opts) {
      return this.propertiesSearchWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
