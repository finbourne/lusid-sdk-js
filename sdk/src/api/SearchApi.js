...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/InstrumentMatch', 'model/InstrumentSearchProperty', 'model/ResourceListOfPortfolioGroup', 'model/ResourceListOfPortfolioSearchResult', 'model/ResourceListOfPropertyDefinition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/InstrumentMatch'), require('../model/InstrumentSearchProperty'), require('../model/ResourceListOfPortfolioGroup'), require('../model/ResourceListOfPortfolioSearchResult'), require('../model/ResourceListOfPropertyDefinition'));
  } else {
...
}(this, function(ApiClient, ErrorResponse, InstrumentMatch, InstrumentSearchProperty, ResourceListOfPortfolioGroup, ResourceListOfPortfolioSearchResult, ResourceListOfPropertyDefinition) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.body A valid Elasticsearch 5.x request
