...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeleteQuoteRequest', 'model/DeleteQuotesResponse', 'model/ErrorResponse', 'model/GetQuotesResponse', 'model/QuoteId', 'model/UpsertQuoteRequest', 'model/UpsertQuotesResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DeleteQuoteRequest'), require('../model/DeleteQuotesResponse'), require('../model/ErrorResponse'), require('../model/GetQuotesResponse'), require('../model/QuoteId'), require('../model/UpsertQuoteRequest'), require('../model/UpsertQuotesResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.QuotesApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.DeleteQuoteRequest, root.LusidSdk.DeleteQuotesResponse, root.LusidSdk.ErrorResponse, root.LusidSdk.GetQuotesResponse, root.LusidSdk.QuoteId, root.LusidSdk.UpsertQuoteRequest, root.LusidSdk.UpsertQuotesResponse);
  }
}(this, function(ApiClient, DeleteQuoteRequest, DeleteQuotesResponse, ErrorResponse, GetQuotesResponse, QuoteId, UpsertQuoteRequest, UpsertQuotesResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<DeleteQuoteRequest>} opts.deleteQuoteRequest The quotes to delete
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DeleteQuotesResponse} and HTTP response
     */
    this.deleteQuotesWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['deleteQuoteRequest'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deleteQuotes");
      }
      ...
      var returnType = DeleteQuotesResponse;
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<DeleteQuoteRequest>} opts.deleteQuoteRequest The quotes to delete
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DeleteQuotesResponse}
     */
    this.deleteQuotes = function(scope, opts) {
      return this.deleteQuotesWithHttpInfo(scope, opts)
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.effectiveAt Optional. The date/time from which the quotes are effective
     * @param {Date} opts.asAt Optional. The &#39;AsAt&#39; date/time
     * @param {String} opts.maxAge Optional. The quote staleness tolerance
     * @param {Number} opts.page Optional. The page of results to return
     * @param {Number} opts.limit Optional. The number of results per page
     * @param {Array.<QuoteId>} opts.quoteId The ids of the quotes
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetQuotesResponse} and HTTP response
     */
    this.getQuotesWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['quoteId'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getQuotes");
      }
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = GetQuotesResponse;
     ...
     * @param {Number} opts.limit Optional. The number of results per page
     * @param {Array.<QuoteId>} opts.quoteId The ids of the quotes
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GetQuotesResponse}
     */
    this.getQuotes = function(scope, opts) {
      return this.getQuotesWithHttpInfo(scope, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} scope The scope of the quotes
     * @param {Object} opts Optional parameters
     * @param {Array.<UpsertQuoteRequest>} opts.upsertQuoteRequest The quotes to upsert
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UpsertQuotesResponse} and HTTP response
     */
    this.upsertQuotesWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['upsertQuoteRequest'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling upsertQuotes");
      }
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = UpsertQuotesResponse;
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<UpsertQuoteRequest>} opts.upsertQuoteRequest The quotes to upsert
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UpsertQuotesResponse}
     */
    this.upsertQuotes = function(scope, opts) {
      return this.upsertQuotesWithHttpInfo(scope, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
