...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreateDerivedTransactionPortfolioRequest} opts.createDerivedTransactionPortfolioRequest The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope
    ...
    this.createDerivedPortfolioWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['createDerivedTransactionPortfolioRequest'];
