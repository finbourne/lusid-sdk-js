...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AggregationRequest', 'model/ErrorResponse', 'model/ListAggregationResponse', 'model/NestedAggregationResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AggregationRequest'), require('../model/ErrorResponse'), require('../model/ListAggregationResponse'), require('../model/NestedAggregationResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.AggregationApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.AggregationRequest, root.LusidSdk.ErrorResponse, root.LusidSdk.ListAggregationResponse, root.LusidSdk.NestedAggregationResponse);
  }
}(this, function(ApiClient, AggregationRequest, ErrorResponse, ListAggregationResponse, NestedAggregationResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/AggregationRequest} opts.aggregationRequest The request specifying the parameters of the aggregation
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ListAggregationResponse} and HTTP response
     */
    this.getAggregationByGroupWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['aggregationRequest'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getAggregationByGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getAggregationByGroup");
      }
      ...
      var returnType = ListAggregationResponse;
     ...
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @param {module:model/AggregationRequest} opts.aggregationRequest The request specifying the parameters of the aggregation
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ListAggregationResponse}
     */
    this.getAggregationByGroup = function(scope, code, opts) {
      return this.getAggregationByGroupWithHttpInfo(scope, code, opts)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ListAggregationResponse} and HTTP response
     */
    this.getAggregationByPortfolioWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['aggregationRequest'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getAggregationByPortfolio");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getAggregationByPortfolio");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ListAggregationResponse}
     */
    this.getAggregationByPortfolio = function(scope, code, opts) {
      return this.getAggregationByPortfolioWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ListAggregationResponse} and HTTP response
     */
    this.getAggregationByResultSetWithHttpInfo = function(scope, resultsKey, opts) {
      opts = opts || {};
      var postBody = opts['aggregationRequest'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getAggregationByResultSet");
      }

      // verify the required parameter 'resultsKey' is set
      if (resultsKey === undefined || resultsKey === null) {
        throw new Error("Missing the required parameter 'resultsKey' when calling getAggregationByResultSet");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ListAggregationResponse}
     */
    this.getAggregationByResultSet = function(scope, resultsKey, opts) {
      return this.getAggregationByResultSetWithHttpInfo(scope, resultsKey, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/AggregationRequest} opts.aggregationRequest The request specifying the parameters of the aggregation
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/NestedAggregationResponse} and HTTP response
     */
    this.getNestedAggregationByGroupWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['aggregationRequest'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getNestedAggregationByGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getNestedAggregationByGroup");
      }
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = NestedAggregationResponse;
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/AggregationRequest} opts.aggregationRequest The request specifying the parameters of the aggregation
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/NestedAggregationResponse}
     */
    this.getNestedAggregationByGroup = function(scope, code, opts) {
      return this.getNestedAggregationByGroupWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
