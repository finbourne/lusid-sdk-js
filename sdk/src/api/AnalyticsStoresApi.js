...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreateAnalyticStoreRequest} opts.createAnalyticStoreRequest A populated analytic store definition
    ...
    this.createAnalyticStoreWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['createAnalyticStoreRequest'];
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<InstrumentAnalytic>} opts.instrumentAnalytic The analytic data being inserted
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AnalyticStore} and HTTP response
     */
    this.setAnalyticsWithHttpInfo = function(scope, year, month, day, opts) {
      opts = opts || {};
      var postBody = opts['instrumentAnalytic'];
