...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.MarketContextSuppliers = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The MarketContextSuppliers model module.
   * @module model/MarketContextSuppliers
   * @version 0.9.234
   */

  /**
   * Constructs a new <code>MarketContextSuppliers</code>.
   * It is possible to control which supplier is used for a given asset class.
   * @alias module:model/MarketContextSuppliers
   * @class
   */
  ...
  /**
   * Constructs a <code>MarketContextSuppliers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MarketContextSuppliers} obj Optional instance to populate.
   * @return {module:model/MarketContextSuppliers} The populated <code>MarketContextSuppliers</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('Fx')) {
        obj['Fx'] = ApiClient.convertToType(data['Fx'], 'String');
      }
  ...
  /**
   * @member {module:model/MarketContextSuppliers.FxEnum} Fx
   */
  exports.prototype['Fx'] = undefined;
  /**
   * @member {module:model/MarketContextSuppliers.RatesEnum} Rates
   */
  exports.prototype['Rates'] = undefined;
  /**
   * @member {module:model/MarketContextSuppliers.CommodityEnum} Commodity
   */
  exports.prototype['Commodity'] = undefined;
  /**
   * @member {module:model/MarketContextSuppliers.CreditEnum} Credit
   */
  exports.prototype['Credit'] = undefined;
  /**
   * @member {module:model/MarketContextSuppliers.EquityEnum} Equity
   */
  exports.prototype['Equity'] = undefined;


  /**
   * Allowed values for the <code>Fx</code> property.
   * @enum {String}
   * @readonly
   */
  exports.FxEnum = {
  ...
  /**
   * Allowed values for the <code>Rates</code> property.
   * @enum {String}
   * @readonly
   */
  exports.RatesEnum = {
  ...
  /**
   * Allowed values for the <code>Commodity</code> property.
   * @enum {String}
   * @readonly
   */
  exports.CommodityEnum = {
    /**
     * value: "DataScope"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>Credit</code> property.
   * @enum {String}
   * @readonly
   */
  exports.CreditEnum = {
  ...
  /**
   * Allowed values for the <code>Equity</code> property.
   * @enum {String}
   * @readonly
   */
  exports.EquityEnum = {
