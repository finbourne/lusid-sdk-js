...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateUnitDefinition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateUnitDefinition'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CreateDataTypeRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreateUnitDefinition);
  }
}(this, function(ApiClient, CreateUnitDefinition) {
  'use strict';



  /**
   * The CreateDataTypeRequest model module.
   * @module model/CreateDataTypeRequest
   * @version 0.9.234
   */

  /**
   * Constructs a new <code>CreateDataTypeRequest</code>.
   * @alias module:model/CreateDataTypeRequest
   * @class
   * @param scope {String} 
   * @param code {String} 
   * @param typeValueRange {module:model/CreateDataTypeRequest.TypeValueRangeEnum} 
   * @param displayName {String} 
   * @param description {String} 
   * @param valueType {module:model/CreateDataTypeRequest.ValueTypeEnum} 
   */
  var exports = function(scope, code, typeValueRange, displayName, description, valueType) {
    var _this = this;

    _this['scope'] = scope;
    _this['code'] = code;
    _this['typeValueRange'] = typeValueRange;
  ...
  /**
   * Constructs a <code>CreateDataTypeRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateDataTypeRequest} obj Optional instance to populate.
   * @return {module:model/CreateDataTypeRequest} The populated <code>CreateDataTypeRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('typeValueRange')) {
        obj['typeValueRange'] = ApiClient.convertToType(data['typeValueRange'], 'String');
      }
      ...
      if (data.hasOwnProperty('acceptableValues')) {
        obj['acceptableValues'] = ApiClient.convertToType(data['acceptableValues'], [Object]);
      }
      if (data.hasOwnProperty('unitSchema')) {
        obj['unitSchema'] = ApiClient.convertToType(data['unitSchema'], 'String');
      }
      if (data.hasOwnProperty('acceptableUnits')) {
        obj['acceptableUnits'] = ApiClient.convertToType(data['acceptableUnits'], [CreateUnitDefinition]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/CreateDataTypeRequest.TypeValueRangeEnum} typeValueRange
   */
  exports.prototype['typeValueRange'] = undefined;
  /**
  ...
  /**
   * @member {module:model/CreateDataTypeRequest.ValueTypeEnum} valueType
   */
  exports.prototype['valueType'] = undefined;
  /**
   * @member {Array.<Object>} acceptableValues
   */
  exports.prototype['acceptableValues'] = undefined;
  /**
   * @member {module:model/CreateDataTypeRequest.UnitSchemaEnum} unitSchema
   */
  exports.prototype['unitSchema'] = undefined;
  /**
   * @member {Array.<module:model/CreateUnitDefinition>} acceptableUnits
   */
  exports.prototype['acceptableUnits'] = undefined;


  /**
   * Allowed values for the <code>typeValueRange</code> property.
   * @enum {String}
   * @readonly
   */
  exports.TypeValueRangeEnum = {
    /**
     * value: "Open"
     * @const
     */
  ...
  exports.ValueTypeEnum = {
    ...
    /**
     * value: "ArrayOfTransactionAliases"
     * @const
     */
    "ArrayOfTransactionAliases": "ArrayOfTransactionAliases",
    /**
     * value: "ArrayofTransactionMovements"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>unitSchema</code> property.
   * @enum {String}
   * @readonly
   */
  exports.UnitSchemaEnum = {
    /**
     * value: "NoUnits"
     * @const
     */
