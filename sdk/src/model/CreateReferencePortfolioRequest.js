...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PerpetualPropertyValue'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PerpetualPropertyValue'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CreateReferencePortfolioRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.PerpetualPropertyValue);
  }
}(this, function(ApiClient, PerpetualPropertyValue) {
  'use strict';



  /**
   * The CreateReferencePortfolioRequest model module.
   * @module model/CreateReferencePortfolioRequest
   * @version 0.9.232
   */

  /**
   * Constructs a new <code>CreateReferencePortfolioRequest</code>.
   * @alias module:model/CreateReferencePortfolioRequest
   * @class
   * @param displayName {String} 
   * @param code {String} 
   */
  var exports = function(displayName, code) {
    var _this = this;
  ...
  /**
   * Constructs a <code>CreateReferencePortfolioRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateReferencePortfolioRequest} obj Optional instance to populate.
   * @return {module:model/CreateReferencePortfolioRequest} The populated <code>CreateReferencePortfolioRequest</code> instance.
   */
