...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CurrencyAndAmount'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CurrencyAndAmount'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.RealisedGainLoss = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount);
  }
}(this, function(ApiClient, CurrencyAndAmount) {
  'use strict';



  /**
   * The RealisedGainLoss model module.
   * @module model/RealisedGainLoss
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>RealisedGainLoss</code>.
   * @alias module:model/RealisedGainLoss
   * @class
   */
  ...
  /**
   * Constructs a <code>RealisedGainLoss</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RealisedGainLoss} obj Optional instance to populate.
   * @return {module:model/RealisedGainLoss} The populated <code>RealisedGainLoss</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('purchaseTradeDate')) {
        obj['purchaseTradeDate'] = ApiClient.convertToType(data['purchaseTradeDate'], 'Date');
      }
      if (data.hasOwnProperty('purchaseSettlementDate')) {
        obj['purchaseSettlementDate'] = ApiClient.convertToType(data['purchaseSettlementDate'], 'Date');
      }
      if (data.hasOwnProperty('purchasePrice')) {
        obj['purchasePrice'] = ApiClient.convertToType(data['purchasePrice'], 'Number');
      }
      if (data.hasOwnProperty('costTradeCcy')) {
        obj['costTradeCcy'] = CurrencyAndAmount.constructFromObject(data['costTradeCcy']);
      }
      if (data.hasOwnProperty('costPortfolioCcy')) {
        obj['costPortfolioCcy'] = CurrencyAndAmount.constructFromObject(data['costPortfolioCcy']);
      }
      if (data.hasOwnProperty('realisedTradeCcy')) {
        obj['realisedTradeCcy'] = CurrencyAndAmount.constructFromObject(data['realisedTradeCcy']);
      }
      if (data.hasOwnProperty('realisedTotal')) {
        obj['realisedTotal'] = CurrencyAndAmount.constructFromObject(data['realisedTotal']);
      }
      if (data.hasOwnProperty('realisedMarket')) {
        obj['realisedMarket'] = CurrencyAndAmount.constructFromObject(data['realisedMarket']);
      }
      if (data.hasOwnProperty('realisedCurrency')) {
        obj['realisedCurrency'] = CurrencyAndAmount.constructFromObject(data['realisedCurrency']);
      }
    }
    return obj;
  }
   ...
   * @member {Date} purchaseTradeDate
   */
  exports.prototype['purchaseTradeDate'] = undefined;
  /**
   * Date the position originally settled
   * @member {Date} purchaseSettlementDate
   */
  exports.prototype['purchaseSettlementDate'] = undefined;
  /**
  ...
  /**
   * @member {module:model/CurrencyAndAmount} costTradeCcy
   */
  exports.prototype['costTradeCcy'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} costPortfolioCcy
   */
  exports.prototype['costPortfolioCcy'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} realisedTradeCcy
   */
  exports.prototype['realisedTradeCcy'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} realisedTotal
   */
  exports.prototype['realisedTotal'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} realisedMarket
   */
  exports.prototype['realisedMarket'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} realisedCurrency
   */
  exports.prototype['realisedCurrency'] = undefined;
