...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/ResourceId', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./ResourceId'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.PortfolioGroup = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.ResourceId, root.LusidSdk.Version);
  }
}(this, function(ApiClient, Link, ResourceId, Version) {
  'use strict';



  /**
   * The PortfolioGroup model module.
   * @module model/PortfolioGroup
   * @version 0.9.234
   */

  /**
   * Constructs a new <code>PortfolioGroup</code>.
   * @alias module:model/PortfolioGroup
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioGroup</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioGroup} obj Optional instance to populate.
   * @return {module:model/PortfolioGroup} The populated <code>PortfolioGroup</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('portfolios')) {
        obj['portfolios'] = ApiClient.convertToType(data['portfolios'], [ResourceId]);
      }
      if (data.hasOwnProperty('subGroups')) {
        obj['subGroups'] = ApiClient.convertToType(data['subGroups'], [ResourceId]);
      }
  ...
  /**
   * @member {Array.<module:model/ResourceId>} portfolios
   */
  exports.prototype['portfolios'] = undefined;
  /**
   * @member {Array.<module:model/ResourceId>} subGroups
   */
