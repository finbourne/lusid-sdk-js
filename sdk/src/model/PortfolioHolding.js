...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CurrencyAndAmount', 'model/PerpetualProperty', 'model/Property', 'model/Transaction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CurrencyAndAmount'), require('./PerpetualProperty'), require('./Property'), require('./Transaction'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.PortfolioHolding = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount, root.LusidSdk.PerpetualProperty, root.LusidSdk.Property, root.LusidSdk.Transaction);
  }
}(this, function(ApiClient, CurrencyAndAmount, PerpetualProperty, Property, Transaction) {
  'use strict';
   ...
   * @class
   * @param instrumentUid {String} Unique instrument identifier
   * @param holdingType {String} Type of holding, eg Position, Balance, CashCommitment, Receivable, ForwardFX
   * @param units {Number} Quantity of holding
   * @param settledUnits {Number} Settled quantity of holding
   * @param cost {module:model/CurrencyAndAmount} 
   * @param costPortfolioCcy {module:model/CurrencyAndAmount} 
   */
  var exports = function(instrumentUid, holdingType, units, settledUnits, cost, costPortfolioCcy) {
    var _this = this;

    _this['instrumentUid'] = instrumentUid;
    _this['holdingType'] = holdingType;
    _this['units'] = units;
    _this['settledUnits'] = settledUnits;
    _this['cost'] = cost;
    _this['costPortfolioCcy'] = costPortfolioCcy;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('instrumentUid')) {
        obj['instrumentUid'] = ApiClient.convertToType(data['instrumentUid'], 'String');
      }
      if (data.hasOwnProperty('subHoldingKeys')) {
        obj['subHoldingKeys'] = ApiClient.convertToType(data['subHoldingKeys'], [PerpetualProperty]);
      }
      ...
      if (data.hasOwnProperty('settledUnits')) {
        obj['settledUnits'] = ApiClient.convertToType(data['settledUnits'], 'Number');
      }
      if (data.hasOwnProperty('cost')) {
        obj['cost'] = CurrencyAndAmount.constructFromObject(data['cost']);
      }
      if (data.hasOwnProperty('costPortfolioCcy')) {
        obj['costPortfolioCcy'] = CurrencyAndAmount.constructFromObject(data['costPortfolioCcy']);
      }
   ...
   */
  exports.prototype['instrumentUid'] = undefined;
  /**
   * @member {Array.<module:model/PerpetualProperty>} subHoldingKeys
   */
  exports.prototype['subHoldingKeys'] = undefined;
  /**
   ...
   * @member {Number} settledUnits
   */
  exports.prototype['settledUnits'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} cost
   */
  exports.prototype['cost'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} costPortfolioCcy
   */
  exports.prototype['costPortfolioCcy'] = undefined;
  /**
