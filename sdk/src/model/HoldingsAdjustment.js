...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/HoldingAdjustment', 'model/Link', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HoldingAdjustment'), require('./Link'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.HoldingsAdjustment = factory(root.LusidSdk.ApiClient, root.LusidSdk.HoldingAdjustment, root.LusidSdk.Link, root.LusidSdk.Version);
  }
}(this, function(ApiClient, HoldingAdjustment, Link, Version) {
  'use strict';



  /**
   * The HoldingsAdjustment model module.
   * @module model/HoldingsAdjustment
   * @version 0.9.236
   */

  /**
   * Constructs a new <code>HoldingsAdjustment</code>.
   * Full content of a holdings adjustment for a single portfolio and effective date.
   * @alias module:model/HoldingsAdjustment
   * @class
   */
  ...
  /**
   * Constructs a <code>HoldingsAdjustment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HoldingsAdjustment} obj Optional instance to populate.
   * @return {module:model/HoldingsAdjustment} The populated <code>HoldingsAdjustment</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('unmatchedHoldingMethod')) {
        obj['unmatchedHoldingMethod'] = ApiClient.convertToType(data['unmatchedHoldingMethod'], 'String');
      }
      if (data.hasOwnProperty('adjustments')) {
        obj['adjustments'] = ApiClient.convertToType(data['adjustments'], [HoldingAdjustment]);
      }
  ...
  /**
   * @member {module:model/HoldingsAdjustment.UnmatchedHoldingMethodEnum} unmatchedHoldingMethod
   */
  exports.prototype['unmatchedHoldingMethod'] = undefined;
  /**
   * @member {Array.<module:model/HoldingAdjustment>} adjustments
   */
  ...
  /**
   * Allowed values for the <code>unmatchedHoldingMethod</code> property.
   * @enum {String}
   * @readonly
   */
  exports.UnmatchedHoldingMethodEnum = {
    /**
     * value: "PositionToZero"
     * @const
     */
