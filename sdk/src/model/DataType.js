...
(function(root, factory) {
   ...
   * @class
   * @param typeValueRange {module:model/DataType.TypeValueRangeEnum} 
   * @param id {module:model/ResourceId} 
   * @param displayName {String} 
   * @param description {String} 
   * @param valueType {module:model/DataType.ValueTypeEnum} 
   */
  var exports = function(typeValueRange, id, displayName, description, valueType) {
    var _this = this;
