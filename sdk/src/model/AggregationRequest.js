...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AggregateSpec', 'model/ConfigurationRecipe', 'model/PropertyFilter', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AggregateSpec'), require('./ConfigurationRecipe'), require('./PropertyFilter'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.AggregationRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.AggregateSpec, root.LusidSdk.ConfigurationRecipe, root.LusidSdk.PropertyFilter, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, AggregateSpec, ConfigurationRecipe, PropertyFilter, ResourceId) {
  'use strict';
   ...
   * @class
   * @param effectiveAt {Date} The market data time, i.e. the time to run the aggregation request effective of.
   * @param metrics {Array.<module:model/AggregateSpec>} The set of specifications for items to calculate or retrieve during the aggregation and present in the results.  This is logically equivalent to the set of operations in a Sql select statement  select [operation1(field1), operation2(field2), ... ] from results
   */
  var exports = function(effectiveAt, metrics) {
    var _this = this;

    _this['effectiveAt'] = effectiveAt;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('recipeId')) {
        obj['recipeId'] = ResourceId.constructFromObject(data['recipeId']);
      }
      if (data.hasOwnProperty('inlineRecipe')) {
        obj['inlineRecipe'] = ConfigurationRecipe.constructFromObject(data['inlineRecipe']);
      }
      if (data.hasOwnProperty('asAt')) {
        obj['asAt'] = ApiClient.convertToType(data['asAt'], 'Date');
      }
      if (data.hasOwnProperty('effectiveAt')) {
        obj['effectiveAt'] = ApiClient.convertToType(data['effectiveAt'], 'Date');
      }
      if (data.hasOwnProperty('metrics')) {
        obj['metrics'] = ApiClient.convertToType(data['metrics'], [AggregateSpec]);
      }
      if (data.hasOwnProperty('groupBy')) {
        obj['groupBy'] = ApiClient.convertToType(data['groupBy'], ['String']);
      }
      if (data.hasOwnProperty('filters')) {
        obj['filters'] = ApiClient.convertToType(data['filters'], [PropertyFilter]);
      }
  ...
  /**
   * @member {module:model/ResourceId} recipeId
   */
  exports.prototype['recipeId'] = undefined;
  /**
   * @member {module:model/ConfigurationRecipe} inlineRecipe
   */
  exports.prototype['inlineRecipe'] = undefined;
  /**
   * The asAt date to use
   * @member {Date} asAt
   */
  exports.prototype['asAt'] = undefined;
  /**
   * The market data time, i.e. the time to run the aggregation request effective of.
   * @member {Date} effectiveAt
   */
  exports.prototype['effectiveAt'] = undefined;
  /**
   ...
   * @member {Array.<module:model/AggregateSpec>} metrics
   */
   ...
   * @member {Array.<module:model/PropertyFilter>} filters
   */
