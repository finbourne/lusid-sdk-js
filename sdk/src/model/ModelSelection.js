...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.ModelSelection = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The ModelSelection model module.
   * @module model/ModelSelection
   * @version 0.9.234
   */

  /**
   * Constructs a new <code>ModelSelection</code>.
   ...
   * @alias module:model/ModelSelection
   * @class
   * @param library {module:model/ModelSelection.LibraryEnum} Which library is used for pricing requests
   * @param model {module:model/ModelSelection.ModelEnum} Which model should be used for pricing requests
   */
  var exports = function(library, model) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ModelSelection</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelSelection} obj Optional instance to populate.
   * @return {module:model/ModelSelection} The populated <code>ModelSelection</code> instance.
   */
   ...
   * @member {module:model/ModelSelection.LibraryEnum} library
   */
  exports.prototype['library'] = undefined;
  /**
   * Which model should be used for pricing requests
   * @member {module:model/ModelSelection.ModelEnum} model
   */
  exports.prototype['model'] = undefined;


  /**
   * Allowed values for the <code>library</code> property.
   * @enum {String}
   * @readonly
   */
  exports.LibraryEnum = {
