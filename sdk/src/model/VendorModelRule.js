...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.VendorModelRule = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The VendorModelRule model module.
   * @module model/VendorModelRule
   * @version 0.9.228
   */

  /**
   * Constructs a new <code>VendorModelRule</code>.
   ...
   * @alias module:model/VendorModelRule
   * @class
   * @param supplier {module:model/VendorModelRule.SupplierEnum} The vendor library supplier
   * @param modelName {String} The vendor library model name
   * @param instrumentType {String} The vendor library instrument type
   * @param parameters {String} The set of opaque model parameters, provided as a Json object, that is a string object which will internally be converted to a dictionary of string to object.  Note that this is not intended as the final form of this object. It will be replaced with a more structured object as the set of parameters that are possible is  better understood.
   */
  var exports = function(supplier, modelName, instrumentType, parameters) {
    var _this = this;

    _this['supplier'] = supplier;
    _this['modelName'] = modelName;
    _this['instrumentType'] = instrumentType;
    _this['parameters'] = parameters;
  };

  /**
   * Constructs a <code>VendorModelRule</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VendorModelRule} obj Optional instance to populate.
   * @return {module:model/VendorModelRule} The populated <code>VendorModelRule</code> instance.
   */
   ...
   * @member {module:model/VendorModelRule.SupplierEnum} supplier
   */
