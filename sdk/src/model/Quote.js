...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MetricValue', 'model/QuoteId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MetricValue'), require('./QuoteId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.Quote = factory(root.LusidSdk.ApiClient, root.LusidSdk.MetricValue, root.LusidSdk.QuoteId);
  }
}(this, function(ApiClient, MetricValue, QuoteId) {
  'use strict';
   ...
   * @class
   * @param quoteId {module:model/QuoteId} 
   * @param metricValue {module:model/MetricValue} 
   * @param effectiveAt {Date} 
   * @param asAt {Date} 
   * @param uploadedBy {String} 
   */
  var exports = function(quoteId, metricValue, effectiveAt, asAt, uploadedBy) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('quoteId')) {
        obj['quoteId'] = QuoteId.constructFromObject(data['quoteId']);
      }
      if (data.hasOwnProperty('metricValue')) {
        obj['metricValue'] = MetricValue.constructFromObject(data['metricValue']);
      }
  ...
  /**
   * @member {module:model/QuoteId} quoteId
   */
  exports.prototype['quoteId'] = undefined;
  /**
   * @member {module:model/MetricValue} metricValue
   */
  exports.prototype['metricValue'] = undefined;
  /**
   * 
   ...
   */
  exports.prototype['uploadedBy'] = undefined;
  /**
   * 
