...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.MarketOptions = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The MarketOptions model module.
   * @module model/MarketOptions
   * @version 0.9.228
   */

  /**
   * Constructs a new <code>MarketOptions</code>.
   ...
   * @alias module:model/MarketOptions
   * @class
   */
  ...
  /**
   * Constructs a <code>MarketOptions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MarketOptions} obj Optional instance to populate.
   * @return {module:model/MarketOptions} The populated <code>MarketOptions</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('defaultSupplier')) {
        obj['defaultSupplier'] = ApiClient.convertToType(data['defaultSupplier'], 'String');
      }
      if (data.hasOwnProperty('defaultInstrumentCodeType')) {
        obj['defaultInstrumentCodeType'] = ApiClient.convertToType(data['defaultInstrumentCodeType'], 'String');
      }
   ...
   * @member {module:model/MarketOptions.DefaultSupplierEnum} defaultSupplier
   */
  exports.prototype['defaultSupplier'] = undefined;
  /**
   * When instrument quotes are searched for, what identifier should be used by default
   * @member {module:model/MarketOptions.DefaultInstrumentCodeTypeEnum} defaultInstrumentCodeType
   */
  exports.prototype['defaultInstrumentCodeType'] = undefined;
  /**
   * For default rules, which scope should data be searched for in
   * @member {String} defaultScope
   */
  exports.prototype['defaultScope'] = undefined;


  /**
   * Allowed values for the <code>defaultSupplier</code> property.
   * @enum {String}
   * @readonly
   */
  exports.DefaultSupplierEnum = {
    /**
     * value: "DataScope"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>defaultInstrumentCodeType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.DefaultInstrumentCodeTypeEnum = {
    /**
