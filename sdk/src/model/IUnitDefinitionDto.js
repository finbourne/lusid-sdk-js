...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.IUnitDefinitionDto = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The IUnitDefinitionDto model module.
   * @module model/IUnitDefinitionDto
   * @version 0.9.234
   */

  /**
   * Constructs a new <code>IUnitDefinitionDto</code>.
   * @alias module:model/IUnitDefinitionDto
   * @class
   */
  ...
  /**
   * Constructs a <code>IUnitDefinitionDto</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IUnitDefinitionDto} obj Optional instance to populate.
   * @return {module:model/IUnitDefinitionDto} The populated <code>IUnitDefinitionDto</code> instance.
   */
  ...
  /**
   * @member {module:model/IUnitDefinitionDto.SchemaEnum} schema
   */
  ...
  /**
   * Allowed values for the <code>schema</code> property.
   * @enum {String}
   * @readonly
   */
  exports.SchemaEnum = {
