...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.HoldingsAdjustmentHeader = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.Version);
  }
}(this, function(ApiClient, Link, Version) {
  'use strict';



  /**
   * The HoldingsAdjustmentHeader model module.
   * @module model/HoldingsAdjustmentHeader
   * @version 0.9.231
   */

  /**
   * Constructs a new <code>HoldingsAdjustmentHeader</code>.
   * Summary information of a holdings adjustment for a single portfolio and effective date.
   * @alias module:model/HoldingsAdjustmentHeader
   * @class
   */
  ...
  /**
   * Constructs a <code>HoldingsAdjustmentHeader</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HoldingsAdjustmentHeader} obj Optional instance to populate.
   * @return {module:model/HoldingsAdjustmentHeader} The populated <code>HoldingsAdjustmentHeader</code> instance.
   */
  ...
  /**
   * @member {module:model/HoldingsAdjustmentHeader.UnmatchedHoldingMethodEnum} unmatchedHoldingMethod
   */
