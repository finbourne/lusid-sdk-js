...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.QuoteId = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The QuoteId model module.
   * @module model/QuoteId
   * @version 0.9.234
   */

  /**
   * Constructs a new <code>QuoteId</code>.
   * @alias module:model/QuoteId
   * @class
   * @param provider {String} 
   * @param priceSource {String} 
   * @param instrumentId {String} 
   * @param instrumentIdType {module:model/QuoteId.InstrumentIdTypeEnum} 
   * @param quoteType {module:model/QuoteId.QuoteTypeEnum} 
   * @param priceSide {module:model/QuoteId.PriceSideEnum} 
   */
  var exports = function(provider, priceSource, instrumentId, instrumentIdType, quoteType, priceSide) {
    var _this = this;

    _this['provider'] = provider;
    _this['priceSource'] = priceSource;
    _this['instrumentId'] = instrumentId;
    _this['instrumentIdType'] = instrumentIdType;
    _this['quoteType'] = quoteType;
    _this['priceSide'] = priceSide;
  };

  /**
   * Constructs a <code>QuoteId</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/QuoteId} obj Optional instance to populate.
   * @return {module:model/QuoteId} The populated <code>QuoteId</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('instrumentIdType')) {
        obj['instrumentIdType'] = ApiClient.convertToType(data['instrumentIdType'], 'String');
      }
      if (data.hasOwnProperty('quoteType')) {
        obj['quoteType'] = ApiClient.convertToType(data['quoteType'], 'String');
      }
      if (data.hasOwnProperty('priceSide')) {
        obj['priceSide'] = ApiClient.convertToType(data['priceSide'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * 
   * @member {String} priceSource
   */
  exports.prototype['priceSource'] = undefined;
  /**
   * 
  ...
  /**
   * 
   * @member {module:model/QuoteId.InstrumentIdTypeEnum} instrumentIdType
   */
  exports.prototype['instrumentIdType'] = undefined;
  /**
   * 
   * @member {module:model/QuoteId.QuoteTypeEnum} quoteType
   */
  exports.prototype['quoteType'] = undefined;
  /**
   * 
   * @member {module:model/QuoteId.PriceSideEnum} priceSide
   */
  exports.prototype['priceSide'] = undefined;


  /**
   * Allowed values for the <code>instrumentIdType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.InstrumentIdTypeEnum = {
    /**
     * value: "LusidInstrumentId"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>priceSide</code> property.
   * @enum {String}
   * @readonly
   */
  exports.PriceSideEnum = {
    /**
     * value: "Bid"
     * @const
     */
