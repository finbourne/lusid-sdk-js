...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PerpetualPropertyValue', 'model/TransactionPropertyMappingRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PerpetualPropertyValue'), require('./TransactionPropertyMappingRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.TransactionConfigurationMovementDataRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.PerpetualPropertyValue, root.LusidSdk.TransactionPropertyMappingRequest);
  }
}(this, function(ApiClient, PerpetualPropertyValue, TransactionPropertyMappingRequest) {
  'use strict';



  /**
   * The TransactionConfigurationMovementDataRequest model module.
   * @module model/TransactionConfigurationMovementDataRequest
   * @version 0.9.236
   */

  /**
   * Constructs a new <code>TransactionConfigurationMovementDataRequest</code>.
   * @alias module:model/TransactionConfigurationMovementDataRequest
   * @class
   * @param movementTypes {module:model/TransactionConfigurationMovementDataRequest.MovementTypesEnum} The Movement Types
   * @param side {module:model/TransactionConfigurationMovementDataRequest.SideEnum} The Movement Side
   * @param direction {Number} The Movement direction
   */
  var exports = function(movementTypes, side, direction) {
    var _this = this;

    _this['movementTypes'] = movementTypes;
    _this['side'] = side;
    _this['direction'] = direction;
  };

  /**
   * Constructs a <code>TransactionConfigurationMovementDataRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionConfigurationMovementDataRequest} obj Optional instance to populate.
   * @return {module:model/TransactionConfigurationMovementDataRequest} The populated <code>TransactionConfigurationMovementDataRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('movementTypes')) {
        obj['movementTypes'] = ApiClient.convertToType(data['movementTypes'], 'String');
      }
      ...
      if (data.hasOwnProperty('properties')) {
        obj['properties'] = ApiClient.convertToType(data['properties'], {'String': PerpetualPropertyValue});
      }
      if (data.hasOwnProperty('mappings')) {
        obj['mappings'] = ApiClient.convertToType(data['mappings'], [TransactionPropertyMappingRequest]);
      }
    }
    return obj;
  }
  ...
  /**
   * The Movement Types
   * @member {module:model/TransactionConfigurationMovementDataRequest.MovementTypesEnum} movementTypes
   */
  exports.prototype['movementTypes'] = undefined;
  /**
   * The Movement Side
   * @member {module:model/TransactionConfigurationMovementDataRequest.SideEnum} side
   */
  ...
  /**
   * @member {Object.<String, module:model/PerpetualPropertyValue>} properties
   */
  exports.prototype['properties'] = undefined;
  /**
   * @member {Array.<module:model/TransactionPropertyMappingRequest>} mappings
   */
  exports.prototype['mappings'] = undefined;


  /**
   * Allowed values for the <code>movementTypes</code> property.
   * @enum {String}
   * @readonly
   */
  exports.MovementTypesEnum = {
    /**
     * value: "Settlement"
     * @const
     */
