...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CurrencyAndAmount', 'model/PerpetualProperty', 'model/TransactionPrice'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CurrencyAndAmount'), require('./PerpetualProperty'), require('./TransactionPrice'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.Transaction = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount, root.LusidSdk.PerpetualProperty, root.LusidSdk.TransactionPrice);
  }
}(this, function(ApiClient, CurrencyAndAmount, PerpetualProperty, TransactionPrice) {
  'use strict';
   ...
   * @class
   * @param transactionId {String} Unique transaction identifier
   * @param type {String} LUSID transaction type code - Buy, Sell, StockIn, StockOut, etc
   * @param instrumentUid {String} Unique instrument identifier
   * @param transactionDate {Date} Transaction date
   * @param settlementDate {Date} Settlement date
   * @param units {Number} Quantity of transaction in units of the instrument
   * @param transactionPrice {module:model/TransactionPrice} 
   * @param totalConsideration {module:model/CurrencyAndAmount} 
   * @param source {String} Where this transaction came from
   */
  var exports = function(transactionId, type, instrumentUid, transactionDate, settlementDate, units, transactionPrice, totalConsideration, source) {
    var _this = this;
    ...
    _this['units'] = units;
    _this['transactionPrice'] = transactionPrice;
    _this['totalConsideration'] = totalConsideration;
    _this['source'] = source;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('instrumentIdentifiers')) {
        obj['instrumentIdentifiers'] = ApiClient.convertToType(data['instrumentIdentifiers'], {'String': 'String'});
      }
      ...
      if (data.hasOwnProperty('transactionPrice')) {
        obj['transactionPrice'] = TransactionPrice.constructFromObject(data['transactionPrice']);
      }
      if (data.hasOwnProperty('totalConsideration')) {
        obj['totalConsideration'] = CurrencyAndAmount.constructFromObject(data['totalConsideration']);
      }
      ...
      if (data.hasOwnProperty('properties')) {
        obj['properties'] = ApiClient.convertToType(data['properties'], [PerpetualProperty]);
      }
      if (data.hasOwnProperty('counterpartyId')) {
        obj['counterpartyId'] = ApiClient.convertToType(data['counterpartyId'], 'String');
      }
      if (data.hasOwnProperty('source')) {
        obj['source'] = ApiClient.convertToType(data['source'], 'String');
      }
      if (data.hasOwnProperty('nettingSet')) {
        obj['nettingSet'] = ApiClient.convertToType(data['nettingSet'], 'String');
      }
    }
    return obj;
  }
   ...
   * @member {Object.<String, String>} instrumentIdentifiers
   */
  ...
  /**
   * @member {module:model/TransactionPrice} transactionPrice
   */
  exports.prototype['transactionPrice'] = undefined;
  /**
   * @member {module:model/CurrencyAndAmount} totalConsideration
   */
  exports.prototype['totalConsideration'] = undefined;
  /**
   ...
   */
  exports.prototype['transactionCurrency'] = undefined;
  /**
   * @member {Array.<module:model/PerpetualProperty>} properties
   */
   ...
   */
  exports.prototype['counterpartyId'] = undefined;
  /**
   ...
   */
  exports.prototype['nettingSet'] = undefined;
