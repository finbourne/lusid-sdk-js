...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CorporateActionTransitionRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CorporateActionTransitionRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CreateCorporateAction = factory(root.LusidSdk.ApiClient, root.LusidSdk.CorporateActionTransitionRequest);
  }
}(this, function(ApiClient, CorporateActionTransitionRequest) {
  'use strict';



  /**
   * The CreateCorporateAction model module.
   * @module model/CreateCorporateAction
   * @version 0.9.232
   */

  /**
   * Constructs a new <code>CreateCorporateAction</code>.
   * @alias module:model/CreateCorporateAction
   * @class
   * @param corporateActionCode {String} 
   * @param announcementDate {Date} 
   * @param exDate {Date} 
   * @param recordDate {Date} 
   * @param paymentDate {Date} 
   * @param transitions {Array.<module:model/CorporateActionTransitionRequest>} 
   */
  var exports = function(corporateActionCode, announcementDate, exDate, recordDate, paymentDate, transitions) {
    var _this = this;

    _this['corporateActionCode'] = corporateActionCode;
    _this['announcementDate'] = announcementDate;
    _this['exDate'] = exDate;
    _this['recordDate'] = recordDate;
    _this['paymentDate'] = paymentDate;
    _this['transitions'] = transitions;
  };

  /**
   * Constructs a <code>CreateCorporateAction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateCorporateAction} obj Optional instance to populate.
   * @return {module:model/CreateCorporateAction} The populated <code>CreateCorporateAction</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('corporateActionCode')) {
        obj['corporateActionCode'] = ApiClient.convertToType(data['corporateActionCode'], 'String');
      }
      ...
      if (data.hasOwnProperty('transitions')) {
        obj['transitions'] = ApiClient.convertToType(data['transitions'], [CorporateActionTransitionRequest]);
      }
    }
    return obj;
  }
   ...
   */
  exports.prototype['corporateActionCode'] = undefined;
  /**
   * 
   * @member {Date} announcementDate
   */
  exports.prototype['announcementDate'] = undefined;
  /**
   * 
   * @member {Date} exDate
   */
  exports.prototype['exDate'] = undefined;
  /**
   * 
   * @member {Date} recordDate
   */
  exports.prototype['recordDate'] = undefined;
  /**
   * 
  ...
  /**
   * @member {Array.<module:model/CorporateActionTransitionRequest>} transitions
   */
