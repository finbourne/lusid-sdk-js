...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FieldSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FieldSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.FieldSchema = factory(root.LusidSdk.ApiClient, root.LusidSdk.FieldSchema);
  }
}(this, function(ApiClient, FieldSchema) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isMetric')) {
        obj['isMetric'] = ApiClient.convertToType(data['isMetric'], 'Boolean');
      }
      if (data.hasOwnProperty('displayOrder')) {
        obj['displayOrder'] = ApiClient.convertToType(data['displayOrder'], 'Number');
      }
      if (data.hasOwnProperty('propertySchema')) {
        obj['propertySchema'] = ApiClient.convertToType(data['propertySchema'], {'String': FieldSchema});
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/FieldSchema.TypeEnum} type
   */
  exports.prototype['type'] = undefined;
  /**
   * @member {Boolean} isMetric
   */
  exports.prototype['isMetric'] = undefined;
  /**
   * @member {Number} displayOrder
   */
  exports.prototype['displayOrder'] = undefined;
  /**
   * @member {Object.<String, module:model/FieldSchema>} propertySchema
   */
  exports.prototype['propertySchema'] = undefined;
