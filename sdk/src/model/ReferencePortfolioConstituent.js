...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.ReferencePortfolioConstituent = factory(root.LusidSdk.ApiClient, root.LusidSdk.Property);
  }
  ...
  /**
   * The ReferencePortfolioConstituent model module.
   * @module model/ReferencePortfolioConstituent
   * @version 0.9.234
   */

  /**
   * Constructs a new <code>ReferencePortfolioConstituent</code>.
   * @alias module:model/ReferencePortfolioConstituent
   * @class
   * @param instrumentUid {String} 
   * @param currency {String} 
   * @param weight {Number} 
   */
  var exports = function(instrumentUid, currency, weight) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ReferencePortfolioConstituent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReferencePortfolioConstituent} obj Optional instance to populate.
   * @return {module:model/ReferencePortfolioConstituent} The populated <code>ReferencePortfolioConstituent</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('floatingWeight')) {
        obj['floatingWeight'] = ApiClient.convertToType(data['floatingWeight'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * 
   * @member {Number} floatingWeight
   */
  exports.prototype['floatingWeight'] = undefined;
