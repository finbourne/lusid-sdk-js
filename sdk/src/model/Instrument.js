...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InstrumentEconomicDefinition', 'model/Link', 'model/Property', 'model/ResourceId', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InstrumentEconomicDefinition'), require('./Link'), require('./Property'), require('./ResourceId'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.Instrument = factory(root.LusidSdk.ApiClient, root.LusidSdk.InstrumentEconomicDefinition, root.LusidSdk.Link, root.LusidSdk.Property, root.LusidSdk.ResourceId, root.LusidSdk.Version);
  }
}(this, function(ApiClient, InstrumentEconomicDefinition, Link, Property, ResourceId, Version) {
  'use strict';
   ...
   * @class
   * @param state {module:model/Instrument.StateEnum} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lusidInstrumentId')) {
        obj['lusidInstrumentId'] = ApiClient.convertToType(data['lusidInstrumentId'], 'String');
      }
      ...
      if (data.hasOwnProperty('identifiers')) {
        obj['identifiers'] = ApiClient.convertToType(data['identifiers'], {'String': 'String'});
      }
      if (data.hasOwnProperty('properties')) {
        obj['properties'] = ApiClient.convertToType(data['properties'], [Property]);
      }
      if (data.hasOwnProperty('lookthroughPortfolio')) {
        obj['lookthroughPortfolio'] = ResourceId.constructFromObject(data['lookthroughPortfolio']);
      }
      if (data.hasOwnProperty('instrumentDefinition')) {
        obj['instrumentDefinition'] = InstrumentEconomicDefinition.constructFromObject(data['instrumentDefinition']);
      }
   ...
   * @member {String} lusidInstrumentId
   */
  exports.prototype['lusidInstrumentId'] = undefined;
  /**
   ...
   * @member {Object.<String, String>} identifiers
   */
  exports.prototype['identifiers'] = undefined;
  /**
   * Any requested instrument properties. If no property can be found for the instrument, then  a value of 'Unknown' will be returned
   * @member {Array.<module:model/Property>} properties
   */
  exports.prototype['properties'] = undefined;
  /**
   * @member {module:model/ResourceId} lookthroughPortfolio
   */
  exports.prototype['lookthroughPortfolio'] = undefined;
  /**
   * @member {module:model/InstrumentEconomicDefinition} instrumentDefinition
   */
  exports.prototype['instrumentDefinition'] = undefined;
  /**
   * @member {module:model/Instrument.StateEnum} state
   */
