...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddTransactionPropertyResponse', 'model/AdjustHolding', 'model/AdjustHoldingRequest', 'model/AggregateSpec', 'model/AggregationRequest', 'model/AggregationResponseNode', 'model/AnalyticStore', 'model/AnalyticStoreKey', 'model/CompletePortfolio', 'model/ConfigurationRecipe', 'model/ConstituentsAdjustmentHeader', 'model/CorporateAction', 'model/CorporateActionSource', 'model/CorporateActionTransition', 'model/CorporateActionTransitionComponent', 'model/CorporateActionTransitionComponentRequest', 'model/CorporateActionTransitionRequest', 'model/CreateAnalyticStoreRequest', 'model/CreateCorporateAction', 'model/CreateCorporateActionSourceRequest', 'model/CreateDataTypeRequest', 'model/CreateDerivedTransactionPortfolioRequest', 'model/CreatePortfolioDetails', 'model/CreatePortfolioGroupRequest', 'model/CreatePropertyDefinitionRequest', 'model/CreateReferencePortfolioRequest', 'model/CreateResults', 'model/CreateTransactionPortfolioRequest', 'model/CreateUnitDefinition', 'model/CurrencyAndAmount', 'model/DataType', 'model/DeleteInstrumentPropertyRequest', 'model/DeleteInstrumentResponse', 'model/DeleteQuoteRequest', 'model/DeleteQuotesResponse', 'model/DeletedEntityResponse', 'model/ErrorDetail', 'model/ErrorDetailBase', 'model/ErrorResponse', 'model/ExecutionRequest', 'model/ExpandedGroup', 'model/FieldSchema', 'model/FileResponse', 'model/GetInstrumentsResponse', 'model/GetQuotesResponse', 'model/GetReferencePortfolioConstituentsResponse', 'model/HoldingAdjustment', 'model/HoldingsAdjustment', 'model/HoldingsAdjustmentHeader', 'model/IUnitDefinitionDto', 'model/Instrument', 'model/InstrumentAnalytic', 'model/InstrumentDefinition', 'model/InstrumentEconomicDefinition', 'model/InstrumentMatch', 'model/InstrumentProperty', 'model/InstrumentSearchProperty', 'model/Link', 'model/ListAggregationResponse', 'model/MarketContext', 'model/MarketContextSuppliers', 'model/MarketDataKeyRule', 'model/MarketOptions', 'model/MatchInstrumentsResponse', 'model/MetricValue', 'model/NestedAggregationResponse', 'model/OutputTransaction', 'model/PerpetualProperty', 'model/PerpetualPropertyValue', 'model/Portfolio', 'model/PortfolioDetails', 'model/PortfolioGroup', 'model/PortfolioHolding', 'model/PortfolioProperties', 'model/PortfolioReconciliationRequest', 'model/PortfolioSearchResult', 'model/PortfoliosReconciliationRequest', 'model/ProcessedCommand', 'model/Property', 'model/PropertyDefinition', 'model/PropertyFilter', 'model/PropertySchema', 'model/PropertyValue', 'model/Quote', 'model/QuoteId', 'model/QuoteLineage', 'model/RealisedGainLoss', 'model/ReconciliationBreak', 'model/ReferencePortfolioConstituent', 'model/ReferencePortfolioConstituentRequest', 'model/ResourceId', 'model/ResourceListOfAnalyticStoreKey', 'model/ResourceListOfConstituentsAdjustmentHeader', 'model/ResourceListOfCorporateAction', 'model/ResourceListOfCorporateActionSource', 'model/ResourceListOfDataType', 'model/ResourceListOfHoldingsAdjustmentHeader', 'model/ResourceListOfIUnitDefinitionDto', 'model/ResourceListOfInstrument', 'model/ResourceListOfPortfolio', 'model/ResourceListOfPortfolioGroup', 'model/ResourceListOfPortfolioSearchResult', 'model/ResourceListOfProcessedCommand', 'model/ResourceListOfPropertyDefinition', 'model/ResourceListOfReconciliationBreak', 'model/ResourceListOfScopeDefinition', 'model/ResourceListOfString', 'model/ResourceListOfTransactionConfigurationData', 'model/ResourceListOfValueType', 'model/ResultDataSchema', 'model/Results', 'model/Schema', 'model/ScopeDefinition', 'model/Stream', 'model/TargetTaxLot', 'model/TargetTaxLotRequest', 'model/Transaction', 'model/TransactionConfigurationData', 'model/TransactionConfigurationDataRequest', 'model/TransactionConfigurationMovementData', 'model/TransactionConfigurationMovementDataRequest', 'model/TransactionConfigurationTypeAlias', 'model/TransactionPrice', 'model/TransactionPropertyMapping', 'model/TransactionPropertyMappingRequest', 'model/TransactionQueryParameters', 'model/TransactionRequest', 'model/UpdateDataTypeRequest', 'model/UpdateInstrumentIdentifierRequest', 'model/UpdatePortfolioGroupRequest', 'model/UpdatePortfolioRequest', 'model/UpdatePropertyDefinitionRequest', 'model/UpsertCorporateActionsResponse', 'model/UpsertInstrumentPropertiesResponse', 'model/UpsertInstrumentPropertyRequest', 'model/UpsertInstrumentsResponse', 'model/UpsertPortfolioExecutionsResponse', 'model/UpsertPortfolioTransactionsResponse', 'model/UpsertQuoteRequest', 'model/UpsertQuotesResponse', 'model/UpsertReferencePortfolioConstituentsRequest', 'model/UpsertReferencePortfolioConstituentsResponse', 'model/User', 'model/ValuationReconciliationRequest', 'model/ValuationsReconciliationRequest', 'model/Version', 'model/VersionSummaryDto', 'model/VersionedResourceListOfOutputTransaction', 'model/VersionedResourceListOfPortfolioHolding', 'model/VersionedResourceListOfTransaction', 'api/AggregationApi', 'api/AnalyticsStoresApi', 'api/ApplicationMetadataApi', 'api/CorporateActionSourcesApi', 'api/DataTypesApi', 'api/DerivedTransactionPortfoliosApi', 'api/InstrumentsApi', 'api/LoginApi', 'api/PortfolioGroupsApi', 'api/PortfoliosApi', 'api/PropertyDefinitionsApi', 'api/QuotesApi', 'api/ReconciliationsApi', 'api/ReferencePortfolioApi', 'api/ResultsApi', 'api/SchemasApi', 'api/ScopesApi', 'api/SearchApi', 'api/SystemConfigurationApi', 'api/TransactionPortfoliosApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AddTransactionPropertyResponse'), require('./model/AdjustHolding'), require('./model/AdjustHoldingRequest'), require('./model/AggregateSpec'), require('./model/AggregationRequest'), require('./model/AggregationResponseNode'), require('./model/AnalyticStore'), require('./model/AnalyticStoreKey'), require('./model/CompletePortfolio'), require('./model/ConfigurationRecipe'), require('./model/ConstituentsAdjustmentHeader'), require('./model/CorporateAction'), require('./model/CorporateActionSource'), require('./model/CorporateActionTransition'), require('./model/CorporateActionTransitionComponent'), require('./model/CorporateActionTransitionComponentRequest'), require('./model/CorporateActionTransitionRequest'), require('./model/CreateAnalyticStoreRequest'), require('./model/CreateCorporateAction'), require('./model/CreateCorporateActionSourceRequest'), require('./model/CreateDataTypeRequest'), require('./model/CreateDerivedTransactionPortfolioRequest'), require('./model/CreatePortfolioDetails'), require('./model/CreatePortfolioGroupRequest'), require('./model/CreatePropertyDefinitionRequest'), require('./model/CreateReferencePortfolioRequest'), require('./model/CreateResults'), require('./model/CreateTransactionPortfolioRequest'), require('./model/CreateUnitDefinition'), require('./model/CurrencyAndAmount'), require('./model/DataType'), require('./model/DeleteInstrumentPropertyRequest'), require('./model/DeleteInstrumentResponse'), require('./model/DeleteQuoteRequest'), require('./model/DeleteQuotesResponse'), require('./model/DeletedEntityResponse'), require('./model/ErrorDetail'), require('./model/ErrorDetailBase'), require('./model/ErrorResponse'), require('./model/ExecutionRequest'), require('./model/ExpandedGroup'), require('./model/FieldSchema'), require('./model/FileResponse'), require('./model/GetInstrumentsResponse'), require('./model/GetQuotesResponse'), require('./model/GetReferencePortfolioConstituentsResponse'), require('./model/HoldingAdjustment'), require('./model/HoldingsAdjustment'), require('./model/HoldingsAdjustmentHeader'), require('./model/IUnitDefinitionDto'), require('./model/Instrument'), require('./model/InstrumentAnalytic'), require('./model/InstrumentDefinition'), require('./model/InstrumentEconomicDefinition'), require('./model/InstrumentMatch'), require('./model/InstrumentProperty'), require('./model/InstrumentSearchProperty'), require('./model/Link'), require('./model/ListAggregationResponse'), require('./model/MarketContext'), require('./model/MarketContextSuppliers'), require('./model/MarketDataKeyRule'), require('./model/MarketOptions'), require('./model/MatchInstrumentsResponse'), require('./model/MetricValue'), require('./model/NestedAggregationResponse'), require('./model/OutputTransaction'), require('./model/PerpetualProperty'), require('./model/PerpetualPropertyValue'), require('./model/Portfolio'), require('./model/PortfolioDetails'), require('./model/PortfolioGroup'), require('./model/PortfolioHolding'), require('./model/PortfolioProperties'), require('./model/PortfolioReconciliationRequest'), require('./model/PortfolioSearchResult'), require('./model/PortfoliosReconciliationRequest'), require('./model/ProcessedCommand'), require('./model/Property'), require('./model/PropertyDefinition'), require('./model/PropertyFilter'), require('./model/PropertySchema'), require('./model/PropertyValue'), require('./model/Quote'), require('./model/QuoteId'), require('./model/QuoteLineage'), require('./model/RealisedGainLoss'), require('./model/ReconciliationBreak'), require('./model/ReferencePortfolioConstituent'), require('./model/ReferencePortfolioConstituentRequest'), require('./model/ResourceId'), require('./model/ResourceListOfAnalyticStoreKey'), require('./model/ResourceListOfConstituentsAdjustmentHeader'), require('./model/ResourceListOfCorporateAction'), require('./model/ResourceListOfCorporateActionSource'), require('./model/ResourceListOfDataType'), require('./model/ResourceListOfHoldingsAdjustmentHeader'), require('./model/ResourceListOfIUnitDefinitionDto'), require('./model/ResourceListOfInstrument'), require('./model/ResourceListOfPortfolio'), require('./model/ResourceListOfPortfolioGroup'), require('./model/ResourceListOfPortfolioSearchResult'), require('./model/ResourceListOfProcessedCommand'), require('./model/ResourceListOfPropertyDefinition'), require('./model/ResourceListOfReconciliationBreak'), require('./model/ResourceListOfScopeDefinition'), require('./model/ResourceListOfString'), require('./model/ResourceListOfTransactionConfigurationData'), require('./model/ResourceListOfValueType'), require('./model/ResultDataSchema'), require('./model/Results'), require('./model/Schema'), require('./model/ScopeDefinition'), require('./model/Stream'), require('./model/TargetTaxLot'), require('./model/TargetTaxLotRequest'), require('./model/Transaction'), require('./model/TransactionConfigurationData'), require('./model/TransactionConfigurationDataRequest'), require('./model/TransactionConfigurationMovementData'), require('./model/TransactionConfigurationMovementDataRequest'), require('./model/TransactionConfigurationTypeAlias'), require('./model/TransactionPrice'), require('./model/TransactionPropertyMapping'), require('./model/TransactionPropertyMappingRequest'), require('./model/TransactionQueryParameters'), require('./model/TransactionRequest'), require('./model/UpdateDataTypeRequest'), require('./model/UpdateInstrumentIdentifierRequest'), require('./model/UpdatePortfolioGroupRequest'), require('./model/UpdatePortfolioRequest'), require('./model/UpdatePropertyDefinitionRequest'), require('./model/UpsertCorporateActionsResponse'), require('./model/UpsertInstrumentPropertiesResponse'), require('./model/UpsertInstrumentPropertyRequest'), require('./model/UpsertInstrumentsResponse'), require('./model/UpsertPortfolioExecutionsResponse'), require('./model/UpsertPortfolioTransactionsResponse'), require('./model/UpsertQuoteRequest'), require('./model/UpsertQuotesResponse'), require('./model/UpsertReferencePortfolioConstituentsRequest'), require('./model/UpsertReferencePortfolioConstituentsResponse'), require('./model/User'), require('./model/ValuationReconciliationRequest'), require('./model/ValuationsReconciliationRequest'), require('./model/Version'), require('./model/VersionSummaryDto'), require('./model/VersionedResourceListOfOutputTransaction'), require('./model/VersionedResourceListOfPortfolioHolding'), require('./model/VersionedResourceListOfTransaction'), require('./api/AggregationApi'), require('./api/AnalyticsStoresApi'), require('./api/ApplicationMetadataApi'), require('./api/CorporateActionSourcesApi'), require('./api/DataTypesApi'), require('./api/DerivedTransactionPortfoliosApi'), require('./api/InstrumentsApi'), require('./api/LoginApi'), require('./api/PortfolioGroupsApi'), require('./api/PortfoliosApi'), require('./api/PropertyDefinitionsApi'), require('./api/QuotesApi'), require('./api/ReconciliationsApi'), require('./api/ReferencePortfolioApi'), require('./api/ResultsApi'), require('./api/SchemasApi'), require('./api/ScopesApi'), require('./api/SearchApi'), require('./api/SystemConfigurationApi'), require('./api/TransactionPortfoliosApi'));
  }
}(function(ApiClient, AddTransactionPropertyResponse, AdjustHolding, AdjustHoldingRequest, AggregateSpec, AggregationRequest, AggregationResponseNode, AnalyticStore, AnalyticStoreKey, CompletePortfolio, ConfigurationRecipe, ConstituentsAdjustmentHeader, CorporateAction, CorporateActionSource, CorporateActionTransition, CorporateActionTransitionComponent, CorporateActionTransitionComponentRequest, CorporateActionTransitionRequest, CreateAnalyticStoreRequest, CreateCorporateAction, CreateCorporateActionSourceRequest, CreateDataTypeRequest, CreateDerivedTransactionPortfolioRequest, CreatePortfolioDetails, CreatePortfolioGroupRequest, CreatePropertyDefinitionRequest, CreateReferencePortfolioRequest, CreateResults, CreateTransactionPortfolioRequest, CreateUnitDefinition, CurrencyAndAmount, DataType, DeleteInstrumentPropertyRequest, DeleteInstrumentResponse, DeleteQuoteRequest, DeleteQuotesResponse, DeletedEntityResponse, ErrorDetail, ErrorDetailBase, ErrorResponse, ExecutionRequest, ExpandedGroup, FieldSchema, FileResponse, GetInstrumentsResponse, GetQuotesResponse, GetReferencePortfolioConstituentsResponse, HoldingAdjustment, HoldingsAdjustment, HoldingsAdjustmentHeader, IUnitDefinitionDto, Instrument, InstrumentAnalytic, InstrumentDefinition, InstrumentEconomicDefinition, InstrumentMatch, InstrumentProperty, InstrumentSearchProperty, Link, ListAggregationResponse, MarketContext, MarketContextSuppliers, MarketDataKeyRule, MarketOptions, MatchInstrumentsResponse, MetricValue, NestedAggregationResponse, OutputTransaction, PerpetualProperty, PerpetualPropertyValue, Portfolio, PortfolioDetails, PortfolioGroup, PortfolioHolding, PortfolioProperties, PortfolioReconciliationRequest, PortfolioSearchResult, PortfoliosReconciliationRequest, ProcessedCommand, Property, PropertyDefinition, PropertyFilter, PropertySchema, PropertyValue, Quote, QuoteId, QuoteLineage, RealisedGainLoss, ReconciliationBreak, ReferencePortfolioConstituent, ReferencePortfolioConstituentRequest, ResourceId, ResourceListOfAnalyticStoreKey, ResourceListOfConstituentsAdjustmentHeader, ResourceListOfCorporateAction, ResourceListOfCorporateActionSource, ResourceListOfDataType, ResourceListOfHoldingsAdjustmentHeader, ResourceListOfIUnitDefinitionDto, ResourceListOfInstrument, ResourceListOfPortfolio, ResourceListOfPortfolioGroup, ResourceListOfPortfolioSearchResult, ResourceListOfProcessedCommand, ResourceListOfPropertyDefinition, ResourceListOfReconciliationBreak, ResourceListOfScopeDefinition, ResourceListOfString, ResourceListOfTransactionConfigurationData, ResourceListOfValueType, ResultDataSchema, Results, Schema, ScopeDefinition, Stream, TargetTaxLot, TargetTaxLotRequest, Transaction, TransactionConfigurationData, TransactionConfigurationDataRequest, TransactionConfigurationMovementData, TransactionConfigurationMovementDataRequest, TransactionConfigurationTypeAlias, TransactionPrice, TransactionPropertyMapping, TransactionPropertyMappingRequest, TransactionQueryParameters, TransactionRequest, UpdateDataTypeRequest, UpdateInstrumentIdentifierRequest, UpdatePortfolioGroupRequest, UpdatePortfolioRequest, UpdatePropertyDefinitionRequest, UpsertCorporateActionsResponse, UpsertInstrumentPropertiesResponse, UpsertInstrumentPropertyRequest, UpsertInstrumentsResponse, UpsertPortfolioExecutionsResponse, UpsertPortfolioTransactionsResponse, UpsertQuoteRequest, UpsertQuotesResponse, UpsertReferencePortfolioConstituentsRequest, UpsertReferencePortfolioConstituentsResponse, User, ValuationReconciliationRequest, ValuationsReconciliationRequest, Version, VersionSummaryDto, VersionedResourceListOfOutputTransaction, VersionedResourceListOfPortfolioHolding, VersionedResourceListOfTransaction, AggregationApi, AnalyticsStoresApi, ApplicationMetadataApi, CorporateActionSourcesApi, DataTypesApi, DerivedTransactionPortfoliosApi, InstrumentsApi, LoginApi, PortfolioGroupsApi, PortfoliosApi, PropertyDefinitionsApi, QuotesApi, ReconciliationsApi, ReferencePortfolioApi, ResultsApi, SchemasApi, ScopesApi, SearchApi, SystemConfigurationApi, TransactionPortfoliosApi) {
  'use strict';

  /**
   * _IntroductionThis_page_documents_the__LUSID_APIs_httpsapi_lusid_comswagger_which_allows_authorised_clients_to_query_and_update_their_data_within_the_LUSID_platform_SDKs_to_interact_with_the_LUSID_APIs_are_available_in_the_following_languages___C_httpsgithub_comfinbournelusid_sdk_csharp__Java_httpsgithub_comfinbournelusid_sdk_java__JavaScript_httpsgithub_comfinbournelusid_sdk_js__Python_httpsgithub_comfinbournelusid_sdk_python_Data_ModelThe_LUSID_API_has_a_relatively_lightweight_but_extremely_powerful_data_model____One_of_the_goals_of_LUSID_was_not_to_enforce_on_clients_a_single_rigid_data_model_but_rather_to_provide_a_flexible_foundation_onto_which_clients_can_streamline_their_data____One_of_the_primary_tools_to_extend_the_data_model_is_through_using_properties___Properties_can_be_associated_with_amongst_others___Transactions_Instruments_Portfolios_The_LUSID_data_model_is_exposed_through_the_LUSID_APIs___The_APIs_provide_access_to_both_business_objects_and_the_meta_data_used_to_configure_the_systems_behaviours____The_key_business_entities_are___PortfoliosA_portfolio_is_the_primary_container_for_transactions_and_holdings___Derived_PortfoliosDerived_portfolios_allow_portfolios_to_be_created_based_on_other_portfolios_by_overriding_or_overlaying_specific_items_HoldingsA_holding_is_a_position_account_for_a_instrument_within_a_portfolio___Holdings_can_only_be_adjusted_via_transactions__TransactionsA_Transaction_is_a_source_of_transactions_used_to_manipulate_holdings___Corporate_ActionsA_corporate_action_is_a_market_event_which_occurs_to_a_instrument_for_example_a_stock_split_Instruments_A_instrument_represents_a_currency_tradable_instrument_or_OTC_contract_that_is_attached_to_a_transaction_and_a_holding__PropertiesSeveral_entities_allow_additional_user_defined_properties_to_be_associated_with_them____For_example_a_Portfolio_manager_may_be_associated_with_a_portfolioMeta_data_includes___Transaction_TypesTransactions_are_booked_with_a_specific_transaction_type___The_types_are_client_defined_and_are_used_to_map_the_Transaction_to_a_series_of_movements_which_update_the_portfolio_holdings___Properties_TypesTypes_of_user_defined_properties_used_within_the_system_This_section_describes_the_data_model_that_LUSID_exposes_via_the_APIs__ScopeAll_data_in_LUSID_is_segregated_at_the_client_level___Entities_in_LUSID_are_identifiable_by_a_unique_code___Every_entity_lives_within_a_logical_data_partition_known_as_a_Scope___Scope_is_an_identity_namespace_allowing_two_entities_with_the_same_unique_code_to_co_exist_within_individual_address_spaces_For_example_prices_for_equities_from_different_vendors_may_be_uploaded_into_different_scopes_such_as_clientvendor1_and_clientvendor2___A_portfolio_may_then_be_valued_using_either_of_the_price_sources_by_referencing_the_appropriate_scope_LUSID_Clients_cannot_access_scopes_of_other_clients__SchemaA_detailed_description_of_the_entities_used_by_the_API_and_parameters_for_endpoints_which_take_a_JSON_document_can_be_retrieved_via_the_schema_endpoint__InstrumentsLUSID_has_its_own_built_in_instrument_master_which_you_can_use_to_master_your_own_instrument_universe_Every_instrument_must_be_created_with_one_or_more_unique_market_identifiers_such_as__FIGI_httpsopenfigi_com_or_RIC_code__For_any_non_listed_instruments__eg_OTCs_you_can_upload_an_instrument_against_a_custom_ID_of_your_choosing_In_addition_LUSID_will_allocate_each_instrument_a_unique_LUSID_instrument_identifier__The_LUSID_instrument_identifier_is_what_is_used_when_uploading_transactions_holdings_prices_etc__The_API_exposes_an_instrumentlookup_endpoint_which_can_be_used_to_lookup_these_LUSID_identifiers_using_their_market_identifiers_Cash_can_be_referenced_using_the_ISO_currency_code_prefixed_with_CCY__e_g__CCY_GBP_Instrument_Prices__AnalyticsInstrument_prices_are_stored_in_LUSIDs_Analytics_Store__Field_Type_Description___________________InstrumentUid_string_Unique_instrument_identifier____Value_decimal_Value_of_the_analytic_eg_price____Denomination_string_Underlying_unit_of_the_analytic_eg_currency_EPS_etc____Instrument_DataInstrument_data_can_be_uploaded_to_the_system_using_the__Instrument_Properties_tagInstrumentProperties_endpoint___Field_Type_Description__________________PortfoliosPortfolios_are_the_top_level_entity_containers_within_LUSID_containing_transactions_corporate_actions_and_holdings_____The_transactions_build_up_the_portfolio_holdings_on_which_valuations_analytics_profit__loss_and_risk_can_be_calculated_____Properties_can_be_associated_with_Portfolios_to_add_in_additional_model_data___Portfolio_properties_can_be_changed_over_time_as_well___For_example_to_allow_a_Portfolio_Manager_to_be_linked_with_a_Portfolio_Additionally_portfolios_can_be_securitised_and_held_by_other_portfolios_allowing_LUSID_to_perform_drill_through_into_underlying_fund_holdings_Reference_PortfoliosReference_portfolios_are_portfolios_that_contain_only_weights_as_opposed_to_transactions_and_are_designed_to_represent_entities_such_as_indices__Derived_PortfoliosLUSID_also_allows_for_a_portfolio_to_be_composed_of_another_portfolio_via_derived_portfolios___A_derived_portfolio_can_contain_its_own_transactions_and_also_inherits_any_transactions_from_its_parent_portfolio___Any_changes_made_to_the_parent_portfolio_are_automatically_reflected_in_derived_portfolio_Derived_portfolios_in_conjunction_with_scopes_are_a_powerful_construct___For_example_to_do_pre_trade_what_if_analysis_a_derived_portfolio_could_be_created_a_new_namespace_linked_to_the_underlying_live__parent_portfolio___Analysis_can_then_be_undertaken_on_the_derived_portfolio_without_affecting_the_live_portfolio__Portfolio_GroupsPortfolio_groups_allow_the_construction_of_a_hierarchy_from_portfolios_and_groups___Portfolio_operations_on_the_group_are_executed_on_an_aggregated_set_of_portfolios_in_the_hierarchy__For_example__Global_Portfolios___group____APAC___group______Hong_Kong___portfolio______Japan___portfolio____Europe___group______France___portfolio______Germany___portfolio____UK___portfolio__In_this_example_Global_Portfolios_is_a_group_that_consists_of_an_aggregate_of_Hong_Kong_Japan_France_Germany_and_UK_portfolios__Movements_EngineThe_Movements_engine_sits_on_top_of_the_immutable_event_store_and_is_used_to_manage_the_relationship_between_input_trading_actions_and_their_associated_portfolio_holdings____The_movements_engine_reads_in_the_following_entity_types__Posting_Transactions_Applying_Corporate_Actions__Holding_AdjustmentsThese_are_converted_to_one_or_more_movements_and_used_by_the_movements_engine_to_calculate_holdings___At_the_same_time_it_also_calculates_running_balances_and_realised_PL___The_outputs_from_the_movements_engine_are_holdings_and_transactions__TransactionsA_transaction_represents_an_economic_activity_against_a_Portfolio_Transactions_are_processed_according_to_a_configuration__This_will_tell_the_LUSID_engine_how_to_interpret_the_transaction_and_correctly_update_the_holdings__LUSID_comes_with_a_set_of_transaction_types_you_can_use_out_of_the_box_or_you_can_configure_your_own_set_s_of_transactions_For_more_details_see_the__LUSID_Getting_Started_Guide_for_transaction_configuration__httpssupport_finbourne_comhcen_usarticles360016737511_Configuring_Transaction_Types__Field_Type_Description___________________TransactionId_string_Unique_transaction_identifier____Type_string_LUSID_transaction_type_code___Buy_Sell_StockIn_StockOut_etc____InstrumentIdentifiers_IReadOnlyDictionary2_Unique_instrument_identifiers_____InstrumentUid_string_Unique_instrument_identifier____TransactionDate_datetime_Transaction_date____SettlementDate_datetime_Settlement_date____Units_decimal_Quantity_of_transaction_in_units_of_the_instrument____TransactionPrice_tradeprice_Execution_price_for_the_transaction____TotalConsideration_currencyandamount_Total_value_of_the_transaction_in_settlement_currency____ExchangeRate_decimal_Rate_between_transaction_and_settle_currency____TransactionCurrency_currency_Transaction_currency____CounterpartyId_string_Counterparty_identifier____Source_string_Where_this_transaction_came_from____NettingSet_string____From_these_fields_the_following_values_can_be_calculated__Transaction_value_in_Transaction_currency_TotalConsideration__ExchangeRate__Transaction_value_in_Portfolio_currency_Transaction_value_in_Transaction_currency__TradeToPortfolioRate_Example_Transactions_A_Common_Purchase_ExampleThree_example_transactions_are_shown_in_the_table_below__They_represent_a_purchase_of_USD_denominated_IBM_shares_within_a_Sterling_denominated_portfolio___The_first_two_transactions_are_for_separate_buy_and_fx_trades____Buying_500_IBM_shares_for_71480_00____A_foreign_exchange_conversion_to_fund_the_IBM_purchase___Buy_71480_00_for_16354846_60__The_third_transaction_is_an_alternate_version_of_the_above_trades__Buying_500_IBM_shares_and_settling_directly_in_Sterling___Column____Buy_Trade___Fx_Trade___Buy_Trade_with_foreign_Settlement_____________________________________TransactionId___FBN00001___FBN00002___FBN00003____Type___Buy___FxBuy___Buy____InstrumentUid___FIGI_BBG000BLNNH6___CCY_USD___FIGI_BBG000BLNNH6____TransactionDate___2018_08_02___2018_08_02___2018_08_02____SettlementDate___2018_08_06___2018_08_06___2018_08_06____Units___500___71480___500____TransactionPrice___142_96___1___142_96____TradeCurrency___USD___USD___USD____ExchangeRate___1___0_7673___0_7673____TotalConsideration_Amount___71480_00___54846_60___54846_60____TotalConsideration_Currency___USD___GBP___GBP____TradedefaultTradeToPortfolioRateast___0_7673___0_7673___0_7673___ast_This_is_a_property_field_A_Forward_FX_ExampleLUSID_has_a_flexible_transaction_modelling_system_and_there_are_a_number_of_different_ways_of_modelling_forward_fx_trades_The_default_LUSID_transaction_types_are_FwdFxBuy_and_FwdFxSell__Other_types_and_behaviours_can_be_configured_as_required_Using_these_transaction_types_the_holdings_query_will_report_two_forward_positions__One_in_each_currency__Since_an_FX_trade_is_an_exchange_of_one_currency_for_another_the_following_two_6_month_forward_transactions_are_equivalent__Column____Forward_Sell_Trade___Forward_Buy_Trade_____________________________TransactionId___FBN00004___FBN00005____Type___FwdFxSell___FwdFxBuy____InstrumentUid___CCY_GBP___CCY_USD____TransactionDate___2018_08_02___2018_08_02____SettlementDate___2019_02_06___2019_02_06____Units___10000_00___13142_00____TransactionPrice__1___1____TradeCurrency___GBP___USD____ExchangeRate___1_3142___0_760919____TotalConsideration_Amount___13142_00___10000_00____TotalConsideration_Currency___USD___GBP____TradedefaultTradeToPortfolioRate___1_0___0_760919___HoldingsA_holding_represents_a_position_in_a_instrument_or_cash_on_a_given_date___Field_Type_Description___________________InstrumentUid_string_Unique_instrument_identifier____HoldingType_string_Type_of_holding_eg_Position_Balance_CashCommitment_Receivable_ForwardFX____Units_decimal_Quantity_of_holding____SettledUnits_decimal_Settled_quantity_of_holding____Cost_currencyandamount_Book_cost_of_holding_in_transaction_currency____CostPortfolioCcy_currencyandamount_Book_cost_of_holding_in_portfolio_currency____Transaction_Transaction_If_this_is_commitment_type_holding_the_transaction_behind_it___Corporate_ActionsCorporate_actions_are_represented_within_LUSID_in_terms_of_a_set_of_instrument_specific_transitions___These_transitions_are_used_to_specify_the_participants_of_the_corporate_action_and_the_effect_that_the_corporate_action_will_have_on_holdings_in_those_participants_Corporate_action__Field_Type_Description___________________SourceId_id______CorporateActionCode_code______AnnouncementDate_datetime______ExDate_datetime______RecordDate_datetime______PaymentDate_datetime____Transition__Field_Type_Description__________________PropertyProperties_are_key_value_pairs_that_can_be_applied_to_any_entity_within_a_domain__where_a_domain_is_trade_portfolio_security_etc___Properties_must_be_defined_before_use_with_a_PropertyDefinition_and_can_then_subsequently_be_added_to_entities__SchemasThe_following_headers_are_returned_on_all_responses_from_LUSID__Name___Purpose_________________lusid_meta_duration___Duration_of_the_request____lusid_meta_success___Whether_or_not_LUSID_considered_the_request_to_be_successful____lusid_meta_requestId___The_unique_identifier_for_the_request____lusid_schema_url___Url_of_the_schema_for_the_data_being_returned____lusid_property_schema_url___Url_of_the_schema_for_any_properties___Error_Codes__Code_Name_Description___________________a_name102102a_VersionNotFound______a_name104104a_InstrumentNotFound______a_name105105a_PropertyNotFound______a_name106106a_PortfolioRecursionDepth______a_name108108a_GroupNotFound______a_name109109a_PortfolioNotFound______a_name110110a_PropertySchemaNotFound______a_name111111a_PortfolioAncestryNotFound______a_name112112a_PortfolioWithIdAlreadyExists______a_name113113a_OrphanedPortfolio______a_name119119a_MissingBaseClaims______a_name121121a_PropertyNotDefined______a_name122122a_CannotDeleteSystemProperty______a_name123123a_CannotModifyImmutablePropertyField______a_name124124a_PropertyAlreadyExists______a_name125125a_InvalidPropertyLifeTime______a_name127127a_CannotModifyDefaultDataType______a_name128128a_GroupAlreadyExists______a_name129129a_NoSuchDataType______a_name132132a_ValidationError______a_name133133a_LoopDetectedInGroupHierarchy______a_name135135a_SubGroupAlreadyExists______a_name138138a_PriceSourceNotFound______a_name139139a_AnalyticStoreNotFound______a_name141141a_AnalyticStoreAlreadyExists______a_name143143a_ClientInstrumentAlreadyExists______a_name144144a_DuplicateInParameterSet______a_name147147a_ResultsNotFound______a_name148148a_OrderFieldNotInResultSet______a_name149149a_OperationFailed______a_name150150a_ElasticSearchError______a_name151151a_InvalidParameterValue______a_name153153a_CommandProcessingFailure______a_name154154a_EntityStateConstructionFailure______a_name155155a_EntityTimelineDoesNotExist______a_name156156a_EventPublishFailure______a_name157157a_InvalidRequestFailure______a_name158158a_EventPublishUnknown______a_name159159a_EventQueryFailure______a_name160160a_BlobDidNotExistFailure______a_name162162a_SubSystemRequestFailure______a_name163163a_SubSystemConfigurationFailure______a_name165165a_FailedToDelete______a_name166166a_UpsertClientInstrumentFailure______a_name167167a_IllegalAsAtInterval______a_name168168a_IllegalBitemporalQuery______a_name169169a_InvalidAlternateId______a_name170170a_CannotAddSourcePortfolioPropertyExplicitly______a_name171171a_EntityAlreadyExistsInGroup______a_name173173a_EntityWithIdAlreadyExists______a_name174174a_PortfolioDetailsDoNotExist______a_name176176a_PortfolioWithNameAlreadyExists______a_name177177a_InvalidTransactions______a_name178178a_ReferencePortfolioNotFound______a_name179179a_DuplicateIdFailure______a_name180180a_CommandRetrievalFailure______a_name181181a_DataFilterApplicationFailure______a_name182182a_SearchFailed______a_name183183a_MovementsEngineConfigurationKeyFailure______a_name184184a_FxRateSourceNotFound______a_name185185a_AccrualSourceNotFound______a_name186186a_EntitlementsFailure______a_name187187a_InvalidIdentityToken______a_name188188a_InvalidRequestHeaders______a_name189189a_PriceNotFound______a_name190190a_InvalidSubHoldingKeysProvided______a_name191191a_DuplicateSubHoldingKeysProvided______a_name192192a_CutDefinitionNotFound______a_name193193a_CutDefinitionInvalid______a_name200200a_InvalidUnitForDataType______a_name201201a_InvalidTypeForDataType______a_name202202a_InvalidValueForDataType______a_name203203a_UnitNotDefinedForDataType______a_name204204a_UnitsNotSupportedOnDataType______a_name205205a_CannotSpecifyUnitsOnDataType______a_name206206a_UnitSchemaInconsistentWithDataType______a_name207207a_UnitDefinitionNotSpecified______a_name208208a_DuplicateUnitDefinitionsSpecified______a_name209209a_InvalidUnitsDefinition______a_name210210a_InvalidInstrumentIdentifierUnit______a_name211211a_HoldingsAdjustmentDoesNotExist______a_name212212a_CouldNotBuildExcelUrl______a_name213213a_CouldNotGetExcelVersion______a_name214214a_InstrumentByCodeNotFound______a_name215215a_EntitySchemaDoesNotExist______a_name216216a_FeatureNotSupportedOnPortfolioType______a_name217217a_QuoteNotFoundFailure______a_name219219a_InvalidInstrumentDefinition______a_name221221a_InstrumentUpsertFailure______a_name222222a_ReferencePortfolioRequestNotSupported______a_name223223a_TransactionPortfolioRequestNotSupported______a_name224224a_InvalidPropertyValueAssignment______a_name230230a_TransactionTypeNotFound______a_name231231a_TransactionTypeDuplication______a_name232232a_PortfolioDoesNotExistAtGivenDate______a_name233233a_QueryParserFailure______a_name234234a_DuplicateConstituentFailure______a_name235235a_UnresolvedInstrumentConstituentFailure______a_name236236a_UnresolvedInstrumentInTransitionFailure______a_name300300a_MissingRecipeFailure______a_name301301a_DependenciesFailure______a_name304304a_PortfolioPreprocessFailure______a_name310310a_ValuationEngineFailure______a_name311311a_TaskFactoryFailure______a_name312312a_TaskEvaluationFailure______a_name350350a_InstrumentFailure______a_name351351a_CashFlowsFailure______a_name370370a_ResultRetrievalFailure______a_name371371a_ResultProcessingFailure______a_name372372a_VendorResultProcessingFailure______a_name373373a_CannotSupplyTimesWithPortfoliosQuery______a_name374374a_AttemptToUpsertDuplicateQuotes______a_name_10_10a_ServerConfigurationError______a_name_1_1a_Unknown_error____.<br>
  ...
  var exports = {
    ...
    QuoteId: QuoteId,
    /**
     * The QuoteLineage model constructor.
     * @property {module:model/QuoteLineage}
     */
