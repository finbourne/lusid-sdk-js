...
export declare namespace ErrorResponse {
    enum CodeEnum {
        ...
        DerivedPortfolioDetailsDoNotExist,
        ...
        FxRateSourceNotFound,
        AccrualSourceNotFound,
        EntitlementsFailure,
        InvalidIdentityToken,
        InvalidRequestHeaders,
        PriceNotFound,
        InvalidSubHoldingKeysProvided,
        DuplicateSubHoldingKeysProvided,
        CutDefinitionNotFound,
        CutDefinitionInvalid,
        ServerConfigurationError,
        InvalidUnitForDataType,
        InvalidTypeForDataType,
        InvalidValueForDataType,
        UnitNotDefinedForDataType,
        UnitsNotSupportedOnDataType,
        CannotSpecifyUnitsOnDataType,
        UnitSchemaInconsistentWithDataType,
        UnitDefinitionNotSpecified,
        DuplicateUnitDefinitionsSpecified,
        InvalidUnitsDefinition,
        InvalidInstrumentIdentifierUnit,
        HoldingsAdjustmentDoesNotExist,
        CouldNotBuildExcelUrl,
        CouldNotGetExcelVersion,
        InstrumentByCodeNotFound,
        ...
        QueryParserFailure,
        DuplicateConstituentFailure,
        UnresolvedInstrumentConstituentFailure,
        UnresolvedInstrumentInTransitionFailure,
        MissingRecipeFailure,
        DependenciesFailure,
        PortfolioPreprocessFailure,
        ValuationEngineFailure,
        TaskFactoryFailure,
        TaskEvaluationFailure,
        InstrumentFailure,
        CashFlowsFailure,
        ResultRetrievalFailure,
        ResultProcessingFailure,
        ...
        InstrumentIdentifierAlreadyInUse,
        PortfolioInInvalidState,
        GroupInInvalidState,
        CorporateActionSourceInInvalidState,
        LookThroughPortfolioInInvalidState,
        InstrumentInInvalidState,
        PropertyDefinitionInInvalidState
    }
}
