...
var ErrorResponse = /** @class */ (function () {
    ...
    ErrorResponse.attributeTypeMap = [
        ...
        },
        {
            ...
            "baseName": "detailedMessage",
            "type": "string"
        },
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<ErrorDetailBase>"
        },
        {
            "name": "moreInfo",
            "baseName": "moreInfo",
...
(function (ErrorResponse) {
    ...
    (function (CodeEnum) {
        ...
        CodeEnum[CodeEnum["VersionNotFound"] = 'VersionNotFound'] = "VersionNotFound";
        CodeEnum[CodeEnum["InstrumentNotFound"] = 'InstrumentNotFound'] = "InstrumentNotFound";
        CodeEnum[CodeEnum["PropertyNotFound"] = 'PropertyNotFound'] = "PropertyNotFound";
        CodeEnum[CodeEnum["PortfolioRecursionDepth"] = 'PortfolioRecursionDepth'] = "PortfolioRecursionDepth";
        CodeEnum[CodeEnum["GroupNotFound"] = 'GroupNotFound'] = "GroupNotFound";
        CodeEnum[CodeEnum["PortfolioNotFound"] = 'PortfolioNotFound'] = "PortfolioNotFound";
        CodeEnum[CodeEnum["PropertySchemaNotFound"] = 'PropertySchemaNotFound'] = "PropertySchemaNotFound";
        CodeEnum[CodeEnum["PortfolioAncestryNotFound"] = 'PortfolioAncestryNotFound'] = "PortfolioAncestryNotFound";
        CodeEnum[CodeEnum["PortfolioWithIdAlreadyExists"] = 'PortfolioWithIdAlreadyExists'] = "PortfolioWithIdAlreadyExists";
        CodeEnum[CodeEnum["OrphanedPortfolio"] = 'OrphanedPortfolio'] = "OrphanedPortfolio";
        CodeEnum[CodeEnum["MissingBaseClaims"] = 'MissingBaseClaims'] = "MissingBaseClaims";
        CodeEnum[CodeEnum["PropertyNotDefined"] = 'PropertyNotDefined'] = "PropertyNotDefined";
        CodeEnum[CodeEnum["CannotDeleteSystemProperty"] = 'CannotDeleteSystemProperty'] = "CannotDeleteSystemProperty";
        CodeEnum[CodeEnum["CannotModifyImmutablePropertyField"] = 'CannotModifyImmutablePropertyField'] = "CannotModifyImmutablePropertyField";
        CodeEnum[CodeEnum["PropertyAlreadyExists"] = 'PropertyAlreadyExists'] = "PropertyAlreadyExists";
        CodeEnum[CodeEnum["InvalidPropertyLifeTime"] = 'InvalidPropertyLifeTime'] = "InvalidPropertyLifeTime";
        CodeEnum[CodeEnum["CannotModifyDefaultDataType"] = 'CannotModifyDefaultDataType'] = "CannotModifyDefaultDataType";
        CodeEnum[CodeEnum["GroupAlreadyExists"] = 'GroupAlreadyExists'] = "GroupAlreadyExists";
        CodeEnum[CodeEnum["NoSuchDataType"] = 'NoSuchDataType'] = "NoSuchDataType";
        CodeEnum[CodeEnum["ValidationError"] = 'ValidationError'] = "ValidationError";
        CodeEnum[CodeEnum["LoopDetectedInGroupHierarchy"] = 'LoopDetectedInGroupHierarchy'] = "LoopDetectedInGroupHierarchy";
        CodeEnum[CodeEnum["SubGroupAlreadyExists"] = 'SubGroupAlreadyExists'] = "SubGroupAlreadyExists";
        CodeEnum[CodeEnum["PriceSourceNotFound"] = 'PriceSourceNotFound'] = "PriceSourceNotFound";
        CodeEnum[CodeEnum["AnalyticStoreNotFound"] = 'AnalyticStoreNotFound'] = "AnalyticStoreNotFound";
        CodeEnum[CodeEnum["AnalyticStoreAlreadyExists"] = 'AnalyticStoreAlreadyExists'] = "AnalyticStoreAlreadyExists";
        CodeEnum[CodeEnum["ClientInstrumentAlreadyExists"] = 'ClientInstrumentAlreadyExists'] = "ClientInstrumentAlreadyExists";
        CodeEnum[CodeEnum["DuplicateInParameterSet"] = 'DuplicateInParameterSet'] = "DuplicateInParameterSet";
        CodeEnum[CodeEnum["ResultsNotFound"] = 'ResultsNotFound'] = "ResultsNotFound";
        CodeEnum[CodeEnum["OrderFieldNotInResultSet"] = 'OrderFieldNotInResultSet'] = "OrderFieldNotInResultSet";
        CodeEnum[CodeEnum["OperationFailed"] = 'OperationFailed'] = "OperationFailed";
        CodeEnum[CodeEnum["ElasticSearchError"] = 'ElasticSearchError'] = "ElasticSearchError";
        CodeEnum[CodeEnum["InvalidParameterValue"] = 'InvalidParameterValue'] = "InvalidParameterValue";
        CodeEnum[CodeEnum["CommandProcessingFailure"] = 'CommandProcessingFailure'] = "CommandProcessingFailure";
        CodeEnum[CodeEnum["EntityStateConstructionFailure"] = 'EntityStateConstructionFailure'] = "EntityStateConstructionFailure";
        CodeEnum[CodeEnum["EntityTimelineDoesNotExist"] = 'EntityTimelineDoesNotExist'] = "EntityTimelineDoesNotExist";
        CodeEnum[CodeEnum["EventPublishFailure"] = 'EventPublishFailure'] = "EventPublishFailure";
        CodeEnum[CodeEnum["InvalidRequestFailure"] = 'InvalidRequestFailure'] = "InvalidRequestFailure";
        CodeEnum[CodeEnum["EventPublishUnknown"] = 'EventPublishUnknown'] = "EventPublishUnknown";
        CodeEnum[CodeEnum["EventQueryFailure"] = 'EventQueryFailure'] = "EventQueryFailure";
        CodeEnum[CodeEnum["BlobDidNotExistFailure"] = 'BlobDidNotExistFailure'] = "BlobDidNotExistFailure";
        CodeEnum[CodeEnum["SubSystemRequestFailure"] = 'SubSystemRequestFailure'] = "SubSystemRequestFailure";
        CodeEnum[CodeEnum["SubSystemConfigurationFailure"] = 'SubSystemConfigurationFailure'] = "SubSystemConfigurationFailure";
        CodeEnum[CodeEnum["FailedToDelete"] = 'FailedToDelete'] = "FailedToDelete";
        CodeEnum[CodeEnum["UpsertClientInstrumentFailure"] = 'UpsertClientInstrumentFailure'] = "UpsertClientInstrumentFailure";
        CodeEnum[CodeEnum["IllegalAsAtInterval"] = 'IllegalAsAtInterval'] = "IllegalAsAtInterval";
        CodeEnum[CodeEnum["IllegalBitemporalQuery"] = 'IllegalBitemporalQuery'] = "IllegalBitemporalQuery";
        CodeEnum[CodeEnum["InvalidAlternateId"] = 'InvalidAlternateId'] = "InvalidAlternateId";
        CodeEnum[CodeEnum["CannotAddSourcePortfolioPropertyExplicitly"] = 'CannotAddSourcePortfolioPropertyExplicitly'] = "CannotAddSourcePortfolioPropertyExplicitly";
        CodeEnum[CodeEnum["EntityAlreadyExistsInGroup"] = 'EntityAlreadyExistsInGroup'] = "EntityAlreadyExistsInGroup";
        CodeEnum[CodeEnum["EntityWithIdAlreadyExists"] = 'EntityWithIdAlreadyExists'] = "EntityWithIdAlreadyExists";
        CodeEnum[CodeEnum["DerivedPortfolioDetailsDoNotExist"] = 'DerivedPortfolioDetailsDoNotExist'] = "DerivedPortfolioDetailsDoNotExist";
        CodeEnum[CodeEnum["PortfolioWithNameAlreadyExists"] = 'PortfolioWithNameAlreadyExists'] = "PortfolioWithNameAlreadyExists";
        CodeEnum[CodeEnum["InvalidTransactions"] = 'InvalidTransactions'] = "InvalidTransactions";
        CodeEnum[CodeEnum["ReferencePortfolioNotFound"] = 'ReferencePortfolioNotFound'] = "ReferencePortfolioNotFound";
        CodeEnum[CodeEnum["DuplicateIdFailure"] = 'DuplicateIdFailure'] = "DuplicateIdFailure";
        CodeEnum[CodeEnum["CommandRetrievalFailure"] = 'CommandRetrievalFailure'] = "CommandRetrievalFailure";
        CodeEnum[CodeEnum["DataFilterApplicationFailure"] = 'DataFilterApplicationFailure'] = "DataFilterApplicationFailure";
        CodeEnum[CodeEnum["SearchFailed"] = 'SearchFailed'] = "SearchFailed";
        CodeEnum[CodeEnum["MovementsEngineConfigurationKeyFailure"] = 'MovementsEngineConfigurationKeyFailure'] = "MovementsEngineConfigurationKeyFailure";
        CodeEnum[CodeEnum["FxRateSourceNotFound"] = 'FxRateSourceNotFound'] = "FxRateSourceNotFound";
        CodeEnum[CodeEnum["AccrualSourceNotFound"] = 'AccrualSourceNotFound'] = "AccrualSourceNotFound";
        CodeEnum[CodeEnum["EntitlementsFailure"] = 'EntitlementsFailure'] = "EntitlementsFailure";
        CodeEnum[CodeEnum["InvalidIdentityToken"] = 'InvalidIdentityToken'] = "InvalidIdentityToken";
        CodeEnum[CodeEnum["InvalidRequestHeaders"] = 'InvalidRequestHeaders'] = "InvalidRequestHeaders";
        CodeEnum[CodeEnum["PriceNotFound"] = 'PriceNotFound'] = "PriceNotFound";
        CodeEnum[CodeEnum["InvalidSubHoldingKeysProvided"] = 'InvalidSubHoldingKeysProvided'] = "InvalidSubHoldingKeysProvided";
        CodeEnum[CodeEnum["DuplicateSubHoldingKeysProvided"] = 'DuplicateSubHoldingKeysProvided'] = "DuplicateSubHoldingKeysProvided";
        CodeEnum[CodeEnum["CutDefinitionNotFound"] = 'CutDefinitionNotFound'] = "CutDefinitionNotFound";
        CodeEnum[CodeEnum["CutDefinitionInvalid"] = 'CutDefinitionInvalid'] = "CutDefinitionInvalid";
        CodeEnum[CodeEnum["ServerConfigurationError"] = 'ServerConfigurationError'] = "ServerConfigurationError";
        CodeEnum[CodeEnum["InvalidUnitForDataType"] = 'InvalidUnitForDataType'] = "InvalidUnitForDataType";
        CodeEnum[CodeEnum["InvalidTypeForDataType"] = 'InvalidTypeForDataType'] = "InvalidTypeForDataType";
        CodeEnum[CodeEnum["InvalidValueForDataType"] = 'InvalidValueForDataType'] = "InvalidValueForDataType";
        CodeEnum[CodeEnum["UnitNotDefinedForDataType"] = 'UnitNotDefinedForDataType'] = "UnitNotDefinedForDataType";
        CodeEnum[CodeEnum["UnitsNotSupportedOnDataType"] = 'UnitsNotSupportedOnDataType'] = "UnitsNotSupportedOnDataType";
        CodeEnum[CodeEnum["CannotSpecifyUnitsOnDataType"] = 'CannotSpecifyUnitsOnDataType'] = "CannotSpecifyUnitsOnDataType";
        CodeEnum[CodeEnum["UnitSchemaInconsistentWithDataType"] = 'UnitSchemaInconsistentWithDataType'] = "UnitSchemaInconsistentWithDataType";
        CodeEnum[CodeEnum["UnitDefinitionNotSpecified"] = 'UnitDefinitionNotSpecified'] = "UnitDefinitionNotSpecified";
        CodeEnum[CodeEnum["DuplicateUnitDefinitionsSpecified"] = 'DuplicateUnitDefinitionsSpecified'] = "DuplicateUnitDefinitionsSpecified";
        CodeEnum[CodeEnum["InvalidUnitsDefinition"] = 'InvalidUnitsDefinition'] = "InvalidUnitsDefinition";
        CodeEnum[CodeEnum["InvalidInstrumentIdentifierUnit"] = 'InvalidInstrumentIdentifierUnit'] = "InvalidInstrumentIdentifierUnit";
        CodeEnum[CodeEnum["HoldingsAdjustmentDoesNotExist"] = 'HoldingsAdjustmentDoesNotExist'] = "HoldingsAdjustmentDoesNotExist";
        CodeEnum[CodeEnum["CouldNotBuildExcelUrl"] = 'CouldNotBuildExcelUrl'] = "CouldNotBuildExcelUrl";
        CodeEnum[CodeEnum["CouldNotGetExcelVersion"] = 'CouldNotGetExcelVersion'] = "CouldNotGetExcelVersion";
        CodeEnum[CodeEnum["InstrumentByCodeNotFound"] = 'InstrumentByCodeNotFound'] = "InstrumentByCodeNotFound";
        CodeEnum[CodeEnum["EntitySchemaDoesNotExist"] = 'EntitySchemaDoesNotExist'] = "EntitySchemaDoesNotExist";
        CodeEnum[CodeEnum["FeatureNotSupportedOnPortfolioType"] = 'FeatureNotSupportedOnPortfolioType'] = "FeatureNotSupportedOnPortfolioType";
        CodeEnum[CodeEnum["QuoteNotFoundFailure"] = 'QuoteNotFoundFailure'] = "QuoteNotFoundFailure";
        CodeEnum[CodeEnum["ReferencePortfolioRequestNotSupported"] = 'ReferencePortfolioRequestNotSupported'] = "ReferencePortfolioRequestNotSupported";
        CodeEnum[CodeEnum["TransactionPortfolioRequestNotSupported"] = 'TransactionPortfolioRequestNotSupported'] = "TransactionPortfolioRequestNotSupported";
        CodeEnum[CodeEnum["InvalidInstrumentDefinition"] = 'InvalidInstrumentDefinition'] = "InvalidInstrumentDefinition";
        CodeEnum[CodeEnum["InstrumentUpsertFailure"] = 'InstrumentUpsertFailure'] = "InstrumentUpsertFailure";
        CodeEnum[CodeEnum["TransactionTypeNotFound"] = 'TransactionTypeNotFound'] = "TransactionTypeNotFound";
        CodeEnum[CodeEnum["TransactionTypeDuplication"] = 'TransactionTypeDuplication'] = "TransactionTypeDuplication";
        CodeEnum[CodeEnum["InvalidPropertyValueAssignment"] = 'InvalidPropertyValueAssignment'] = "InvalidPropertyValueAssignment";
        CodeEnum[CodeEnum["PortfolioDoesNotExistAtGivenDate"] = 'PortfolioDoesNotExistAtGivenDate'] = "PortfolioDoesNotExistAtGivenDate";
        CodeEnum[CodeEnum["QueryParserFailure"] = 'QueryParserFailure'] = "QueryParserFailure";
        CodeEnum[CodeEnum["DuplicateConstituentFailure"] = 'DuplicateConstituentFailure'] = "DuplicateConstituentFailure";
        CodeEnum[CodeEnum["UnresolvedInstrumentConstituentFailure"] = 'UnresolvedInstrumentConstituentFailure'] = "UnresolvedInstrumentConstituentFailure";
        CodeEnum[CodeEnum["UnresolvedInstrumentInTransitionFailure"] = 'UnresolvedInstrumentInTransitionFailure'] = "UnresolvedInstrumentInTransitionFailure";
        CodeEnum[CodeEnum["MissingRecipeFailure"] = 'MissingRecipeFailure'] = "MissingRecipeFailure";
        CodeEnum[CodeEnum["DependenciesFailure"] = 'DependenciesFailure'] = "DependenciesFailure";
        CodeEnum[CodeEnum["PortfolioPreprocessFailure"] = 'PortfolioPreprocessFailure'] = "PortfolioPreprocessFailure";
        CodeEnum[CodeEnum["ValuationEngineFailure"] = 'ValuationEngineFailure'] = "ValuationEngineFailure";
        CodeEnum[CodeEnum["TaskFactoryFailure"] = 'TaskFactoryFailure'] = "TaskFactoryFailure";
        CodeEnum[CodeEnum["TaskEvaluationFailure"] = 'TaskEvaluationFailure'] = "TaskEvaluationFailure";
        CodeEnum[CodeEnum["InstrumentFailure"] = 'InstrumentFailure'] = "InstrumentFailure";
        CodeEnum[CodeEnum["CashFlowsFailure"] = 'CashFlowsFailure'] = "CashFlowsFailure";
        CodeEnum[CodeEnum["ResultRetrievalFailure"] = 'ResultRetrievalFailure'] = "ResultRetrievalFailure";
        CodeEnum[CodeEnum["ResultProcessingFailure"] = 'ResultProcessingFailure'] = "ResultProcessingFailure";
        CodeEnum[CodeEnum["VendorResultProcessingFailure"] = 'VendorResultProcessingFailure'] = "VendorResultProcessingFailure";
        CodeEnum[CodeEnum["CannotSupplyTimesWithPortfoliosQuery"] = 'CannotSupplyTimesWithPortfoliosQuery'] = "CannotSupplyTimesWithPortfoliosQuery";
        CodeEnum[CodeEnum["AttemptToUpsertDuplicateQuotes"] = 'AttemptToUpsertDuplicateQuotes'] = "AttemptToUpsertDuplicateQuotes";
        CodeEnum[CodeEnum["CorporateActionSourceDoesNotExist"] = 'CorporateActionSourceDoesNotExist'] = "CorporateActionSourceDoesNotExist";
        CodeEnum[CodeEnum["InstrumentIdentifierAlreadyInUse"] = 'InstrumentIdentifierAlreadyInUse'] = "InstrumentIdentifierAlreadyInUse";
        CodeEnum[CodeEnum["PortfolioInInvalidState"] = 'PortfolioInInvalidState'] = "PortfolioInInvalidState";
        CodeEnum[CodeEnum["GroupInInvalidState"] = 'GroupInInvalidState'] = "GroupInInvalidState";
        CodeEnum[CodeEnum["CorporateActionSourceInInvalidState"] = 'CorporateActionSourceInInvalidState'] = "CorporateActionSourceInInvalidState";
        CodeEnum[CodeEnum["LookThroughPortfolioInInvalidState"] = 'LookThroughPortfolioInInvalidState'] = "LookThroughPortfolioInInvalidState";
        CodeEnum[CodeEnum["InstrumentInInvalidState"] = 'InstrumentInInvalidState'] = "InstrumentInInvalidState";
        CodeEnum[CodeEnum["PropertyDefinitionInInvalidState"] = 'PropertyDefinitionInInvalidState'] = "PropertyDefinitionInInvalidState";
    })(CodeEnum = ErrorResponse.CodeEnum || (ErrorResponse.CodeEnum = {}));
