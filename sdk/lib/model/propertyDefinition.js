...
(function (PropertyDefinition) {
    ...
    (function (ValueTypeEnum) {
        ...
        ValueTypeEnum[ValueTypeEnum["Map"] = 'Map'] = "Map";
        ValueTypeEnum[ValueTypeEnum["List"] = 'List'] = "List";
        ValueTypeEnum[ValueTypeEnum["PropertyArray"] = 'PropertyArray'] = "PropertyArray";
        ValueTypeEnum[ValueTypeEnum["Percentage"] = 'Percentage'] = "Percentage";
        ValueTypeEnum[ValueTypeEnum["BenchmarkType"] = 'BenchmarkType'] = "BenchmarkType";
        ValueTypeEnum[ValueTypeEnum["Code"] = 'Code'] = "Code";
        ValueTypeEnum[ValueTypeEnum["Id"] = 'Id'] = "Id";
        ValueTypeEnum[ValueTypeEnum["Uri"] = 'Uri'] = "Uri";
        ValueTypeEnum[ValueTypeEnum["ArrayOfIds"] = 'ArrayOfIds'] = "ArrayOfIds";
        ValueTypeEnum[ValueTypeEnum["ArrayOfTransactionAliases"] = 'ArrayOfTransactionAliases'] = "ArrayOfTransactionAliases";
        ValueTypeEnum[ValueTypeEnum["ArrayofTransactionMovements"] = 'ArrayofTransactionMovements'] = "ArrayofTransactionMovements";
        ValueTypeEnum[ValueTypeEnum["ArrayofUnits"] = 'ArrayofUnits'] = "ArrayofUnits";
        ValueTypeEnum[ValueTypeEnum["StringArray"] = 'StringArray'] = "StringArray";
        ValueTypeEnum[ValueTypeEnum["CurrencyAndAmount"] = 'CurrencyAndAmount'] = "CurrencyAndAmount";
        ValueTypeEnum[ValueTypeEnum["TradePrice"] = 'TradePrice'] = "TradePrice";
        ValueTypeEnum[ValueTypeEnum["UnitCreation"] = 'UnitCreation'] = "UnitCreation";
        ValueTypeEnum[ValueTypeEnum["Currency"] = 'Currency'] = "Currency";
        ValueTypeEnum[ValueTypeEnum["UserId"] = 'UserId'] = "UserId";
        ValueTypeEnum[ValueTypeEnum["MetricValue"] = 'MetricValue'] = "MetricValue";
        ValueTypeEnum[ValueTypeEnum["QuoteId"] = 'QuoteId'] = "QuoteId";
        ValueTypeEnum[ValueTypeEnum["QuoteSeriesId"] = 'QuoteSeriesId'] = "QuoteSeriesId";
        ValueTypeEnum[ValueTypeEnum["ResourceId"] = 'ResourceId'] = "ResourceId";
        ValueTypeEnum[ValueTypeEnum["ResultValue"] = 'ResultValue'] = "ResultValue";
        ValueTypeEnum[ValueTypeEnum["CutLocalTime"] = 'CutLocalTime'] = "CutLocalTime";
        ValueTypeEnum[ValueTypeEnum["DateOrCutLabel"] = 'DateOrCutLabel'] = "DateOrCutLabel";
        ValueTypeEnum[ValueTypeEnum["Transition"] = 'Transition'] = "Transition";
        ValueTypeEnum[ValueTypeEnum["StructuredData"] = 'StructuredData'] = "StructuredData";
        ValueTypeEnum[ValueTypeEnum["StructuredDataId"] = 'StructuredDataId'] = "StructuredDataId";
        ValueTypeEnum[ValueTypeEnum["ConfigurationRecipe"] = 'ConfigurationRecipe'] = "ConfigurationRecipe";
        ValueTypeEnum[ValueTypeEnum["ConfigurationRecipeSnippet"] = 'ConfigurationRecipeSnippet'] = "ConfigurationRecipeSnippet";
    })(ValueTypeEnum = PropertyDefinition.ValueTypeEnum || (PropertyDefinition.ValueTypeEnum = {}));
    var LifeTimeEnum;
    (function (LifeTimeEnum) {
        LifeTimeEnum[LifeTimeEnum["Perpetual"] = 'Perpetual'] = "Perpetual";
        LifeTimeEnum[LifeTimeEnum["TimeVariant"] = 'TimeVariant'] = "TimeVariant";
    })(LifeTimeEnum = PropertyDefinition.LifeTimeEnum || (PropertyDefinition.LifeTimeEnum = {}));
    var TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Label"] = 'Label'] = "Label";
        TypeEnum[TypeEnum["Metric"] = 'Metric'] = "Metric";
        TypeEnum[TypeEnum["Information"] = 'Information'] = "Information";
    })(TypeEnum = PropertyDefinition.TypeEnum || (PropertyDefinition.TypeEnum = {}));
    var UnitSchemaEnum;
    (function (UnitSchemaEnum) {
        UnitSchemaEnum[UnitSchemaEnum["NoUnits"] = 'NoUnits'] = "NoUnits";
        UnitSchemaEnum[UnitSchemaEnum["Basic"] = 'Basic'] = "Basic";
        UnitSchemaEnum[UnitSchemaEnum["Iso4217Currency"] = 'Iso4217Currency'] = "Iso4217Currency";
    })(UnitSchemaEnum = PropertyDefinition.UnitSchemaEnum || (PropertyDefinition.UnitSchemaEnum = {}));
    var DomainEnum;
    (function (DomainEnum) {
        DomainEnum[DomainEnum["NotDefined"] = 'NotDefined'] = "NotDefined";
        DomainEnum[DomainEnum["Transaction"] = 'Transaction'] = "Transaction";
        DomainEnum[DomainEnum["Portfolio"] = 'Portfolio'] = "Portfolio";
        DomainEnum[DomainEnum["Holding"] = 'Holding'] = "Holding";
        DomainEnum[DomainEnum["ReferenceHolding"] = 'ReferenceHolding'] = "ReferenceHolding";
        DomainEnum[DomainEnum["TransactionConfiguration"] = 'TransactionConfiguration'] = "TransactionConfiguration";
        DomainEnum[DomainEnum["Instrument"] = 'Instrument'] = "Instrument";
        DomainEnum[DomainEnum["CutLabelDefinition"] = 'CutLabelDefinition'] = "CutLabelDefinition";
        DomainEnum[DomainEnum["Analytic"] = 'Analytic'] = "Analytic";
    })(DomainEnum = PropertyDefinition.DomainEnum || (PropertyDefinition.DomainEnum = {}));
