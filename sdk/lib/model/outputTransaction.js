...
var OutputTransaction = /** @class */ (function () {
    function OutputTransaction() {
    }
    OutputTransaction.getAttributeTypeMap = function () {
        return OutputTransaction.attributeTypeMap;
    };
    OutputTransaction.discriminator = undefined;
    OutputTransaction.attributeTypeMap = [
        {
            "name": "transactionId",
...
(function (OutputTransaction) {
    ...
    (function (TransactionStatusEnum) {
        TransactionStatusEnum[TransactionStatusEnum["Active"] = 'Active'] = "Active";
        TransactionStatusEnum[TransactionStatusEnum["Amended"] = 'Amended'] = "Amended";
        TransactionStatusEnum[TransactionStatusEnum["Cancelled"] = 'Cancelled'] = "Cancelled";
    })(TransactionStatusEnum = OutputTransaction.TransactionStatusEnum || (OutputTransaction.TransactionStatusEnum = {}));
})(OutputTransaction = exports.OutputTransaction || (exports.OutputTransaction = {}));
exports.OutputTransaction = OutputTransaction;
