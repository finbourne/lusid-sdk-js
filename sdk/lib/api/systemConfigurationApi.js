...
var SystemConfigurationApi = /** @class */ (function () {
     ...
     */
    SystemConfigurationApi.prototype.createConfigurationTransactionType = function (transactionConfigurationDataRequest) {
        var localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(transactionConfigurationDataRequest, "TransactionConfigurationDataRequest")
        };
     ...
     */
    SystemConfigurationApi.prototype.listConfigurationTransactionTypes = function () {
        var localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
     ...
     */
    SystemConfigurationApi.prototype.setConfigurationTransactionTypes = function (transactionConfigurationDataRequest) {
        var localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(transactionConfigurationDataRequest, "Array<TransactionConfigurationDataRequest>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
