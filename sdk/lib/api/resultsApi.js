...
var ResultsApi = /** @class */ (function () {
     ...
     */
    ResultsApi.prototype.getResults = function (scope, key, date, asAt, sortBy, start, limit) {
        var localVarPath = this.basePath + '/api/results/{scope}/{key}/{date}'
     ...
     */
    ResultsApi.prototype.upsertResults = function (scope, key, date, createResults) {
        var localVarPath = this.basePath + '/api/results/{scope}/{key}/{date}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)))
            .replace('{' + 'date' + '}', encodeURIComponent(String(date)));
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(createResults, "CreateResults")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
