...
var AnalyticsStoresApi = /** @class */ (function () {
     ...
     */
    AnalyticsStoresApi.prototype.createAnalyticStore = function (createAnalyticStoreRequest) {
        var localVarPath = this.basePath + '/api/analytics';
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(createAnalyticStoreRequest, "CreateAnalyticStoreRequest")
        };
     ...
     */
    AnalyticsStoresApi.prototype.deleteAnalyticStore = function (scope, year, month, day) {
        var localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}'
     ...
     */
    AnalyticsStoresApi.prototype.getAnalyticStore = function (scope, year, month, day, asAt) {
        var localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'year' + '}', encodeURIComponent(String(year)))
            .replace('{' + 'month' + '}', encodeURIComponent(String(month)))
     ...
     */
    AnalyticsStoresApi.prototype.listAnalyticStores = function (asAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/analytics';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
     ...
     */
    AnalyticsStoresApi.prototype.setAnalytics = function (scope, year, month, day, instrumentAnalytic) {
        var localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}/prices'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'year' + '}', encodeURIComponent(String(year)))
            .replace('{' + 'month' + '}', encodeURIComponent(String(month)))
            .replace('{' + 'day' + '}', encodeURIComponent(String(day)));
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(instrumentAnalytic, "Array<InstrumentAnalytic>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
