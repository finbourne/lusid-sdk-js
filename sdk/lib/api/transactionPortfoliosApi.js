...
var TransactionPortfoliosApi = /** @class */ (function () {
     ...
     */
    TransactionPortfoliosApi.prototype.buildTransactions = function (scope, code, asAt, sortBy, start, limit, propertyKeys, filter, parameters, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    TransactionPortfoliosApi.prototype.getHoldings = function (scope, code, byTaxlots, effectiveAt, asAt, sortBy, start, limit, filter, propertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    TransactionPortfoliosApi.prototype.getTransactions = function (scope, code, fromTransactionDate, toTransactionDate, asAt, sortBy, start, limit, propertyKeys, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
