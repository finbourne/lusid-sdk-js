...
var TransactionPortfoliosApi = /** @class */ (function () {
     ...
     */
    TransactionPortfoliosApi.prototype.addTransactionProperty = function (scope, code, transactionId, requestBody) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions/{transactionId}/properties'
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(requestBody, "{ [key: string]: PerpetualPropertyValue; }")
        };
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "AddTransactionPropertyResponse");
     ...
     */
    TransactionPortfoliosApi.prototype.adjustHoldings = function (scope, code, effectiveAt, adjustHoldingRequest) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(adjustHoldingRequest, "Array<AdjustHoldingRequest>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     */
    TransactionPortfoliosApi.prototype.buildTransactions = function (scope, code, asAt, sortBy, start, limit, instrumentPropertyKeys, filter, transactionQueryParameters) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions/$build'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(transactionQueryParameters, "TransactionQueryParameters")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     * @param effectiveAt The effective date of the change
     */
    TransactionPortfoliosApi.prototype.cancelAdjustHoldings = function (scope, code, effectiveAt) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'effectiveAt' + '}', encodeURIComponent(String(effectiveAt)));
     ...
     */
    TransactionPortfoliosApi.prototype.createPortfolio = function (scope, createTransactionPortfolioRequest) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(createTransactionPortfolioRequest, "CreateTransactionPortfolioRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     */
    TransactionPortfoliosApi.prototype.deleteExecutions = function (scope, code, executionIds) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/executions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    TransactionPortfoliosApi.prototype.deletePropertyFromTransaction = function (scope, code, transactionId, transactionPropertyKey) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions/{transactionId}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'transactionId' + '}', encodeURIComponent(String(transactionId)));
     ...
     */
    TransactionPortfoliosApi.prototype.deleteTransactions = function (scope, code, transactionIds) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    TransactionPortfoliosApi.prototype.getDetails = function (scope, code, effectiveAt, asAt) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/details'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    TransactionPortfoliosApi.prototype.getHoldings = function (scope, code, byTaxlots, effectiveAt, asAt, sortBy, start, limit, filter, instrumentPropertyKeys) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    TransactionPortfoliosApi.prototype.getHoldingsAdjustment = function (scope, code, effectiveAt, asAt) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdingsadjustments/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'effectiveAt' + '}', encodeURIComponent(String(effectiveAt)));
        var localVarQueryParameters = {};
     ...
     * @param filter Optional. Expression to filter the result set
     */
    TransactionPortfoliosApi.prototype.getTransactions = function (scope, code, fromTransactionDate, toTransactionDate, asAt, sortBy, start, limit, instrumentPropertyKeys, filter) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        if (fromTransactionDate !== undefined) {
            localVarQueryParameters['fromTransactionDate'] = models_1.ObjectSerializer.serialize(fromTransactionDate, "Date");
        }
        if (toTransactionDate !== undefined) {
            localVarQueryParameters['toTransactionDate'] = models_1.ObjectSerializer.serialize(toTransactionDate, "Date");
        }
        if (asAt !== undefined) {
            localVarQueryParameters['asAt'] = models_1.ObjectSerializer.serialize(asAt, "Date");
        }
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    TransactionPortfoliosApi.prototype.listHoldingsAdjustments = function (scope, code, fromEffectiveAt, toEffectiveAt, asAt) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdingsadjustments'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        ...
        if (fromEffectiveAt !== undefined) {
            localVarQueryParameters['fromEffectiveAt'] = models_1.ObjectSerializer.serialize(fromEffectiveAt, "Date");
        }
        if (toEffectiveAt !== undefined) {
            localVarQueryParameters['toEffectiveAt'] = models_1.ObjectSerializer.serialize(toEffectiveAt, "Date");
        }
        if (asAt !== undefined) {
            localVarQueryParameters['asAt'] = models_1.ObjectSerializer.serialize(asAt, "Date");
        }
     ...
     */
    TransactionPortfoliosApi.prototype.setHoldings = function (scope, code, effectiveAt, adjustHoldingRequest) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'effectiveAt' + '}', encodeURIComponent(String(effectiveAt)));
     ...
     */
    TransactionPortfoliosApi.prototype.upsertExecutions = function (scope, code, executionRequest) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/executions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(executionRequest, "Array<ExecutionRequest>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     */
    TransactionPortfoliosApi.prototype.upsertPortfolioDetails = function (scope, code, effectiveAt, createPortfolioDetails) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/details'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(createPortfolioDetails, "CreatePortfolioDetails")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     */
    TransactionPortfoliosApi.prototype.upsertTransactions = function (scope, code, transactionRequest) {
        var localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(transactionRequest, "Array<TransactionRequest>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
