...
var defaultBasePath = 'http://http:/api';
// ===============================================
...
var PortfolioGroupsApi = /** @class */ (function () {
     ...
     */
    PortfolioGroupsApi.prototype.addPortfolioToGroup = function (scope, code, portfolioId, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/portfolios'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(portfolioId, "ResourceId")
                };
     ...
     * @summary [EARLY ACCESS] Add group to group
     ...
     */
    PortfolioGroupsApi.prototype.addSubGroupToGroup = function (scope, code, portfolioGroupId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/subgroups'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                    .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(portfolioGroupId, "ResourceId")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
     ...
     * @summary [EARLY ACCESS] Create group
     ...
     */
    PortfolioGroupsApi.prototype.createPortfolioGroup = function (scope, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "CreatePortfolioGroupRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
     ...
     * @summary [EARLY ACCESS] Remove portfolio from group
     ...
     */
    PortfolioGroupsApi.prototype.deletePortfolioFromGroup = function (scope, code, portfolioScope, portfolioCode, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     * @summary [EARLY ACCESS] Delete group
     * @param scope The scope of the portfolio group
     * @param code The code of the portfolio group
     */
     ...
     * @summary [EARLY ACCESS] Remove group from group
     * @param scope The scope of the portfolio group
     * @param code The code of the portfolio group
     * @param subgroupScope The scope of the sub-group being removed
     * @param subgroupCode The code of the sub-group being removed
     */
    PortfolioGroupsApi.prototype.deleteSubGroupFromGroup = function (scope, code, subgroupScope, subgroupCode, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PortfolioGroupsApi.prototype.getPortfolioGroup = function (scope, code, asAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PortfolioGroupsApi.prototype.getPortfolioGroupCommands = function (scope, code, fromAsAt, toAsAt, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     * @summary [EARLY ACCESS] Get a full expansion of a portfolio group
     ...
     * @summary [EARLY ACCESS] List groups in scope
     ...
     * @param filter Optional. Expression to filter the result set
     */
    PortfolioGroupsApi.prototype.listPortfolioGroups = function (scope, asAt, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     * @summary [EARLY ACCESS] Update group
     * @param scope The scope of the portfolio group
     * @param code The code of the portfolio group
     * @param request The updated definition of the portfolio group
     */
    PortfolioGroupsApi.prototype.updatePortfolioGroup = function (scope, code, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "UpdatePortfolioGroupRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
