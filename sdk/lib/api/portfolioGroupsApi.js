...
// ===============================================
var PortfolioGroupsApiApiKeys;
(function (PortfolioGroupsApiApiKeys) {
})(PortfolioGroupsApiApiKeys = exports.PortfolioGroupsApiApiKeys || (exports.PortfolioGroupsApiApiKeys = {}));
var PortfolioGroupsApi = /** @class */ (function () {
    function PortfolioGroupsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PortfolioGroupsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PortfolioGroupsApi.prototype, "basePath", {
        get: function () {
    ...
    PortfolioGroupsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PortfolioGroupsApi.prototype.setApiKey = function (key, value) {
        this.authentications[PortfolioGroupsApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(PortfolioGroupsApi.prototype, "accessToken", {
        set: function (token) {
     ...
     * @param resourceId The id of the portfolio
     */
    PortfolioGroupsApi.prototype.addPortfolioToGroup = function (scope, code, resourceId) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/portfolios'
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(resourceId, "ResourceId")
        };
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "PortfolioGroup");
     ...
     * @param resourceId The id of the portfolio group being added as a sub-group
     */
    PortfolioGroupsApi.prototype.addSubGroupToGroup = function (scope, code, resourceId) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/subgroups'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param createPortfolioGroupRequest The definition of the new portfolio group
     */
    PortfolioGroupsApi.prototype.createPortfolioGroup = function (scope, createPortfolioGroupRequest) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(createPortfolioGroupRequest, "CreatePortfolioGroupRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     */
    PortfolioGroupsApi.prototype.deletePortfolioFromGroup = function (scope, code, portfolioScope, portfolioCode) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/portfolios/{portfolioScope}/{portfolioCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
     ...
     * @param code The code of the portfolio group
     */
    PortfolioGroupsApi.prototype.deletePortfolioGroup = function (scope, code) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    PortfolioGroupsApi.prototype.deleteSubGroupFromGroup = function (scope, code, subgroupScope, subgroupCode) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/subgroups/{subgroupScope}/{subgroupCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
     ...
     */
    PortfolioGroupsApi.prototype.getPortfolioGroup = function (scope, code, asAt) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
     ...
     */
    PortfolioGroupsApi.prototype.getPortfolioGroupCommands = function (scope, code, fromAsAt, toAsAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/commands'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        ...
        if (fromAsAt !== undefined) {
            localVarQueryParameters['fromAsAt'] = models_1.ObjectSerializer.serialize(fromAsAt, "Date");
        }
        if (toAsAt !== undefined) {
            localVarQueryParameters['toAsAt'] = models_1.ObjectSerializer.serialize(toAsAt, "Date");
        }
        if (sortBy !== undefined) {
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfProcessedCommand");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
     ...
     */
    PortfolioGroupsApi.prototype.getPortfolioGroupExpansion = function (scope, code, effectiveAt, asAt, propertyFilter) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/expansion'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        ...
        if (effectiveAt !== undefined) {
            localVarQueryParameters['effectiveAt'] = models_1.ObjectSerializer.serialize(effectiveAt, "Date");
        }
        if (asAt !== undefined) {
            localVarQueryParameters['asAt'] = models_1.ObjectSerializer.serialize(asAt, "Date");
        }
        if (propertyFilter !== undefined) {
            localVarQueryParameters['propertyFilter'] = models_1.ObjectSerializer.serialize(propertyFilter, "Array<string>");
        }
        var localVarUseFormData = false;
        var localVarRequestOptions = {
            method: 'GET',
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "ExpandedGroup");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    PortfolioGroupsApi.prototype.listPortfolioGroups = function (scope, asAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfPortfolioGroup");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
     ...
     * @param scope The scope of the portfolio group
     * @param code The code of the portfolio group
     * @param updatePortfolioGroupRequest The updated definition of the portfolio group
     */
    PortfolioGroupsApi.prototype.updatePortfolioGroup = function (scope, code, updatePortfolioGroupRequest) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(updatePortfolioGroupRequest, "UpdatePortfolioGroupRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
