...
var ApplicationMetadataApi = /** @class */ (function () {
     ...
     */
    ApplicationMetadataApi.prototype.getExcelAddin = function (version) {
        var localVarPath = this.basePath + '/api/metadata/downloads/exceladdin';
     ...
     * @param version The requested version of the Excel plugin
     */
    ApplicationMetadataApi.prototype.getExcelDownloadUrl = function (version) {
        var localVarPath = this.basePath + '/api/metadata/downloads/excel';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (version !== undefined) {
     ...
     */
    ApplicationMetadataApi.prototype.getLusidVersions = function () {
        var localVarPath = this.basePath + '/api/metadata/versions';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        var localVarUseFormData = false;
