...
var ReferencePortfolioApi = /** @class */ (function () {
     ...
     * @param createReferencePortfolioRequest The portfolio creation request object
     */
    ReferencePortfolioApi.prototype.createReferencePortfolio = function (scope, createReferencePortfolioRequest) {
        var localVarPath = this.basePath + '/api/referenceportfolios/{scope}'
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(createReferencePortfolioRequest, "CreateReferencePortfolioRequest")
        };
     ...
     * @param effectiveAt Optional. The effective date of the constituents to retrieve
     ...
     * @param instrumentPropertyKeys Optional. The Properties of the constituents
     */
    ReferencePortfolioApi.prototype.getReferencePortfolioConstituents = function (scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys) {
        var localVarPath = this.basePath + '/api/referenceportfolios/{scope}/{code}/constituents'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     */
    ReferencePortfolioApi.prototype.listConstituentsAdjustments = function (scope, code, fromEffectiveAt, toEffectiveAt, asAtTime) {
        var localVarPath = this.basePath + '/api/referenceportfolios/{scope}/{code}/constituentsadjustments'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param scope The scope of the portfolio
     * @param code The code of the portfolio
     * @param upsertReferencePortfolioConstituentsRequest The constituents to upload to the portfolio
     */
    ReferencePortfolioApi.prototype.upsertReferencePortfolioConstituents = function (scope, code, upsertReferencePortfolioConstituentsRequest) {
        var localVarPath = this.basePath + '/api/referenceportfolios/{scope}/{code}/constituents'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(upsertReferencePortfolioConstituentsRequest, "UpsertReferencePortfolioConstituentsRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
