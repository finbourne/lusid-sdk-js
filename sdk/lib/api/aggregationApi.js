...
var AggregationApi = /** @class */ (function () {
     ...
     */
    AggregationApi.prototype.getAggregationByGroup = function (scope, code, sortBy, start, limit, aggregationRequest) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/$aggregate'
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(aggregationRequest, "AggregationRequest")
        };
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    AggregationApi.prototype.getAggregationByPortfolio = function (scope, code, sortBy, start, limit, aggregationRequest) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/$aggregate'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    AggregationApi.prototype.getAggregationByResultSet = function (scope, resultsKey, sortBy, start, limit, aggregationRequest) {
        var localVarPath = this.basePath + '/api/results/{scope}/{resultsKey}/$aggregate'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    AggregationApi.prototype.getNestedAggregationByGroup = function (scope, code, aggregationRequest) {
        var localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/$aggregatenested'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
