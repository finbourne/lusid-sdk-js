...
export declare class TransactionPortfoliosApi {
     ...
     */
    addTransactionProperty(scope: string, code: string, transactionId: string, requestBody?: {
     ...
     */
    adjustHoldings(scope: string, code: string, effectiveAt: Date, adjustHoldingRequest?: Array<AdjustHoldingRequest>): Promise<{
        response: http.ClientResponse;
        body: AdjustHolding;
    }>;
    /**
     ...
     */
    buildTransactions(scope: string, code: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>, filter?: string, transactionQueryParameters?: TransactionQueryParameters): Promise<{
        response: http.ClientResponse;
     ...
     * @param effectiveAt The effective date of the change
     */
    cancelAdjustHoldings(scope: string, code: string, effectiveAt: Date): Promise<{
        response: http.ClientResponse;
     ...
     */
    createPortfolio(scope: string, createTransactionPortfolioRequest?: CreateTransactionPortfolioRequest): Promise<{
        response: http.ClientResponse;
        body: Portfolio;
    }>;
    /**
     ...
     */
    deleteExecutions(scope: string, code: string, executionIds?: Array<string>): Promise<{
        response: http.ClientResponse;
        body: DeletedEntityResponse;
    }>;
    /**
     ...
     */
    deletePropertyFromTransaction(scope: string, code: string, transactionId: string, transactionPropertyKey?: string): Promise<{
        response: http.ClientResponse;
        body: DeletedEntityResponse;
    }>;
    /**
     ...
     */
    deleteTransactions(scope: string, code: string, transactionIds?: Array<string>): Promise<{
        response: http.ClientResponse;
        body: DeletedEntityResponse;
    }>;
    /**
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    getDetails(scope: string, code: string, effectiveAt?: Date, asAt?: Date): Promise<{
        response: http.ClientResponse;
     ...
     */
    getHoldings(scope: string, code: string, byTaxlots?: boolean, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>): Promise<{
        response: http.ClientResponse;
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    getHoldingsAdjustment(scope: string, code: string, effectiveAt: Date, asAt?: Date): Promise<{
        response: http.ClientResponse;
     ...
     * @param filter Optional. Expression to filter the result set
     */
    getTransactions(scope: string, code: string, fromTransactionDate?: Date, toTransactionDate?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>, filter?: string): Promise<{
        response: http.ClientResponse;
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    listHoldingsAdjustments(scope: string, code: string, fromEffectiveAt?: Date, toEffectiveAt?: Date, asAt?: Date): Promise<{
        response: http.ClientResponse;
     ...
     */
    setHoldings(scope: string, code: string, effectiveAt: Date, adjustHoldingRequest?: Array<AdjustHoldingRequest>): Promise<{
        response: http.ClientResponse;
        body: AdjustHolding;
    }>;
    /**
     ...
     */
    upsertExecutions(scope: string, code: string, executionRequest?: Array<ExecutionRequest>): Promise<{
        response: http.ClientResponse;
     ...
     */
    upsertPortfolioDetails(scope: string, code: string, effectiveAt?: Date, createPortfolioDetails?: CreatePortfolioDetails): Promise<{
        response: http.ClientResponse;
        body: PortfolioDetails;
    }>;
    /**
     ...
     */
    upsertTransactions(scope: string, code: string, transactionRequest?: Array<TransactionRequest>): Promise<{
        response: http.ClientResponse;
