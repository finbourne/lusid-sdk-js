...
export declare class PortfoliosApi {
     ...
     */
    deletePortfolio(scope: string, code: string, effectiveAt?: Date): Promise<{
     ...
     */
    deletePortfolioProperties(scope: string, code: string, effectiveAt?: Date, portfolioPropertyKeys?: Array<string>): Promise<{
        response: http.ClientResponse;
        body: DeletedEntityResponse;
    }>;
    /**
     ...
     */
    getPortfolio(scope: string, code: string, effectiveAt?: Date, asAt?: Date): Promise<{
        response: http.ClientResponse;
        body: Portfolio;
    }>;
    /**
     ...
     */
    getPortfolioCommands(scope: string, code: string, fromAsAt?: Date, toAsAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string): Promise<{
        response: http.ClientResponse;
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     */
    getPortfolioProperties(scope: string, code: string, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number): Promise<{
        response: http.ClientResponse;
     ...
     */
    listPortfolios(effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, query?: string): Promise<{
        response: http.ClientResponse;
     ...
     * @param filter Optional. Expression to filter the result set
     */
    listPortfoliosForScope(scope: string, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string): Promise<{
        response: http.ClientResponse;
        body: ResourceListOfPortfolio;
    }>;
    /**
     ...
     */
    updatePortfolio(scope: string, code: string, effectiveAt?: Date, updatePortfolioRequest?: UpdatePortfolioRequest): Promise<{
        response: http.ClientResponse;
        body: Portfolio;
    }>;
    /**
     ...
     */
    upsertPortfolioProperties(scope: string, code: string, effectiveAt?: Date, requestBody?: {
