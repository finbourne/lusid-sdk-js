...
var SearchApi = /** @class */ (function () {
     ...
     * @param masteredEffectiveAt Optional. The effective date for searching mastered instruments. If this is not set, then the current date is taken.  This parameter has no effect on instruments that have not been mastered within LUSID.
     * @param masteredOnly Optional. If set to true, only search over instruments that have been mastered within LUSID. Default to false
     * @param instrumentSearchProperty A collection of instrument symbols to search for
     */
    SearchApi.prototype.instrumentsSearch = function (masteredEffectiveAt, masteredOnly, instrumentSearchProperty) {
        var localVarPath = this.basePath + '/api/search/instruments';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (masteredEffectiveAt !== undefined) {
            localVarQueryParameters['masteredEffectiveAt'] = models_1.ObjectSerializer.serialize(masteredEffectiveAt, "Date");
        }
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(instrumentSearchProperty, "Array<InstrumentSearchProperty>")
        };
     ...
     * @param body A valid Elasticsearch 5.x request
     */
    SearchApi.prototype.portfolioGroupsSearch = function (sortBy, start, limit, filter, body) {
        var localVarPath = this.basePath + '/api/search/portfoliogroups';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (sortBy !== undefined) {
     ...
     * @param body A valid Elasticsearch 5.x request
     */
    SearchApi.prototype.portfoliosSearch = function (sortBy, start, limit, filter, body) {
        var localVarPath = this.basePath + '/api/search/portfolios';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (sortBy !== undefined) {
     ...
     * @param body A valid Elasticsearch 5.x request
     */
    SearchApi.prototype.propertiesSearch = function (sortBy, start, limit, filter, body) {
        var localVarPath = this.basePath + '/api/search/propertydefinitions';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (sortBy !== undefined) {
