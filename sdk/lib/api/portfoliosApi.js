...
var PortfoliosApi = /** @class */ (function () {
     ...
     */
    PortfoliosApi.prototype.listPortfolios = function (effectiveAt, asAt, page, sortBy, start, limit, filter, query, portfolioPropertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     * @param portfolioPropertyKeys Optional. Keys of the properties to be decorated on to the portfolio
     */
    PortfoliosApi.prototype.listPortfoliosForScope = function (scope, effectiveAt, asAt, sortBy, start, limit, filter, portfolioPropertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
