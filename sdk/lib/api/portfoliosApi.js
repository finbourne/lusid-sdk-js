...
var PortfoliosApi = /** @class */ (function () {
     ...
     * @param effectiveAt The effective datetime at which to delete the properties. Defaults to the current LUSID system datetime if not specified.
     */
     ...
     * @param effectiveAt The effective datetime at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified.
     ...
     * @param effectiveAt The effective datetime at which to list the portfolio\&#39;s properties. Defaults to the current LUSID system datetime if not specified.
     ...
     * @param effectiveAt The effective datetime at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified.
     ...
     * @param effectiveAt The effective datetime at which to update the definition. Defaults to the current              LUSID system datetime if not specified.
