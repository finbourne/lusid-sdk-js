...
var PortfoliosApi = /** @class */ (function () {
     ...
     */
    PortfoliosApi.prototype.deletePortfolio = function (scope, code, effectiveAt) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}'
     ...
     */
    PortfoliosApi.prototype.deletePortfolioProperties = function (scope, code, effectiveAt, portfolioPropertyKeys) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    PortfoliosApi.prototype.getPortfolio = function (scope, code, effectiveAt, asAt) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
     ...
     */
    PortfoliosApi.prototype.getPortfolioCommands = function (scope, code, fromAsAt, toAsAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/commands'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     */
    PortfoliosApi.prototype.getPortfolioProperties = function (scope, code, effectiveAt, asAt, sortBy, start, limit) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
     ...
     */
    PortfoliosApi.prototype.listPortfolios = function (effectiveAt, asAt, sortBy, start, limit, filter, query) {
        var localVarPath = this.basePath + '/api/portfolios';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (effectiveAt !== undefined) {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    PortfoliosApi.prototype.listPortfoliosForScope = function (scope, effectiveAt, asAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
     ...
     */
    PortfoliosApi.prototype.updatePortfolio = function (scope, code, effectiveAt, updatePortfolioRequest) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(updatePortfolioRequest, "UpdatePortfolioRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     */
    PortfoliosApi.prototype.upsertPortfolioProperties = function (scope, code, effectiveAt, requestBody) {
        var localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(requestBody, "{ [key: string]: PropertyValue; }")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
