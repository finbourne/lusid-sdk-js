...
var PortfoliosApi = /** @class */ (function () {
     ...
     */
    PortfoliosApi.prototype.deletePortfolio = function (scope, code, effectiveAt, options) {
     ...
     */
    PortfoliosApi.prototype.deletePortfolioProperties = function (scope, code, effectiveAt, portfolioPropertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PortfoliosApi.prototype.getPortfolioCommands = function (scope, code, fromAsAt, toAsAt, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     */
    PortfoliosApi.prototype.getPortfolioProperties = function (scope, code, effectiveAt, asAt, sortBy, start, limit, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PortfoliosApi.prototype.listPortfolios = function (effectiveAt, asAt, page, sortBy, start, limit, filter, query, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    PortfoliosApi.prototype.listPortfoliosForScope = function (scope, effectiveAt, asAt, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PortfoliosApi.prototype.upsertPortfolioProperties = function (scope, code, effectiveAt, portfolioProperties, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(portfolioProperties, "{ [key: string]: PropertyValue; }")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
