...
var DerivedTransactionPortfoliosApi = /** @class */ (function () {
     ...
     */
    DerivedTransactionPortfoliosApi.prototype.createDerivedPortfolio = function (scope, portfolio, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/derivedtransactionportfolios/{scope}'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(portfolio, "CreateDerivedTransactionPortfolioRequest")
                };
     ...
     */
    DerivedTransactionPortfoliosApi.prototype.deleteDerivedPortfolioDetails = function (scope, code, effectiveAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/derivedtransactionportfolios/{scope}/{code}/details'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
