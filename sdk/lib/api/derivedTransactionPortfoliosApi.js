...
// ===============================================
var DerivedTransactionPortfoliosApiApiKeys;
(function (DerivedTransactionPortfoliosApiApiKeys) {
})(DerivedTransactionPortfoliosApiApiKeys = exports.DerivedTransactionPortfoliosApiApiKeys || (exports.DerivedTransactionPortfoliosApiApiKeys = {}));
var DerivedTransactionPortfoliosApi = /** @class */ (function () {
    function DerivedTransactionPortfoliosApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(DerivedTransactionPortfoliosApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(DerivedTransactionPortfoliosApi.prototype, "basePath", {
        get: function () {
    ...
    DerivedTransactionPortfoliosApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    DerivedTransactionPortfoliosApi.prototype.setApiKey = function (key, value) {
        this.authentications[DerivedTransactionPortfoliosApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(DerivedTransactionPortfoliosApi.prototype, "accessToken", {
        set: function (token) {
     ...
     * @param createDerivedTransactionPortfolioRequest The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope
     */
    DerivedTransactionPortfoliosApi.prototype.createDerivedPortfolio = function (scope, createDerivedTransactionPortfolioRequest) {
        var localVarPath = this.basePath + '/api/derivedtransactionportfolios/{scope}'
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(createDerivedTransactionPortfolioRequest, "CreateDerivedTransactionPortfolioRequest")
        };
     ...
     */
    DerivedTransactionPortfoliosApi.prototype.deleteDerivedPortfolioDetails = function (scope, code, effectiveAt) {
        var localVarPath = this.basePath + '/api/derivedtransactionportfolios/{scope}/{code}/details'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
    ...
    return DerivedTransactionPortfoliosApi;
}());
exports.DerivedTransactionPortfoliosApi = DerivedTransactionPortfoliosApi;
