...
var InstrumentsApi = /** @class */ (function () {
     ...
     */
    InstrumentsApi.prototype.findInstruments = function (effectiveAt, asAt, instrumentPropertyKeys, aliases, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/$find';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(aliases, "Array<Property>")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
     ...
     */
    InstrumentsApi.prototype.getInstrumentIdentifiers = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/identifiers';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                Object.assign(localVarHeaderParams, options.headers);
     ...
     * @param identifiers The identifiers of the instruments to get
     */
    InstrumentsApi.prototype.matchInstruments = function (identifierType, identifiers, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/$match';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                if (identifierType !== undefined) {
