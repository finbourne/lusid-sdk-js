...
var InstrumentsApi = /** @class */ (function () {
     ...
     */
    InstrumentsApi.prototype.deleteInstrument = function (identifierType, identifier) {
        var localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
     ...
     * @param property The list of market aliases (e.g ISIN, Ticker) to find instruments by.
     */
    InstrumentsApi.prototype.findInstruments = function (effectiveAt, asAt, instrumentPropertyKeys, property) {
        var localVarPath = this.basePath + '/api/instruments/$find';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(property, "Array<Property>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    InstrumentsApi.prototype.getInstrument = function (identifierType, identifier, effectiveAt, asAt, instrumentPropertyKeys) {
        var localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        var localVarQueryParameters = {};
     ...
     */
    InstrumentsApi.prototype.getInstrumentIdentifiers = function () {
        var localVarPath = this.basePath + '/api/instruments/identifiers';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        var localVarUseFormData = false;
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfString");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
     ...
     * @param requestBody The identifiers of the instruments to get
     * @param effectiveAt Optional. The effective date of the request
     * @param asAt Optional. The as at date of the request
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    InstrumentsApi.prototype.getInstruments = function (identifierType, requestBody, effectiveAt, asAt, instrumentPropertyKeys) {
        var localVarPath = this.basePath + '/api/instruments/$get';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        // verify required parameter 'identifierType' is not null or undefined
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    InstrumentsApi.prototype.listInstruments = function (asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys) {
        var localVarPath = this.basePath + '/api/instruments';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (asAt !== undefined) {
     ...
     * @param requestBody The identifiers of the instruments to get
     */
    InstrumentsApi.prototype.matchInstruments = function (identifierType, requestBody) {
        var localVarPath = this.basePath + '/api/instruments/$match';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (identifierType !== undefined) {
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "MatchInstrumentsResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    }
                    else {
     ...
     * @param identifierType The type of identifier being supplied
     * @param identifier The instrument identifier
     * @param updateInstrumentIdentifierRequest The identifier to add, update, or remove
     */
    InstrumentsApi.prototype.updateInstrumentIdentifier = function (identifierType, identifier, updateInstrumentIdentifierRequest) {
        var localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(updateInstrumentIdentifierRequest, "UpdateInstrumentIdentifierRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     * @param requestBody The instrument definitions
     */
    InstrumentsApi.prototype.upsertInstruments = function (requestBody) {
        var localVarPath = this.basePath + '/api/instruments';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(requestBody, "{ [key: string]: InstrumentDefinition; }")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     * @param upsertInstrumentPropertyRequest The instrument property data
     */
    InstrumentsApi.prototype.upsertInstrumentsProperties = function (upsertInstrumentPropertyRequest) {
        var localVarPath = this.basePath + '/api/instruments/$upsertproperties';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        var localVarUseFormData = false;
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(upsertInstrumentPropertyRequest, "Array<UpsertInstrumentPropertyRequest>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
