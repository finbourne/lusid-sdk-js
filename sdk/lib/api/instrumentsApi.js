...
var InstrumentsApi = /** @class */ (function () {
     ...
     * @param effectiveAt The effective datetime at which to retrieve the instrument definition.              Defaults to the current LUSID system datetime if not specified.
     ...
     * @summary [EARLY ACCESS] Get instrument identifiers
     */
     ...
     * @param effectiveAt The effective datetime at which to retrieve the instrument definitions.              Defaults to the current LUSID system datetime if not specified.
     ...
     * @param effectiveAt The effective datetime at which to list the instruments.              Defaults to the current LUSID system datetime if not specified.
