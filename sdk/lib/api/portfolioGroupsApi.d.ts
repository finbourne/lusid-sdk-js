...
export declare class PortfolioGroupsApi {
     ...
     */
    getPortfolioGroupCommands(scope: string, code: string, fromAsAt?: Date, toAsAt?: Date, filter?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     */
    listPortfolioGroups(scope: string, asAt?: Date, filter?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
