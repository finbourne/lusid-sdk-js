...
export declare enum PortfolioGroupsApiApiKeys {
}
export declare class PortfolioGroupsApi {
    ...
    setApiKey(key: PortfolioGroupsApiApiKeys, value: string): void;
    accessToken: string;
    /**
     ...
     */
    addPortfolioToGroup(scope: string, code: string, resourceId?: ResourceId): Promise<{
     ...
     */
    addSubGroupToGroup(scope: string, code: string, resourceId?: ResourceId): Promise<{
        response: http.ClientResponse;
        body: PortfolioGroup;
    }>;
    /**
     ...
     */
    createPortfolioGroup(scope: string, createPortfolioGroupRequest?: CreatePortfolioGroupRequest): Promise<{
        response: http.ClientResponse;
        body: PortfolioGroup;
    }>;
    /**
     ...
     */
    deletePortfolioFromGroup(scope: string, code: string, portfolioScope: string, portfolioCode: string): Promise<{
        response: http.ClientResponse;
        body: PortfolioGroup;
    }>;
    /**
     ...
     * @param code The code of the portfolio group
     */
    deletePortfolioGroup(scope: string, code: string): Promise<{
        response: http.ClientResponse;
     ...
     */
    deleteSubGroupFromGroup(scope: string, code: string, subgroupScope: string, subgroupCode: string): Promise<{
        response: http.ClientResponse;
        body: PortfolioGroup;
    }>;
    /**
     ...
     */
    getPortfolioGroup(scope: string, code: string, asAt?: Date): Promise<{
        response: http.ClientResponse;
        body: PortfolioGroup;
    }>;
    /**
     ...
     */
    getPortfolioGroupCommands(scope: string, code: string, fromAsAt?: Date, toAsAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string): Promise<{
        response: http.ClientResponse;
     ...
     */
    getPortfolioGroupExpansion(scope: string, code: string, effectiveAt?: Date, asAt?: Date, propertyFilter?: Array<string>): Promise<{
        response: http.ClientResponse;
        body: ExpandedGroup;
    }>;
    /**
     ...
     * @param filter Optional. Expression to filter the result set
     */
    listPortfolioGroups(scope: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string): Promise<{
        response: http.ClientResponse;
        body: ResourceListOfPortfolioGroup;
    }>;
    /**
     ...
     */
    updatePortfolioGroup(scope: string, code: string, updatePortfolioGroupRequest?: UpdatePortfolioGroupRequest): Promise<{
        response: http.ClientResponse;
        body: PortfolioGroup;
    }>;
}
