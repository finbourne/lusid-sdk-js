...
var ReconciliationsApi = /** @class */ (function () {
     ...
     */
    ReconciliationsApi.prototype.reconcileHoldings = function (sortBy, start, limit, filter, portfoliosReconciliationRequest) {
        var localVarPath = this.basePath + '/api/portfolios/$reconcileholdings';
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(portfoliosReconciliationRequest, "PortfoliosReconciliationRequest")
        };
     ...
     * @summary Reconcile valuations performed on one or two sets of holdings using one or two configuration recipes.
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName
     * @param start Optional. When paginating, skip this number of results
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     * @param filter Optional. Expression to filter the result set
     ...
     */
    ReconciliationsApi.prototype.reconcileValuation = function (sortBy, start, limit, filter, valuationsReconciliationRequest) {
        var localVarPath = this.basePath + '/api/portfolios/$reconcileValuation';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        if (sortBy !== undefined) {
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(valuationsReconciliationRequest, "ValuationsReconciliationRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
