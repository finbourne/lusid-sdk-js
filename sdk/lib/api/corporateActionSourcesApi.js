...
var CorporateActionSourcesApi = /** @class */ (function () {
     ...
     * @param createCorporateAction The corporate action definitions
     */
    CorporateActionSourcesApi.prototype.batchUpsertCorporateActions = function (scope, code, createCorporateAction) {
        var localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/corporateactions'
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(createCorporateAction, "Array<CreateCorporateAction>")
        };
     ...
     */
    CorporateActionSourcesApi.prototype.createCorporateActionSource = function (createCorporateActionSourceRequest) {
        var localVarPath = this.basePath + '/api/corporateactionsources';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(createCorporateActionSourceRequest, "CreateCorporateActionSourceRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     * @param effectiveAt Optional. The start effective date of the data
     */
    CorporateActionSourcesApi.prototype.deleteCorporateActionSource = function (scope, code, effectiveAt) {
        var localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    CorporateActionSourcesApi.prototype.getCorporateActions = function (scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/corporateactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
     ...
     * @param effectiveAt Optional. The start effective date of the data range
     * @param asAt Optional. The AsAt date of the data
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName
     * @param start Optional. When paginating, skip this number of results
     * @param limit Optional. When paginating, limit the number of returned results to this many
     * @param filter Optional. Expression to filter the result set
     */
    CorporateActionSourcesApi.prototype.listCorporateActionSources = function (effectiveAt, asAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/corporateactionsources';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
