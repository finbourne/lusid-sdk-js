...
// ===============================================
var ConfigurationRecipeApiApiKeys;
(function (ConfigurationRecipeApiApiKeys) {
})(ConfigurationRecipeApiApiKeys = exports.ConfigurationRecipeApiApiKeys || (exports.ConfigurationRecipeApiApiKeys = {}));
var ConfigurationRecipeApi = /** @class */ (function () {
    function ConfigurationRecipeApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ConfigurationRecipeApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ConfigurationRecipeApi.prototype, "basePath", {
        get: function () {
    ...
    ConfigurationRecipeApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ConfigurationRecipeApi.prototype.setApiKey = function (key, value) {
        this.authentications[ConfigurationRecipeApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(ConfigurationRecipeApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    ConfigurationRecipeApi.prototype.deleteConfigurationRecipe = function (scope, code, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/recipes/{scope}/{code}'
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "AnnulSingleStructuredDataResponse");
     ...
     */
    ConfigurationRecipeApi.prototype.getConfigurationRecipe = function (scope, code, asAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "GetRecipeResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    ConfigurationRecipeApi.prototype.upsertConfigurationRecipe = function (scope, structuredData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/recipes/{scope}'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(structuredData, "UpsertRecipeRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "UpsertSingleStructuredDataResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
    ...
    return ConfigurationRecipeApi;
}());
exports.ConfigurationRecipeApi = ConfigurationRecipeApi;
