...
var PropertyDefinitionsApi = /** @class */ (function () {
     ...
     */
    PropertyDefinitionsApi.prototype.createPropertyDefinition = function (createPropertyDefinitionRequest) {
        var localVarPath = this.basePath + '/api/propertydefinitions';
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(createPropertyDefinitionRequest, "CreatePropertyDefinitionRequest")
        };
     ...
     */
    PropertyDefinitionsApi.prototype.deletePropertyDefinition = function (domain, scope, code) {
        var localVarPath = this.basePath + '/api/propertydefinitions/{domain}/{scope}/{code}'
     ...
     */
    PropertyDefinitionsApi.prototype.getMultiplePropertyDefinitions = function (propertyKeys, asAt, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/propertydefinitions';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    PropertyDefinitionsApi.prototype.getPropertyDefinition = function (domain, scope, code, asAt) {
        var localVarPath = this.basePath + '/api/propertydefinitions/{domain}/{scope}/{code}'
            .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
     ...
     */
    PropertyDefinitionsApi.prototype.updatePropertyDefinition = function (domain, scope, code, updatePropertyDefinitionRequest) {
        var localVarPath = this.basePath + '/api/propertydefinitions/{domain}/{scope}/{code}'
            .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(updatePropertyDefinitionRequest, "UpdatePropertyDefinitionRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
