...
var QuotesApi = /** @class */ (function () {
     ...
     */
    QuotesApi.prototype.deleteQuotes = function (scope, deleteQuoteRequest) {
        var localVarPath = this.basePath + '/api/quotes/{scope}/$delete'
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(deleteQuoteRequest, "Array<DeleteQuoteRequest>")
        };
        ...
        return new Promise(function (resolve, reject) {
            localVarRequest(localVarRequestOptions, function (error, response, body) {
                if (error) {
                    ...
                    body = models_1.ObjectSerializer.deserialize(body, "DeleteQuotesResponse");
     ...
     */
    QuotesApi.prototype.getQuotes = function (scope, effectiveAt, asAt, maxAge, page, limit, quoteId) {
        var localVarPath = this.basePath + '/api/quotes/{scope}/$get'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(quoteId, "Array<QuoteId>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
     ...
     */
    QuotesApi.prototype.upsertQuotes = function (scope, upsertQuoteRequest) {
        var localVarPath = this.basePath + '/api/quotes/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(upsertQuoteRequest, "Array<UpsertQuoteRequest>")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
