...
var DataTypesApi = /** @class */ (function () {
     ...
     */
    DataTypesApi.prototype.createDataType = function (createDataTypeRequest) {
        var localVarPath = this.basePath + '/api/datatypes';
        ...
        var localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(createDataTypeRequest, "CreateDataTypeRequest")
        };
     ...
     */
    DataTypesApi.prototype.getDataType = function (scope, code) {
        var localVarPath = this.basePath + '/api/datatypes/{scope}/{code}'
     ...
     */
    DataTypesApi.prototype.getUnitsFromDataType = function (scope, code, units, filter) {
        var localVarPath = this.basePath + '/api/datatypes/{scope}/{code}/units'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param filter Optional. Expression to filter the result set
     */
    DataTypesApi.prototype.listDataTypes = function (scope, includeDefault, includeSystem, sortBy, start, limit, filter) {
        var localVarPath = this.basePath + '/api/datatypes/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        ...
        if (includeDefault !== undefined) {
            localVarQueryParameters['includeDefault'] = models_1.ObjectSerializer.serialize(includeDefault, "boolean");
        }
     ...
     */
    DataTypesApi.prototype.updateDataType = function (scope, code, updateDataTypeRequest) {
        var localVarPath = this.basePath + '/api/datatypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        var localVarQueryParameters = {};
        ...
        var localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(updateDataTypeRequest, "UpdateDataTypeRequest")
        };
        this.authentications.oauth2.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
