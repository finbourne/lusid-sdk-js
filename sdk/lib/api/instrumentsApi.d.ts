...
export declare class InstrumentsApi {
     ...
     */
    deleteInstrument(identifierType: string, identifier: string): Promise<{
     ...
     */
    findInstruments(effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>, property?: Array<Property>): Promise<{
        response: http.ClientResponse;
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    getInstrument(identifierType: string, identifier: string, effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>): Promise<{
        response: http.ClientResponse;
        body: Instrument;
    }>;
    /**
     ...
     */
    getInstrumentIdentifiers(): Promise<{
        response: http.ClientResponse;
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    getInstruments(identifierType: string, requestBody: Array<string>, effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>): Promise<{
        response: http.ClientResponse;
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    listInstruments(asAt?: Date, effectiveAt?: Date, page?: string, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>): Promise<{
        response: http.ClientResponse;
        body: ResourceListOfInstrument;
    }>;
    /**
     ...
     * @param requestBody The identifiers of the instruments to get
     */
    matchInstruments(identifierType?: string, requestBody?: Array<string>): Promise<{
        response: http.ClientResponse;
     ...
     */
    updateInstrumentIdentifier(identifierType: string, identifier: string, updateInstrumentIdentifierRequest?: UpdateInstrumentIdentifierRequest): Promise<{
        response: http.ClientResponse;
        body: Instrument;
    }>;
    /**
     ...
     */
    upsertInstrumentsProperties(upsertInstrumentPropertyRequest?: Array<UpsertInstrumentPropertyRequest>): Promise<{
        response: http.ClientResponse;
