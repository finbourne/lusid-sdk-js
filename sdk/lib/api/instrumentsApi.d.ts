...
export declare class InstrumentsApi {
     ...
     */
    deleteInstrumentProperties(identifierType: string, identifier: string, propertyKeys: Array<string>, effectiveAt?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: DeleteInstrumentPropertiesResponse;
    }>;
    /**
     ...
     */
    getInstrumentIdentifierTypes(options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
