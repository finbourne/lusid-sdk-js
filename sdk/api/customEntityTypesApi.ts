...
export class CustomEntityTypesApi {
     ...
     * @summary [EARLY ACCESS] DeleteCustomEntityType: Delete a Custom Entity type.
     * @param entityType The identifier for the Custom Entity type, derived from the \&quot;entityTypeName\&quot; provided on creation.
     */
    public async deleteCustomEntityType (entityType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        ...
        if (entityType === null || entityType === undefined) {
            throw new Error('Required parameter entityType was null or undefined when calling deleteCustomEntityType.');
        }
