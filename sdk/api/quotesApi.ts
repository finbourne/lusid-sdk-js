...
export class QuotesApi {
     ...
     * @summary [BETA] Delete a quote
     * @param scope The scope of the quote
     * @param quotes The quotes to delete
     */
    public async deleteQuotes (scope: string, quotes?: Array<DeleteQuoteRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteQuotesResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(quotes, "Array<DeleteQuoteRequest>")
        };
        ...
        return new Promise<{ response: http.IncomingMessage; body: DeleteQuotesResponse;  }>((resolve, reject) => {
     ...
     */
    public async getQuotes (scope: string, effectiveAt?: Date, asAt?: Date, maxAge?: string, page?: number, limit?: number, quoteIds?: Array<QuoteId>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetQuotesResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(quoteIds, "Array<QuoteId>")
        };
     ...
     */
    public async upsertQuotes (scope: string, quotes?: Array<UpsertQuoteRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertQuotesResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(quotes, "Array<UpsertQuoteRequest>")
        };
