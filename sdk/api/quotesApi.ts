...
export class QuotesApi {
     ...
     * @summary DeleteQuoteAccessMetadataRule: Delete a Quote Access Metadata Rule
     ...
     * @summary GetQuotesAccessMetadataRule: Get a quote access metadata rule
     * @param scope The scope of the Quote Access Metadata Rule to retrieve.
     * @param provider The Provider of the rule
     * @param priceSource The PriceSource of the rule
     * @param instrumentIdType The InstrumentIdType of the rule
     ...
     * @summary ListQuotesAccessMetadataRules: List all quote access metadata rules in a scope
     * @param scope The scope of the Quote Access Metadata Rule to retrieve.
     * @param asAt The asAt datetime at which to retrieve the access metadata rule. Defaults to return the latest version if not specified.
     */
     ...
     * @summary UpsertQuoteAccessMetadataRule: Upsert a Quote Access Metadata Rule. This creates or updates the data in LUSID.
