...
import { DeleteQuoteRequest } from '../model/deleteQuoteRequest';
...
export class QuotesApi {
     ...
     * @param deleteQuoteRequest The quotes to delete
     */
    public deleteQuotes (scope: string, deleteQuoteRequest?: Array<DeleteQuoteRequest>) : Promise<{ response: http.ClientResponse; body: DeleteQuotesResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(deleteQuoteRequest, "Array<DeleteQuoteRequest>")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: DeleteQuotesResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "DeleteQuotesResponse");
     ...
     * @param quoteId The ids of the quotes
     */
    public getQuotes (scope: string, effectiveAt?: Date, asAt?: Date, maxAge?: string, page?: number, limit?: number, quoteId?: Array<QuoteId>) : Promise<{ response: http.ClientResponse; body: GetQuotesResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(quoteId, "Array<QuoteId>")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: GetQuotesResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param scope The scope of the quotes
     * @param upsertQuoteRequest The quotes to upsert
     */
    public upsertQuotes (scope: string, upsertQuoteRequest?: Array<UpsertQuoteRequest>) : Promise<{ response: http.ClientResponse; body: UpsertQuotesResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertQuoteRequest, "Array<UpsertQuoteRequest>")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: UpsertQuotesResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
