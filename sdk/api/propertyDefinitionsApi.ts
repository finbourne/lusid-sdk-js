...
export class PropertyDefinitionsApi {
     ...
     */
    public createPropertyDefinition (createPropertyDefinitionRequest?: CreatePropertyDefinitionRequest) : Promise<{ response: http.ClientResponse; body: PropertyDefinition;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: PropertyDefinition;  }>((resolve, reject) => {
     ...
     */
    public deletePropertyDefinition (domain: 'Trade' | 'Portfolio' | 'Holding' | 'ReferenceHolding' | 'TransactionConfiguration' | 'Instrument' | 'CutDefinition' | 'Analytic', scope: string, code: string) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getMultiplePropertyDefinitions (propertyKeys?: Array<string>, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfPropertyDefinition;  }> {
        const localVarPath = this.basePath + '/api/propertydefinitions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfPropertyDefinition;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    public getPropertyDefinition (domain: 'Trade' | 'Portfolio' | 'Holding' | 'ReferenceHolding' | 'TransactionConfiguration' | 'Instrument' | 'CutDefinition' | 'Analytic', scope: string, code: string, asAt?: Date) : Promise<{ response: http.ClientResponse; body: PropertyDefinition;  }> {
        const localVarPath = this.basePath + '/api/propertydefinitions/{domain}/{scope}/{code}'
            .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
     ...
     */
    public updatePropertyDefinition (domain: 'Trade' | 'Portfolio' | 'Holding' | 'ReferenceHolding' | 'TransactionConfiguration' | 'Instrument' | 'CutDefinition' | 'Analytic', scope: string, code: string, updatePropertyDefinitionRequest?: UpdatePropertyDefinitionRequest) : Promise<{ response: http.ClientResponse; body: PropertyDefinition;  }> {
        const localVarPath = this.basePath + '/api/propertydefinitions/{domain}/{scope}/{code}'
            .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
