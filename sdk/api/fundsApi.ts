...
export class FundsApi {
     ...
     */
    public async getValuationPointUnsettledTransactions (scope: string, code: string, asAt?: Date, limit?: number, page?: string, propertyKeys?: Array<string>, navTypeCode?: string, date?: string, diaryEntry?: string, variant?: string, valuationPointDataQueryParameters?: ValuationPointDataQueryParameters, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfUnsettledTransaction;  }> {
