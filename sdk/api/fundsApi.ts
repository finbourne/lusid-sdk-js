...
export class FundsApi {
     ...
     * @param singleValuationPointQueryParameters The optional arguments to use for querying the unsettled transactions. Can be              omitted when the Valuation Point is identified by the date or diaryEntry query parameters.
     */
    public async getValuationPointUnsettledTransactions (scope: string, code: string, asAt?: Date, limit?: number, page?: string, propertyKeys?: Array<string>, navTypeCode?: string, date?: string, diaryEntry?: string, variant?: string, singleValuationPointQueryParameters?: SingleValuationPointQueryParameters, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfUnsettledTransaction;  }> {
        ...
        if (variant !== undefined) {
            localVarQueryParameters['variant'] = ObjectSerializer.serialize(variant, "string");
        }
