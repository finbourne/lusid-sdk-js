...
export class FundsApi {
     ...
     * @param navTypeCode When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.
     * @param bucketSetCode When provided, each line\&#39;s bucketMemberships report only this bucket set\&#39;s classification of it.               Otherwise, every bucket set covering the NAV Type is reported.
     */
    public async getValuationPointJournalEntryLines (scope: string, code: string, valuationPointDataQueryParameters: ValuationPointDataQueryParameters, generalLedgerProfileCode?: string, asAt?: Date, filter?: string, limit?: number, page?: string, propertyKeys?: Array<string>, navTypeCode?: string, bucketSetCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfFundJournalEntryLine;  }> {
        ...
        if (bucketSetCode !== undefined) {
            localVarQueryParameters['bucketSetCode'] = ObjectSerializer.serialize(bucketSetCode, "string");
        }
     ...
     * @param returnExcludedTransactions Option to specify whether or not to include transactions excluded by the              NavType\&#39;s TransactionExclusionFilter. Defaults to False if not specified.
     */
    public async getValuationPointTransactions (scope: string, code: string, valuationPointDataQueryParameters: ValuationPointDataQueryParameters, asAt?: Date, filter?: string, limit?: number, page?: string, propertyKeys?: Array<string>, navTypeCode?: string, dataModelScope?: string, dataModelCode?: string, showCancelledTransactions?: boolean, membershipType?: string, returnExcludedTransactions?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfAccountedTransaction;  }> {
     ...
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param singleValuationPointQueryParameters The arguments to use for querying the unsettled transactions.
     ...
     * @param navTypeCode When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.
     */
    public async getValuationPointUnsettledTransactions (scope: string, code: string, singleValuationPointQueryParameters: SingleValuationPointQueryParameters, asAt?: Date, limit?: number, page?: string, propertyKeys?: Array<string>, navTypeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfUnsettledTransaction;  }> {
        ...
        // verify required parameter 'singleValuationPointQueryParameters' is not null or undefined
        if (singleValuationPointQueryParameters === null || singleValuationPointQueryParameters === undefined) {
            throw new Error('Required parameter singleValuationPointQueryParameters was null or undefined when calling getValuationPointUnsettledTransactions.');
        }
