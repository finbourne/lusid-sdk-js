...
export class DataTypesApi {
     ...
     */
    public createDataType (createDataTypeRequest?: CreateDataTypeRequest) : Promise<{ response: http.ClientResponse; body: DataType;  }> {
     ...
     */
    public getDataType (scope: string, code: string) : Promise<{ response: http.ClientResponse; body: DataType;  }> {
     ...
     */
    public getUnitsFromDataType (scope: string, code: string, units?: Array<string>, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfIUnitDefinitionDto;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfIUnitDefinitionDto;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public listDataTypes (scope: string, includeDefault?: boolean, includeSystem?: boolean, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfDataType;  }> {
        ...
        if (includeDefault !== undefined) {
            localVarQueryParameters['includeDefault'] = ObjectSerializer.serialize(includeDefault, "boolean");
        }
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfDataType;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public updateDataType (scope: string, code: string, updateDataTypeRequest?: UpdateDataTypeRequest) : Promise<{ response: http.ClientResponse; body: DataType;  }> {
        const localVarPath = this.basePath + '/api/datatypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
