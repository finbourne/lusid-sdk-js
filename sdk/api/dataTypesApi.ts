...
export class DataTypesApi {
     ...
     */
    public async getDataType (scope: string, code: string, asAt?: Date, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DataType;  }> {
        const localVarPath = this.basePath + '/api/datatypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt.              If this is provided, timelineScope and timelineCode must also be provided.
     */
    public async getUnitsFromDataType (scope: string, code: string, units?: Array<string>, filter?: string, asAt?: Date, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfIUnitDefinitionDto;  }> {
     ...
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt.               If this is provided, timelineScope and timelineCode must also be provided.
     */
    public async listDataTypeSummaries (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfDataTypeSummary;  }> {
        const localVarPath = this.basePath + '/api/datatypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt.              If this is provided, timelineScope and timelineCode must also be provided.
     */
    public async listDataTypes (scope: string, asAt?: Date, includeSystem?: boolean, sortBy?: Array<string>, limit?: number, filter?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfDataType;  }> {
