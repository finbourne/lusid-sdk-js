...
export class DataTypesApi {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public async listDataTypes (scope: string, includeDefault?: boolean, includeSystem?: boolean, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfDataType;  }> {
