...
export class LoginApi {
     ...
     */
    public async getSamlIdentityProviderId (domain: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LusidProblemDetails;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: LusidProblemDetails;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "LusidProblemDetails");
