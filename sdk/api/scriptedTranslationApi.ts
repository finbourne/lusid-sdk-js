...
export class ScriptedTranslationApi {
     ...
     * @param entityType The type of entity this dialect describes e.g. Instrument. Available values: Instrument.
     * @param serialisationFormat The serialisation format of a document in this dialect. Available values: Json, Xml.
