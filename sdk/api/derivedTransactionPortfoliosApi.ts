...
export class DerivedTransactionPortfoliosApi {
     ...
     */
    public async deleteDerivedPortfolioDetails (scope: string, code: string, effectiveAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
