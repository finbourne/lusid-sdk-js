...
export class DerivedTransactionPortfoliosApi {
     ...
     */
    public createDerivedPortfolio (scope: string, createDerivedTransactionPortfolioRequest?: CreateDerivedTransactionPortfolioRequest) : Promise<{ response: http.ClientResponse; body: Portfolio;  }> {
     ...
     */
    public deleteDerivedPortfolioDetails (scope: string, code: string, effectiveAt?: Date) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
