...
export class AnalyticsStoresApi {
     ...
     * @param createAnalyticStoreRequest A populated analytic store definition
     */
    public createAnalyticStore (createAnalyticStoreRequest?: CreateAnalyticStoreRequest) : Promise<{ response: http.ClientResponse; body: AnalyticStore;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createAnalyticStoreRequest, "CreateAnalyticStoreRequest")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: AnalyticStore;  }>((resolve, reject) => {
     ...
     */
    public deleteAnalyticStore (scope: string, year: number, month: number, day: number) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
     ...
     */
    public getAnalyticStore (scope: string, year: number, month: number, day: number, asAt?: Date) : Promise<{ response: http.ClientResponse; body: AnalyticStore;  }> {
        const localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'year' + '}', encodeURIComponent(String(year)))
            .replace('{' + 'month' + '}', encodeURIComponent(String(month)))
     ...
     */
    public listAnalyticStores (asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfAnalyticStoreKey;  }> {
        const localVarPath = this.basePath + '/api/analytics';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfAnalyticStoreKey;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param instrumentAnalytic The analytic data being inserted
     */
    public setAnalytics (scope: string, year: number, month: number, day: number, instrumentAnalytic?: Array<InstrumentAnalytic>) : Promise<{ response: http.ClientResponse; body: AnalyticStore;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(instrumentAnalytic, "Array<InstrumentAnalytic>")
        };
