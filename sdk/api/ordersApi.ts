...
export class OrdersApi {
     ...
     */
    public async listOrders (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, propertyKeys?: Array<string>, dataModelScope?: string, dataModelCode?: string, membershipType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrder;  }> {
