...
export class OrdersApi {
     ...
     * @summary ListOrders: List Orders
     * @param asAt The asAt datetime at which to retrieve the order. Defaults to return the latest version of the order if not specified.
     ...
     * @param propertyKeys A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;.                  All properties, except derived properties, are returned by default, without specifying here.
     ...
     * @param getDerivedComplianceStatuses If true, derives and decorates ComplianceState and ApprovalState onto each order using the V2 compliance engine. Defaults to false.
     */
    public async listOrders (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, propertyKeys?: Array<string>, dataModelScope?: string, dataModelCode?: string, membershipType?: string, getDerivedComplianceStatuses?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrder;  }> {
        ...
        if (getDerivedComplianceStatuses !== undefined) {
            localVarQueryParameters['getDerivedComplianceStatuses'] = ObjectSerializer.serialize(getDerivedComplianceStatuses, "boolean");
        }
     ...
     * @summary UpsertOrders: Upsert Order
     * @param orderSetRequest The collection of order requests.
     * @param dataModelScope The optional scope of a Custom Data Model to use
     * @param dataModelCode The optional code of a Custom Data Model to use
     */
    public async upsertOrders (orderSetRequest: OrderSetRequest, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfOrder;  }> {
        const localVarPath = this.basePath + '/api/orders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'orderSetRequest' is not null or undefined
        if (orderSetRequest === null || orderSetRequest === undefined) {
            throw new Error('Required parameter orderSetRequest was null or undefined when calling upsertOrders.');
        }
