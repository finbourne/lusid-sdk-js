...
export class ApplicationMetadataApi {
     ...
     */
    public getExcelAddin (version?: string) : Promise<{ response: http.ClientResponse; body: FileResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: FileResponse;  }>((resolve, reject) => {
     ...
     * @param version The requested version of the Excel plugin
     */
    public getExcelDownloadUrl (version?: string) : Promise<{ response: http.ClientResponse; body: string;  }> {
     ...
     */
    public getLusidVersions () : Promise<{ response: http.ClientResponse; body: VersionSummaryDto;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: VersionSummaryDto;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
