...
export class PortfolioGroupsApi {
     ...
     */
    public addPortfolioToGroup (scope: string, code: string, resourceId?: ResourceId) : Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }>((resolve, reject) => {
     ...
     */
    public addSubGroupToGroup (scope: string, code: string, resourceId?: ResourceId) : Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }> {
     ...
     */
    public createPortfolioGroup (scope: string, createPortfolioGroupRequest?: CreatePortfolioGroupRequest) : Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }> {
     ...
     */
    public deletePortfolioFromGroup (scope: string, code: string, portfolioScope: string, portfolioCode: string) : Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }> {
     ...
     * @param code The code of the portfolio group
     */
    public deletePortfolioGroup (scope: string, code: string) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
     ...
     */
    public deleteSubGroupFromGroup (scope: string, code: string, subgroupScope: string, subgroupCode: string) : Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }> {
     ...
     */
    public getPortfolioGroup (scope: string, code: string, asAt?: Date) : Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public getPortfolioGroupCommands (scope: string, code: string, fromAsAt?: Date, toAsAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfProcessedCommand;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfProcessedCommand;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getPortfolioGroupExpansion (scope: string, code: string, effectiveAt?: Date, asAt?: Date, propertyFilter?: Array<string>) : Promise<{ response: http.ClientResponse; body: ExpandedGroup;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ExpandedGroup;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public listPortfolioGroups (scope: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolioGroup;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolioGroup;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public updatePortfolioGroup (scope: string, code: string, updatePortfolioGroupRequest?: UpdatePortfolioGroupRequest) : Promise<{ response: http.ClientResponse; body: PortfolioGroup;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
