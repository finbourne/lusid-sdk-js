...
export class SearchApi {
     ...
     */
    public async portfolioGroupsSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioGroup;  }> {
     ...
     * @param request A valid Elasticsearch 5.x request
     */
    public async portfoliosSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioSearchResult;  }> {
     ...
     * @param request A valid Elasticsearch 5.x request
     */
    public async propertiesSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPropertyDefinition;  }> {
