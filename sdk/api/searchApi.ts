...
export class SearchApi {
     ...
     */
    public instrumentsSearch (masteredEffectiveAt?: Date, masteredOnly?: boolean, instrumentSearchProperty?: Array<InstrumentSearchProperty>) : Promise<{ response: http.ClientResponse; body: Array<InstrumentMatch>;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: Array<InstrumentMatch>;  }>((resolve, reject) => {
     ...
     */
    public portfolioGroupsSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, body?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolioGroup;  }> {
     ...
     * @param body A valid Elasticsearch 5.x request
     */
    public portfoliosSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, body?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolioSearchResult;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolioSearchResult;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param body A valid Elasticsearch 5.x request
     */
    public propertiesSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, body?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfPropertyDefinition;  }> {
