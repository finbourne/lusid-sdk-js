...
export class SearchApi {
     ...
     */
    public async instrumentsSearch (masteredEffectiveAt?: string, masteredOnly?: boolean, symbols?: Array<InstrumentSearchProperty>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<InstrumentMatch>;  }> {
