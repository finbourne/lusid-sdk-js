...
export class SearchApi {
     ...
     */
    public async searchPortfolios (filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioSearchResult;  }> {
        const localVarPath = this.basePath + '/api/search/portfolios';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
