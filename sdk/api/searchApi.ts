...
export class SearchApi {
     ...
     */
    public async instrumentsSearch (masteredEffectiveAt?: Date, masteredOnly?: boolean, symbols?: Array<InstrumentSearchProperty>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<InstrumentMatch>;  }> {
        ...
        if (masteredEffectiveAt !== undefined) {
            localVarQueryParameters['masteredEffectiveAt'] = ObjectSerializer.serialize(masteredEffectiveAt, "Date");
        }
     ...
     */
    public async portfolioGroupsSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioGroup;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "any")
        };
     ...
     * @param request A valid Elasticsearch 5.x request
     */
    public async portfoliosSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioSearchResult;  }> {
     ...
     * @param request A valid Elasticsearch 5.x request
     */
    public async propertiesSearch (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: any, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPropertyDefinition;  }> {
