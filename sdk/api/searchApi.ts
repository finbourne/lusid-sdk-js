...
export class SearchApi {
     ...
     */
    public async searchPortfolios (search?: string, filter?: string, sortBy?: string, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioSearchResult;  }> {
        const localVarPath = this.basePath + '/api/search/portfolios';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
