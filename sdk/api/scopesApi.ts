...
export class ScopesApi {
     ...
     */
    public async listScopes (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, query?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfScopeDefinition;  }> {
