...
export class ScopesApi {
     ...
     */
    public listScopes (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, query?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfScopeDefinition;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfScopeDefinition;  }>((resolve, reject) => {
