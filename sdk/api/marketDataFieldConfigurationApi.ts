...
import { MarketDataFieldConfiguration } from '../model/marketDataFieldConfiguration';
import { UpdateMarketDataFieldConfigurationRequest } from '../model/updateMarketDataFieldConfigurationRequest';
...
export enum MarketDataFieldConfigurationApiApiKeys {
}

export class MarketDataFieldConfigurationApi {
    ...
    public setApiKey(key: MarketDataFieldConfigurationApiApiKeys, value: string) {
        (this.authentications as any)[MarketDataFieldConfigurationApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] GetMarketDataFieldConfiguration: Get a Market Data Field Configuration
     * @param marketDataCategory The market data category.
     * @param asAt The asAt datetime at which to retrieve the configuration. Defaults to return the latest version if not specified.
     */
    public async getMarketDataFieldConfiguration (marketDataCategory: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MarketDataFieldConfiguration;  }> {
        const localVarPath = this.basePath + '/api/marketdata/fieldconfiguration/{marketDataCategory}'
            .replace('{' + 'marketDataCategory' + '}', encodeURIComponent(String(marketDataCategory)));
        ...
        // verify required parameter 'marketDataCategory' is not null or undefined
        if (marketDataCategory === null || marketDataCategory === undefined) {
            throw new Error('Required parameter marketDataCategory was null or undefined when calling getMarketDataFieldConfiguration.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: MarketDataFieldConfiguration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "MarketDataFieldConfiguration");
     ...
     * @summary [EARLY ACCESS] UpdateMarketDataFieldConfiguration: Update a Market Data Field Configuration
     * @param marketDataCategory The market data category.
     * @param updateMarketDataFieldConfigurationRequest The metadata fields to add, update, or remove.
     */
    public async updateMarketDataFieldConfiguration (marketDataCategory: string, updateMarketDataFieldConfigurationRequest: UpdateMarketDataFieldConfigurationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MarketDataFieldConfiguration;  }> {
        const localVarPath = this.basePath + '/api/marketdata/fieldconfiguration/{marketDataCategory}/$update'
            .replace('{' + 'marketDataCategory' + '}', encodeURIComponent(String(marketDataCategory)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'marketDataCategory' is not null or undefined
        if (marketDataCategory === null || marketDataCategory === undefined) {
            throw new Error('Required parameter marketDataCategory was null or undefined when calling updateMarketDataFieldConfiguration.');
        }

        // verify required parameter 'updateMarketDataFieldConfigurationRequest' is not null or undefined
        if (updateMarketDataFieldConfigurationRequest === null || updateMarketDataFieldConfigurationRequest === undefined) {
            throw new Error('Required parameter updateMarketDataFieldConfigurationRequest was null or undefined when calling updateMarketDataFieldConfiguration.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateMarketDataFieldConfigurationRequest, "UpdateMarketDataFieldConfigurationRequest")
        };
