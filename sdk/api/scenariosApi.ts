...
export class ScenariosApi {
     ...
     * @summary [EARLY ACCESS] ListScenarios: List the set of Scenario definitions
     ...
     * @param page Pagination token from a previous result to fetch the next page.
     */
    public async listScenarios (scope: string, asAt?: Date, filter?: string, limit?: number, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetScenarioResponse;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling listScenarios.');
        }
