...
import { CreateScenarioFromTemplateRequest } from '../model/createScenarioFromTemplateRequest';
import { GetScenarioResponse } from '../model/getScenarioResponse';
...
import { PagedResourceListOfGetScenarioResponse } from '../model/pagedResourceListOfGetScenarioResponse';
import { PagedResourceListOfVersion } from '../model/pagedResourceListOfVersion';
import { ResourceListOfScenarioTemplateDefinition } from '../model/resourceListOfScenarioTemplateDefinition';
import { ReverseStressRequest } from '../model/reverseStressRequest';
import { ReverseStressResponse } from '../model/reverseStressResponse';
import { ScenarioPreviewRequest } from '../model/scenarioPreviewRequest';
import { ScenarioPreviewResponse } from '../model/scenarioPreviewResponse';
import { UpsertScenarioRequest } from '../model/upsertScenarioRequest';
...
export class ScenariosApi {
     ...
     * @summary [EARLY ACCESS] CreateScenarioFromTemplate: [EARLY ACCESS] CreateScenarioFromTemplate: Create a Scenario from a pre-built template.
     * @param scope The scope in which to create the scenario
     * @param createScenarioFromTemplateRequest The template, code and parameters to create the scenario from
     */
    public async createScenarioFromTemplate (scope: string, createScenarioFromTemplateRequest: CreateScenarioFromTemplateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios/{scope}/$fromTemplate'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling createScenarioFromTemplate.');
        }

        // verify required parameter 'createScenarioFromTemplateRequest' is not null or undefined
        if (createScenarioFromTemplateRequest === null || createScenarioFromTemplateRequest === undefined) {
            throw new Error('Required parameter createScenarioFromTemplateRequest was null or undefined when calling createScenarioFromTemplate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createScenarioFromTemplateRequest, "CreateScenarioFromTemplateRequest")
        };
     ...
     * @summary [EARLY ACCESS] DeleteScenario: Delete a Scenario, assuming that it is present.
     * @param scope The scope of the Scenario to delete.
     * @param code The Scenario to delete.
     */
    public async deleteScenario (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteScenario.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteScenario.');
        }
     ...
     * @summary [EARLY ACCESS] GetScenario: Get Scenario
     * @param scope The scope of the Scenario to retrieve.
     * @param code The code of the Scenario to retrieve.
     * @param asAt The asAt datetime at which to retrieve the Scenario. Defaults to return the latest version if not specified.
     */
    public async getScenario (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetScenarioResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getScenario.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getScenario.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetScenarioResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetScenarioResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListScenarioTemplates: [EARLY ACCESS] ListScenarioTemplates: List the pre-built scenario templates.
     */
    public async listScenarioTemplates (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfScenarioTemplateDefinition;  }> {
        const localVarPath = this.basePath + '/api/scenarios/$templates';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfScenarioTemplateDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfScenarioTemplateDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListScenarioVersions: List the versions of a Scenario
     * @param scope The scope of the Scenario to list versions for.
     * @param code The code of the Scenario to list versions for.
     * @param asAt The asAt datetime to cap the version history at. Defaults to all versions up to now.
     ...
     */
    public async listScenarioVersions (scope: string, code: string, asAt?: Date, limit?: number, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfVersion;  }> {
        const localVarPath = this.basePath + '/api/scenarios/{scope}/{code}/versions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling listScenarioVersions.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling listScenarioVersions.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfVersion;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfVersion");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListScenarios: List Scenarios
     * @param asAt The asAt datetime at which to list the scenarios. Defaults to latest if not specified.
     * @param filter Expression to filter the result set, e.g. \&quot;scope eq \&#39;MyScope\&#39;\&quot;.
     * @param limit Maximum number of results to return. Defaults to 100.
     * @param page Pagination token from a previous result to fetch the next page.
     */
    public async listScenarios (asAt?: Date, filter?: string, limit?: number, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetScenarioResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetScenarioResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfGetScenarioResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListScenariosForScope: List Scenarios for a scope
     * @param scope The scope to list scenarios for.
     * @param asAt The asAt datetime at which to list the scenarios. Defaults to latest if not specified.
     * @param filter Expression to filter the result set.
     * @param limit Maximum number of results to return. Defaults to 100.
     * @param page Pagination token from a previous result to fetch the next page.
     */
    public async listScenariosForScope (scope: string, asAt?: Date, filter?: string, limit?: number, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetScenarioResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling listScenariosForScope.');
        }
     ...
     * @summary [EARLY ACCESS] PreviewScenario: Preview a Scenario
     * @param scenarioPreviewRequest The recipe, portfolios, effective date and scenario (stored reference or inline shifts) to preview
     */
    public async previewScenario (scenarioPreviewRequest: ScenarioPreviewRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ScenarioPreviewResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios/$preview';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'scenarioPreviewRequest' is not null or undefined
        if (scenarioPreviewRequest === null || scenarioPreviewRequest === undefined) {
            throw new Error('Required parameter scenarioPreviewRequest was null or undefined when calling previewScenario.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(scenarioPreviewRequest, "ScenarioPreviewRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ScenarioPreviewResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ScenarioPreviewResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] SolveReverseStress: Solve a reverse stress test
     * @param reverseStressRequest The recipe, portfolios, effective date, scenario direction and target change in value
     */
    public async solveReverseStress (reverseStressRequest: ReverseStressRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReverseStressResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios/$reversestress';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'reverseStressRequest' is not null or undefined
        if (reverseStressRequest === null || reverseStressRequest === undefined) {
            throw new Error('Required parameter reverseStressRequest was null or undefined when calling solveReverseStress.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(reverseStressRequest, "ReverseStressRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ReverseStressResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ReverseStressResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpsertScenario: Upsert a Scenario. This creates or updates the scenario definition in LUSID.
     * @param upsertScenarioRequest The Scenario to update or insert
     */
    public async upsertScenario (upsertScenarioRequest: UpsertScenarioRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/scenarios';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'upsertScenarioRequest' is not null or undefined
        if (upsertScenarioRequest === null || upsertScenarioRequest === undefined) {
            throw new Error('Required parameter upsertScenarioRequest was null or undefined when calling upsertScenario.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertScenarioRequest, "UpsertScenarioRequest")
        };
