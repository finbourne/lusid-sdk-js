...
import { CreateWithholdingTaxDatasetDefinitionsRequest } from '../model/createWithholdingTaxDatasetDefinitionsRequest';
...
import { PagedResourceListOfWithholdingTaxConfiguration } from '../model/pagedResourceListOfWithholdingTaxConfiguration';
import { PagedResourceListOfWithholdingTaxDataset } from '../model/pagedResourceListOfWithholdingTaxDataset';
import { UpsertWithholdingTaxConfigurationRequest } from '../model/upsertWithholdingTaxConfigurationRequest';
import { WithholdingTaxConfiguration } from '../model/withholdingTaxConfiguration';
import { WithholdingTaxDataset } from '../model/withholdingTaxDataset';
import { WithholdingTaxDatasetDefinitions } from '../model/withholdingTaxDatasetDefinitions';
...
export class WithholdingTaxApi {
     ...
     * @summary [EARLY ACCESS] CreateWithholdingTaxDatasetDefinitions: Create the Withholding Tax dataset definitions.
     * @param createWithholdingTaxDatasetDefinitionsRequest The scope, code and matching dimensions of each of the two datasets to create.
     */
    public async createWithholdingTaxDatasetDefinitions (createWithholdingTaxDatasetDefinitionsRequest: CreateWithholdingTaxDatasetDefinitionsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WithholdingTaxDatasetDefinitions;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/datasetdefinitions';
        ...
        // verify required parameter 'createWithholdingTaxDatasetDefinitionsRequest' is not null or undefined
        if (createWithholdingTaxDatasetDefinitionsRequest === null || createWithholdingTaxDatasetDefinitionsRequest === undefined) {
            throw new Error('Required parameter createWithholdingTaxDatasetDefinitionsRequest was null or undefined when calling createWithholdingTaxDatasetDefinitions.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createWithholdingTaxDatasetDefinitionsRequest, "CreateWithholdingTaxDatasetDefinitionsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WithholdingTaxDatasetDefinitions;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "WithholdingTaxDatasetDefinitions");
     ...
     * @summary [EARLY ACCESS] DeleteWithholdingTaxConfiguration: Delete a Withholding Tax Configuration.
     * @param scope The scope of the Withholding Tax Configuration to be deleted.
     * @param code The code of the Withholding Tax Configuration to be deleted. Together with the scope this uniquely identifies the configuration.
     */
    public async deleteWithholdingTaxConfiguration (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/configurations/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteWithholdingTaxConfiguration.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteWithholdingTaxConfiguration.');
        }
     ...
     * @summary [EARLY ACCESS] DeleteWithholdingTaxDatasetDefinition: Delete a Withholding Tax dataset definition.
     * @param scope The scope of the dataset definition to be deleted.
     * @param code The code of the dataset definition to be deleted. Together with the scope this uniquely identifies the definition.
     */
    public async deleteWithholdingTaxDatasetDefinition (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/datasetdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteWithholdingTaxDatasetDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteWithholdingTaxDatasetDefinition.');
        }
     ...
     * @summary [EARLY ACCESS] GetWithholdingTaxConfiguration: Get a Withholding Tax Configuration.
     * @param scope The scope of the Withholding Tax Configuration.
     * @param code The code of the Withholding Tax Configuration. Together with the scope this uniquely identifies the configuration.
     * @param asAt The asAt datetime at which to retrieve the Withholding Tax Configuration. Defaults to returning the latest version if not specified.
     */
    public async getWithholdingTaxConfiguration (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WithholdingTaxConfiguration;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/configurations/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getWithholdingTaxConfiguration.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getWithholdingTaxConfiguration.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WithholdingTaxConfiguration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "WithholdingTaxConfiguration");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetWithholdingTaxDatasetDefinition: Get a Withholding Tax dataset definition.
     * @param scope The scope of the dataset definition.
     * @param code The code of the dataset definition. Together with the scope this uniquely identifies the definition.
     * @param asAt The asAt datetime at which to retrieve the dataset definition. Defaults to returning the latest version if not specified.
     */
    public async getWithholdingTaxDatasetDefinition (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WithholdingTaxDataset;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/datasetdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getWithholdingTaxDatasetDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getWithholdingTaxDatasetDefinition.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WithholdingTaxDataset;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "WithholdingTaxDataset");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListWithholdingTaxConfigurations: List Withholding Tax Configurations.
     * @param asAt The asAt datetime at which to list the Withholding Tax Configurations. Defaults to returning the latest version of each configuration if not specified.
     ...
     */
    public async listWithholdingTaxConfigurations (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWithholdingTaxConfiguration;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/configurations';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWithholdingTaxConfiguration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfWithholdingTaxConfiguration");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListWithholdingTaxDatasetDefinitions: List Withholding Tax dataset definitions.
     * @param asAt The asAt datetime at which to list the dataset definitions. Defaults to returning the latest version of each definition if not specified.
     ...
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     */
    public async listWithholdingTaxDatasetDefinitions (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWithholdingTaxDataset;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/datasetdefinitions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWithholdingTaxDataset;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfWithholdingTaxDataset");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] PatchWithholdingTaxDatasetDefinition: Patch a Withholding Tax dataset definition.
     * @param scope The scope of the dataset definition to amend.
     * @param code The code of the dataset definition to amend. Together with the scope this uniquely identifies the definition.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.
     */
    public async patchWithholdingTaxDatasetDefinition (scope: string, code: string, operation: Array<Operation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WithholdingTaxDataset;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/datasetdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling patchWithholdingTaxDatasetDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling patchWithholdingTaxDatasetDefinition.');
        }

        // verify required parameter 'operation' is not null or undefined
        if (operation === null || operation === undefined) {
            throw new Error('Required parameter operation was null or undefined when calling patchWithholdingTaxDatasetDefinition.');
        }
     ...
     * @summary [EARLY ACCESS] UpsertWithholdingTaxConfiguration: Upsert a Withholding Tax Configuration.
     * @param scope The scope of the Withholding Tax Configuration.
     * @param code The code of the Withholding Tax Configuration. Together with the scope this uniquely identifies the configuration.
     * @param upsertWithholdingTaxConfigurationRequest The complete Withholding Tax Configuration to create or replace.
     */
    public async upsertWithholdingTaxConfiguration (scope: string, code: string, upsertWithholdingTaxConfigurationRequest: UpsertWithholdingTaxConfigurationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WithholdingTaxConfiguration;  }> {
        const localVarPath = this.basePath + '/api/withholdingtax/configurations/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling upsertWithholdingTaxConfiguration.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling upsertWithholdingTaxConfiguration.');
        }

        // verify required parameter 'upsertWithholdingTaxConfigurationRequest' is not null or undefined
        if (upsertWithholdingTaxConfigurationRequest === null || upsertWithholdingTaxConfigurationRequest === undefined) {
            throw new Error('Required parameter upsertWithholdingTaxConfigurationRequest was null or undefined when calling upsertWithholdingTaxConfiguration.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertWithholdingTaxConfigurationRequest, "UpsertWithholdingTaxConfigurationRequest")
        };
