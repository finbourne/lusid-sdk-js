...
export class SequencesApi {
     ...
     * @summary [EARLY ACCESS] DeleteSequence: Delete a sequence
     * @param scope Scope of the sequence.
     * @param code Code of the sequence. This together with stated scope uniquely identifies the sequence.
     */
    public async deleteSequence (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteSequence.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteSequence.');
        }
