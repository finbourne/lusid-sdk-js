...
import { ValuationPointEntity } from '../model/valuationPointEntity';
...
export class EntitiesApi {
     ...
     * @summary GetBookmarkByEntityUniqueId: Get bookmark by EntityUniqueId
     * @param entityUniqueId The universally unique identifier of the bookmark.
     * @param asAt The asAt datetime at which to retrieve the bookmark. Defaults to returning the latest version of the bookmark if not specified.
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getBookmarkByEntityUniqueId (entityUniqueId: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BookmarkEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/bookmarks/{entityUniqueId}'
        ...
        if (entityUniqueId === null || entityUniqueId === undefined) {
            throw new Error('Required parameter entityUniqueId was null or undefined when calling getBookmarkByEntityUniqueId.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BookmarkEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BookmarkEntity");
     ...
     * @summary [EARLY ACCESS] GetComplianceRuleByEntityUniqueId: Get compliance rule by EntityUniqueId
     * @param entityUniqueId The universally unique identifier of the compliance rule.
     * @param asAt The asAt datetime at which to retrieve the compliance rule. Defaults to returning the latest version of the compliance rule if not specified.
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getComplianceRuleByEntityUniqueId (entityUniqueId: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/compliancerules/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'entityUniqueId' is not null or undefined
        if (entityUniqueId === null || entityUniqueId === undefined) {
            throw new Error('Required parameter entityUniqueId was null or undefined when calling getComplianceRuleByEntityUniqueId.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRuleEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRuleEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetComplianceRuleTemplateByEntityUniqueId: Get compliance rule template by EntityUniqueId
     * @param entityUniqueId The universally unique identifier of the compliance rule template.
     * @param asAt The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified.
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getComplianceRuleTemplateByEntityUniqueId (entityUniqueId: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleTemplateEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/complianceruletemplates/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRuleTemplateEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRuleTemplateEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async getInstrumentByEntityUniqueId (entityUniqueId: string, effectiveAt?: string, asAt?: Date, previews?: Array<string>, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentEntity;  }> {
     ...
     * @summary GetTransactionByEntityUniqueId: Get transaction by EntityUniqueId
     * @param entityUniqueId The entity unique identifier of the transaction. The expected format is \&#39;{portfolioEntityUniqueId}_{transactionId}\&#39;.
     * @param asAt The asAt datetime at which to retrieve the transaction. Defaults to returning the latest version of the transaction if not specified.
     * @param previews The ids of the staged modifications to be previewed in the response.
     * @param dataModelScope The optional scope of a Custom Data Model to use.
     * @param dataModelCode The optional code of a Custom Data Model to use.
     */
    public async getTransactionByEntityUniqueId (entityUniqueId: string, asAt?: Date, previews?: Array<string>, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/transactions/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'entityUniqueId' is not null or undefined
        if (entityUniqueId === null || entityUniqueId === undefined) {
            throw new Error('Required parameter entityUniqueId was null or undefined when calling getTransactionByEntityUniqueId.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransactionEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransactionEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary GetValuationPointByEntityUniqueId: Get valuation point by EntityUniqueId
     * @param entityUniqueId The universally unique identifier of the valuation point.
     * @param asAt The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified.
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getValuationPointByEntityUniqueId (entityUniqueId: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/valuationpoints/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'entityUniqueId' is not null or undefined
        if (entityUniqueId === null || entityUniqueId === undefined) {
            throw new Error('Required parameter entityUniqueId was null or undefined when calling getValuationPointByEntityUniqueId.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ValuationPointEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ValuationPointEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
