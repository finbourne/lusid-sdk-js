...
export class EntitiesApi {
     ...
     */
    public async getPortfolioChanges (scope: string, effectiveAt: Date, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfChange;  }> {
