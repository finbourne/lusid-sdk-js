...
export class ConfigurationRecipeApi {
     ...
     * @param asAt The asAt datetime at which to retrieve the Configuration Recipe. Defaults to return the latest version if not specified.
     */
    public async getDerivedRecipe (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetRecipeResponse;  }> {
     ...
     */
    public async getRecipeComposer (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetRecipeComposerResponse;  }> {
        const localVarPath = this.basePath + '/api/recipes/composer/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async listDerivedRecipes (asAt?: Date, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfGetRecipeResponse;  }> {
     ...
     * @param filter Expression to filter the result set, note this functionality is not yet enabled for this endpoint.
     */
    public async listRecipeComposers (asAt?: Date, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfGetRecipeComposerResponse;  }> {
