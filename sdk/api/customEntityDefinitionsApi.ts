...
export class CustomEntityDefinitionsApi {
     ...
     * @summary [EARLY ACCESS] DeleteDefinition: Delete a Custom Entity type definition.
     * @param entityType The identifier for the Custom Entity type, derived from the \&quot;entityTypeName\&quot; provided on creation.
     */
    public async deleteDefinition (entityType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        ...
        if (entityType === null || entityType === undefined) {
            throw new Error('Required parameter entityType was null or undefined when calling deleteDefinition.');
        }
