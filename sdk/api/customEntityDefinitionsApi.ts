...
export class CustomEntityDefinitionsApi {
     ...
     * @summary [EARLY ACCESS] GetCustomEntityDefinition: Get a Custom Entity type definition.
     ...
     */
    public async getCustomEntityDefinition (entityType: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityDefinition;  }> {
        ...
        if (entityType === null || entityType === undefined) {
            throw new Error('Required parameter entityType was null or undefined when calling getCustomEntityDefinition.');
        }
    ...
    /**
     * Retrieve a CustomEntityDefinition by a specific entityType at a point in AsAt time
     * @summary [DEPRECATED] GetDefinition: Get a Custom Entity type definition.
     * @param entityType The identifier for the Custom Entity type, derived from the \&quot;entityTypeName\&quot; provided on creation.
     * @param asAt The AsAt datetime at which to retrieve the definition.
     */
    public async getDefinition (entityType: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityDefinition;  }> {
        const localVarPath = this.basePath + '/api/customentities/entitytypes/{entityType}/$deprecated'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
