...
export enum ResourceRecordApiApiKeys {
}

export class ResourceRecordApi {
    ...
    public setApiKey(key: ResourceRecordApiApiKeys, value: string) {
        (this.authentications as any)[ResourceRecordApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] DeleteResourceRecord: Delete a Resource Record
     * @param scope The scope of the resource record.
     * @param code The code of the resource record.
     * @param resourceId The resource identifier of the resource record.
     */
    public async deleteResourceRecord (scope: string, code: string, resourceId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/resourcerecords/{scope}/{code}/{resourceId}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteResourceRecord.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteResourceRecord.');
        }

        // verify required parameter 'resourceId' is not null or undefined
        if (resourceId === null || resourceId === undefined) {
            throw new Error('Required parameter resourceId was null or undefined when calling deleteResourceRecord.');
        }
     ...
     * @summary [EARLY ACCESS] GetResourceRecord: Get a Resource Record
     * @param scope The scope of the resource record.
     * @param code The code of the resource record.
     * @param resourceId The resource identifier of the resource record.
     * @param asAt The asAt datetime at which to list the resource record. Defaults to return the latest version if not specified.
     */
    public async getResourceRecord (scope: string, code: string, resourceId: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceRecord;  }> {
        const localVarPath = this.basePath + '/api/resourcerecords/{scope}/{code}/{resourceId}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'resourceId' + '}', encodeURIComponent(String(resourceId)));
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getResourceRecord.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getResourceRecord.');
        }

        // verify required parameter 'resourceId' is not null or undefined
        if (resourceId === null || resourceId === undefined) {
            throw new Error('Required parameter resourceId was null or undefined when calling getResourceRecord.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceRecord;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceRecord");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListResourceRecordCodes: List Resource Records Codes for Scope
     * @param scope The scope of the resource record.
     * @param asAt The asAt datetime at which to list the resource record. Defaults to return the latest version if not specified.
     * @param sortOrder Order of the sort - either \&quot;ASC\&quot; or \&quot;DESC\&quot;
     */
    public async listResourceRecordCodes (scope: string, asAt?: Date, sortOrder?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfString;  }> {
        const localVarPath = this.basePath + '/api/resourcerecords/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling listResourceRecordCodes.');
        }
    ...
    /**
     * List all resource records matching particular criteria.
     * @summary [EARLY ACCESS] ListResourceRecordScopes: List Resource Record Scopes
     * @param asAt The asAt datetime at which to list the resource record. Defaults to return the latest version if not specified.
     * @param page The pagination token to use to continue listing resource records from a previous call.
     * @param limit When paginating, limit the number of returned results to this many.
     */
    public async listResourceRecordScopes (asAt?: Date, page?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfScopeDefinition;  }> {
        const localVarPath = this.basePath + '/api/resourcerecords';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
    ...
    /**
     * List all resource records matching particular criteria.
     * @summary [EARLY ACCESS] ListResourceRecords: List Resource Records
     * @param scope The scope of the resource record.
     * @param code The code of the resource record.
     * @param asAt The asAt datetime at which to list the resource record. Defaults to return the latest version if not specified.
     * @param page The pagination token to use to continue listing resource records from a previous call.
     ...
     */
    public async listResourceRecords (scope: string, code: string, asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfResourceRecord;  }> {
        const localVarPath = this.basePath + '/api/resourcerecords/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling listResourceRecords.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling listResourceRecords.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfResourceRecord;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfResourceRecord");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpsertResourceRecord: Upsert a Resource Record
     * @param upsertResourceRecordRequest The resource record to upsert.
     */
    public async upsertResourceRecord (upsertResourceRecordRequest: UpsertResourceRecordRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceRecord;  }> {
        const localVarPath = this.basePath + '/api/resourcerecords';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'upsertResourceRecordRequest' is not null or undefined
        if (upsertResourceRecordRequest === null || upsertResourceRecordRequest === undefined) {
            throw new Error('Required parameter upsertResourceRecordRequest was null or undefined when calling upsertResourceRecord.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertResourceRecordRequest, "UpsertResourceRecordRequest")
        };
