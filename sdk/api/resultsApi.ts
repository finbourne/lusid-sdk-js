...
export class ResultsApi {
     ...
     * @param date The date for which the data was loaded
     ...
     */
    public getResults (scope: string, key: string, date: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number) : Promise<{ response: http.ClientResponse; body: Results;  }> {
        const localVarPath = this.basePath + '/api/results/{scope}/{key}/{date}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getResults.');
        }

        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling getResults.');
        }

        // verify required parameter 'date' is not null or undefined
        if (date === null || date === undefined) {
            throw new Error('Required parameter date was null or undefined when calling getResults.');
        }
        ...
        return new Promise<{ response: http.ClientResponse; body: Results;  }>((resolve, reject) => {
     ...
     * @param scope The scope of the data
     * @param key The key that identifies the data
     * @param date The date for which the data is relevant
     * @param createResults The results to upload
     */
    public upsertResults (scope: string, key: string, date: Date, createResults?: CreateResults) : Promise<{ response: http.ClientResponse; body: Results;  }> {
        const localVarPath = this.basePath + '/api/results/{scope}/{key}/{date}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)))
            .replace('{' + 'date' + '}', encodeURIComponent(String(date)));
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling upsertResults.');
        }

        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling upsertResults.');
        }

        // verify required parameter 'date' is not null or undefined
        if (date === null || date === undefined) {
            throw new Error('Required parameter date was null or undefined when calling upsertResults.');
        }
