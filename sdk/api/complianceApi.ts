 ...
 *
 * The version of the OpenAPI document: 2.0.1671
...
import { ComplianceRuleResultV2WithContributions } from '../model/complianceRuleResultV2WithContributions';
...
export enum ComplianceApiApiKeys {
}
...
export class ComplianceApi {
    ...
    public setApiKey(key: ComplianceApiApiKeys, value: string) {
        (this.authentications as any)[ComplianceApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] CreateComplianceTemplate: Create a Compliance Rule Template
     ...
     */
    public async createComplianceTemplate (scope: string, createComplianceTemplateRequest: CreateComplianceTemplateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleTemplate;  }> {
        const localVarPath = this.basePath + '/api/compliance/templates/{scope}'
        ...
        // verify required parameter 'createComplianceTemplateRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createComplianceTemplateRequest, "CreateComplianceTemplateRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRuleTemplate;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRuleTemplate");
     ...
     * @summary [EARLY ACCESS] DeleteComplianceRule: Delete compliance rule.
     * @param scope The compliance rule\&#39;s scope.
     * @param code The compliance rule\&#39;s code.
     */
    public async deleteComplianceRule (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/rules/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @summary [EARLY ACCESS] DeleteComplianceTemplate: Delete a ComplianceRuleTemplate
     * @param scope The scope of the template to be deleted.
     * @param code The code of the template to be deleted.
     */
    public async deleteComplianceTemplate (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/templates/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EARLY ACCESS] GetComplianceRule: Get compliance rule.
     * @param scope The compliance rule\&#39;s scope.
     * @param code The compliance rule\&#39;s code.
     ...
     */
    public async getComplianceRule (scope: string, code: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/rules/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRuleResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRuleResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetComplianceRuleBreakdown: Get the position-level breakdown for a single rule of a compliance run.
     ...
     */
    public async getComplianceRuleBreakdown (runScope: string, runCode: string, ruleScope: string, ruleCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleResultV2WithContributions;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/breakdown/{runScope}/{runCode}/{ruleScope}/{ruleCode}'
            .replace('{' + 'runScope' + '}', encodeURIComponent(String(runScope)))
            .replace('{' + 'runCode' + '}', encodeURIComponent(String(runCode)))
            .replace('{' + 'ruleScope' + '}', encodeURIComponent(String(ruleScope)))
            .replace('{' + 'ruleCode' + '}', encodeURIComponent(String(ruleCode)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'runScope' is not null or undefined
        if (runScope === null || runScope === undefined) {
            throw new Error('Required parameter runScope was null or undefined when calling getComplianceRuleBreakdown.');
        }

        // verify required parameter 'runCode' is not null or undefined
        if (runCode === null || runCode === undefined) {
            throw new Error('Required parameter runCode was null or undefined when calling getComplianceRuleBreakdown.');
        }

        // verify required parameter 'ruleScope' is not null or undefined
        if (ruleScope === null || ruleScope === undefined) {
            throw new Error('Required parameter ruleScope was null or undefined when calling getComplianceRuleBreakdown.');
        }

        // verify required parameter 'ruleCode' is not null or undefined
        if (ruleCode === null || ruleCode === undefined) {
            throw new Error('Required parameter ruleCode was null or undefined when calling getComplianceRuleBreakdown.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRuleResultV2WithContributions;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRuleResultV2WithContributions");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetComplianceRuleResult: Get detailed results for a specific rule within a compliance run.
     * @param runScope Required: Run Scope.
     * @param runCode Required: Run Code.
     * @param ruleScope Required: Rule Scope.
     * @param ruleCode Required: Rule Code.
     */
    public async getComplianceRuleResult (runScope: string, runCode: string, ruleScope: string, ruleCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleResultV2;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/summary/{runScope}/{runCode}/{ruleScope}/{ruleCode}'
            .replace('{' + 'runScope' + '}', encodeURIComponent(String(runScope)))
            .replace('{' + 'runCode' + '}', encodeURIComponent(String(runCode)))
            .replace('{' + 'ruleScope' + '}', encodeURIComponent(String(ruleScope)))
            .replace('{' + 'ruleCode' + '}', encodeURIComponent(String(ruleCode)));
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRuleResultV2;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRuleResultV2");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async getComplianceTemplate (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceTemplate;  }> {
        const localVarPath = this.basePath + '/api/compliance/templates/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceTemplate;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceTemplate");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetDecoratedComplianceRunSummary: Get decorated summary results for a specific compliance run.
     * @param scope Required: Run Scope.
     * @param code Required: Run Code.
     * @param propertyKeys A list of property keys from the \&#39;Compliance\&#39; domain to decorate onto each rule result.              These must take the format {domain}/{scope}/{code}, for example \&#39;Compliance/live/UCITS\&#39;.
     */
    public async getDecoratedComplianceRunSummary (scope: string, code: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DecoratedComplianceRunSummary;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/summary/{scope}/{code}/$decorate'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DecoratedComplianceRunSummary;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "DecoratedComplianceRunSummary");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListComplianceRules: List compliance rules.
     ...
     */
    public async listComplianceRules (asAt?: Date, page?: string, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceRuleResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/rules';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceRuleResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfComplianceRuleResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListComplianceRuns: List historical compliance run identifiers.
     * @param asAt Optional. The time at which to get results from. Default : latest
     ...
     */
    public async listComplianceRuns (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceRunInfoV2;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceRunInfoV2;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfComplianceRunInfoV2");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListComplianceTemplates: List compliance templates.
     * @param asAt Optional. The time at which to get results from. Default : latest
     * @param page Optional. The pagination token to use to continue listing compliance runs from a previous call to list compliance runs.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request.
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     * @param filter Optional. Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listComplianceTemplates (asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceTemplate;  }> {
        const localVarPath = this.basePath + '/api/compliance/templates';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceTemplate;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfComplianceTemplate");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] RunCompliance: Run a compliance check.
     ...
     */
    public async runCompliance (runScope: string, ruleScope: string, isPreTrade: boolean, recipeIdScope: string, recipeIdCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunInfoV2;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'recipeIdCode' is not null or undefined
        ...
        if (runScope !== undefined) {
            localVarQueryParameters['runScope'] = ObjectSerializer.serialize(runScope, "string");
        }

        if (ruleScope !== undefined) {
            localVarQueryParameters['ruleScope'] = ObjectSerializer.serialize(ruleScope, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRunInfoV2;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRunInfoV2");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
    ...
    /**
     * Use this endpoint to run a compliance check using rules from a specific scope.
     * @summary [EARLY ACCESS] RunCompliancePreview: Run a compliance check.
     * @param runScope Required: Scope to save the run results in.
     * @param ruleScope Required: Scope from which to select rules to be run.
     * @param recipeIdScope Required: the scope of the recipe to be used
     * @param recipeIdCode Required: The code of the recipe to be used. If left blank, the default recipe will be used.
     ...
     */
    public async runCompliancePreview (runScope: string, ruleScope: string, recipeIdScope: string, recipeIdCode: string, complianceRunConfiguration?: ComplianceRunConfiguration, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunInfoV2;  }> {
        const localVarPath = this.basePath + '/api/compliance/preview/runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(complianceRunConfiguration, "ComplianceRunConfiguration")
        };
     ...
     * @summary [EARLY ACCESS] UpdateComplianceTemplate: Update a ComplianceRuleTemplate
     * @param scope The scope of the Compliance Rule Template.
     ...
     */
    public async updateComplianceTemplate (scope: string, code: string, updateComplianceTemplateRequest: UpdateComplianceTemplateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleTemplate;  }> {
        const localVarPath = this.basePath + '/api/compliance/templates/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'updateComplianceTemplateRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateComplianceTemplateRequest, "UpdateComplianceTemplateRequest")
        };
     ...
     */
    public async upsertComplianceRule (upsertComplianceRuleRequest?: UpsertComplianceRuleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/rules';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertComplianceRuleRequest, "UpsertComplianceRuleRequest")
        };
     ...
     * @summary [EARLY ACCESS] UpsertComplianceRunSummary: Upsert a compliance run summary.
     * @param upsertComplianceRunSummaryRequest 
     */
    public async upsertComplianceRunSummary (upsertComplianceRunSummaryRequest?: UpsertComplianceRunSummaryRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertComplianceRunSummaryResult;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/summary';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertComplianceRunSummaryRequest, "UpsertComplianceRunSummaryRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpsertComplianceRunSummaryResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpsertComplianceRunSummaryResult");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
