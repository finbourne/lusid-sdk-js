...
export class ComplianceApi {
     ...
     * @param propertyKeys A list of property keys from the \&#39;Compliance\&#39; domain to decorate onto the rule.              These must take the format {domain}/{scope}/{code}, for example \&#39;Compliance/live/UCITS\&#39;. If not provided will return all the entitled properties for that rule.
     */
