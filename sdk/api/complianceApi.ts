...
import { ComplianceRunSummary } from '../model/complianceRunSummary';
...
export class ComplianceApi {
     ...
     * @summary [EARLY ACCESS] GetComplianceRuleResultDetails: Get summary results for a specific rule within a compliance run.
     ...
     */
    public async getComplianceRuleResultDetails (runScope: string, runCode: string, ruleScope: string, ruleCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunSummary;  }> {
        ...
        if (runScope === null || runScope === undefined) {
            throw new Error('Required parameter runScope was null or undefined when calling getComplianceRuleResultDetails.');
        }

        // verify required parameter 'runCode' is not null or undefined
        if (runCode === null || runCode === undefined) {
            throw new Error('Required parameter runCode was null or undefined when calling getComplianceRuleResultDetails.');
        }

        // verify required parameter 'ruleScope' is not null or undefined
        if (ruleScope === null || ruleScope === undefined) {
            throw new Error('Required parameter ruleScope was null or undefined when calling getComplianceRuleResultDetails.');
        }

        // verify required parameter 'ruleCode' is not null or undefined
        if (ruleCode === null || ruleCode === undefined) {
            throw new Error('Required parameter ruleCode was null or undefined when calling getComplianceRuleResultDetails.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ComplianceRunSummary;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ComplianceRunSummary");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetComplianceRunSummary: Get summary results for a specific compliance run.
     * @param runScope Required: Run Scope.
     * @param runCode Required: Run Code.
     */
    public async getComplianceRunSummary (runScope: string, runCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunSummary;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/summary/{runScope}/{runCode}'
            .replace('{' + 'runScope' + '}', encodeURIComponent(String(runScope)))
            .replace('{' + 'runCode' + '}', encodeURIComponent(String(runCode)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'runScope' is not null or undefined
        if (runScope === null || runScope === undefined) {
            throw new Error('Required parameter runScope was null or undefined when calling getComplianceRunSummary.');
        }

        // verify required parameter 'runCode' is not null or undefined
        if (runCode === null || runCode === undefined) {
            throw new Error('Required parameter runCode was null or undefined when calling getComplianceRunSummary.');
        }
     ...
     */
    public async upsertComplianceRunSummary (upsertComplianceRunSummaryRequest?: UpsertComplianceRunSummaryRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunSummary;  }> {
