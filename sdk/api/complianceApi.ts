...
export class ComplianceApi {
     ...
     */
    public async getDecoratedComplianceRunSummary (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DecoratedComplianceRunSummary;  }> {
