...
export enum SimplePositionPortfoliosApiApiKeys {
}

export class SimplePositionPortfoliosApi {
    ...
    public setApiKey(key: SimplePositionPortfoliosApiApiKeys, value: string) {
        (this.authentications as any)[SimplePositionPortfoliosApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] CreateSimplePositionPortfolio: Create simple position portfolio
     * @param scope The scope in which to create the simple position portfolio.
     * @param createSimplePositionPortfolioRequest The definition of the simple position portfolio.
     */
    public async createSimplePositionPortfolio (scope: string, createSimplePositionPortfolioRequest: CreateSimplePositionPortfolioRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Portfolio;  }> {
        const localVarPath = this.basePath + '/api/simpleposition/{scope}'
        ...
        // verify required parameter 'createSimplePositionPortfolioRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createSimplePositionPortfolioRequest, "CreateSimplePositionPortfolioRequest")
        };
