...
export class ReferencePortfolioApi {
     ...
     */
    public createReferencePortfolio (scope: string, createReferencePortfolioRequest?: CreateReferencePortfolioRequest) : Promise<{ response: http.ClientResponse; body: Portfolio;  }> {
     ...
     */
    public getReferencePortfolioConstituents (scope: string, code: string, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>) : Promise<{ response: http.ClientResponse; body: GetReferencePortfolioConstituentsResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: GetReferencePortfolioConstituentsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public listConstituentsAdjustments (scope: string, code: string, fromEffectiveAt?: Date, toEffectiveAt?: Date, asAtTime?: Date) : Promise<{ response: http.ClientResponse; body: ResourceListOfConstituentsAdjustmentHeader;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfConstituentsAdjustmentHeader;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public upsertReferencePortfolioConstituents (scope: string, code: string, upsertReferencePortfolioConstituentsRequest?: UpsertReferencePortfolioConstituentsRequest) : Promise<{ response: http.ClientResponse; body: UpsertReferencePortfolioConstituentsResponse;  }> {
        const localVarPath = this.basePath + '/api/referenceportfolios/{scope}/{code}/constituents'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: UpsertReferencePortfolioConstituentsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
