...
export class ReferencePortfolioApi {
     ...
     */
    public async getReferencePortfolioConstituents (scope: string, code: string, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetReferencePortfolioConstituentsResponse;  }> {
     ...
     */
    public async listConstituentsAdjustments (scope: string, code: string, fromEffectiveAt?: Date, toEffectiveAt?: Date, asAtTime?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfConstituentsAdjustmentHeader;  }> {
