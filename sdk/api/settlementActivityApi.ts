...
import { ResourceListWithPostBodiesOfSettlementActivityToSettlementActivityQuery } from '../model/resourceListWithPostBodiesOfSettlementActivityToSettlementActivityQuery';
import { SettlementActivityQuery } from '../model/settlementActivityQuery';
...
export enum SettlementActivityApiApiKeys {
}

export class SettlementActivityApi {
    ...
    public setApiKey(key: SettlementActivityApiApiKeys, value: string) {
        (this.authentications as any)[SettlementActivityApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] QuerySettlementActivity: Query Settlement Activity
     * @param settlementActivityQuery The query parameters controlling which settlement activity is returned.
     */
    public async querySettlementActivity (settlementActivityQuery: SettlementActivityQuery, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListWithPostBodiesOfSettlementActivityToSettlementActivityQuery;  }> {
        const localVarPath = this.basePath + '/api/settlementactivities/$query';
        ...
        // verify required parameter 'settlementActivityQuery' is not null or undefined
        if (settlementActivityQuery === null || settlementActivityQuery === undefined) {
            throw new Error('Required parameter settlementActivityQuery was null or undefined when calling querySettlementActivity.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(settlementActivityQuery, "SettlementActivityQuery")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListWithPostBodiesOfSettlementActivityToSettlementActivityQuery;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListWithPostBodiesOfSettlementActivityToSettlementActivityQuery");
