...
export class SchemasApi {
     ...
     */
    public getEntitySchema (entity: string) : Promise<{ response: http.ClientResponse; body: Schema;  }> {
     ...
     */
    public getPropertySchema (propertyKeys?: Array<string>, asAt?: Date) : Promise<{ response: http.ClientResponse; body: PropertySchema;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: PropertySchema;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getValueTypes (sortBy?: Array<string>, start?: number, limit?: number) : Promise<{ response: http.ClientResponse; body: ResourceListOfValueType;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfValueType;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public listEntities () : Promise<{ response: http.ClientResponse; body: ResourceListOfString;  }> {
