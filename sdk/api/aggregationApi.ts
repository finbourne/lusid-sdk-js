...
export class AggregationApi {
     ...
     */
    public getAggregationByGroup (scope: string, code: string, sortBy?: Array<string>, start?: number, limit?: number, aggregationRequest?: AggregationRequest) : Promise<{ response: http.ClientResponse; body: ListAggregationResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ListAggregationResponse;  }>((resolve, reject) => {
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public getAggregationByPortfolio (scope: string, code: string, sortBy?: Array<string>, start?: number, limit?: number, aggregationRequest?: AggregationRequest) : Promise<{ response: http.ClientResponse; body: ListAggregationResponse;  }> {
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public getAggregationByResultSet (scope: string, resultsKey: string, sortBy?: Array<string>, start?: number, limit?: number, aggregationRequest?: AggregationRequest) : Promise<{ response: http.ClientResponse; body: ListAggregationResponse;  }> {
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public getNestedAggregationByGroup (scope: string, code: string, aggregationRequest?: AggregationRequest) : Promise<{ response: http.ClientResponse; body: NestedAggregationResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: NestedAggregationResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
