...
export enum FeeTypesApiApiKeys {
}
...
export class FeeTypesApi {
    ...
    public setApiKey(key: FeeTypesApiApiKeys, value: string) {
        (this.authentications as any)[FeeTypesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] CreateFeeType: Create a FeeType.
     * @param scope The scope of the FeeType.
     * @param feeTypeRequest The contents of the FeeType.
     */
    public async createFeeType (scope: string, feeTypeRequest: FeeTypeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeeType;  }> {
        const localVarPath = this.basePath + '/api/feetypes/{scope}'
        ...
        // verify required parameter 'feeTypeRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(feeTypeRequest, "FeeTypeRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FeeType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "FeeType");
     ...
     * @summary [EARLY ACCESS] DeleteFeeType: Delete a FeeType.
     * @param scope The scope of the FeeType.
     * @param code The code of the fee type
     */
    public async deleteFeeType (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/feetypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @summary [EARLY ACCESS] GetFeeTemplateSpecifications: Get FeeTemplateSpecifications used in the FeeType.
     */
    public async getFeeTemplateSpecifications (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeeTransactionTemplateSpecification;  }> {
        const localVarPath = this.basePath + '/api/feetypes/feetransactiontemplatespecification';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FeeTransactionTemplateSpecification;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "FeeTransactionTemplateSpecification");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetFeeType: Get a FeeType
     * @param scope The scope of the FeeType
     ...
     */
    public async getFeeType (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeeType;  }> {
        const localVarPath = this.basePath + '/api/feetypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EARLY ACCESS] ListFeeTypes: List FeeTypes
     ...
     */
    public async listFeeTypes (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfFeeType;  }> {
        const localVarPath = this.basePath + '/api/feetypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfFeeType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfFeeType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpdateFeeType: Update a FeeType.
     * @param scope The scope of the FeeType.
     * @param code The code of the fee type
     * @param updateFeeTypeRequest The contents of the FeeType.
     */
    public async updateFeeType (scope: string, code: string, updateFeeTypeRequest: UpdateFeeTypeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeeType;  }> {
        const localVarPath = this.basePath + '/api/feetypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'updateFeeTypeRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateFeeTypeRequest, "UpdateFeeTypeRequest")
        };
