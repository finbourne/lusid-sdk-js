...
export class ComplexMarketDataApi {
     ...
     * @param closedPeriodId The closed period ID. If this is specified, both timelineScope and timelineCode must be specified.
     */
    public async listComplexMarketData (asAt?: Date, effectiveAt?: string, page?: string, limit?: number, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfListComplexMarketDataWithMetaDataResponse;  }> {
