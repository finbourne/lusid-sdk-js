...
export class ComplexMarketDataApi {
     ...
     */
    public async getComplexMarketData (scope: string, requestBody: { [key: string]: ComplexMarketDataId; }, effectiveAt?: string, asAt?: Date, maxAge?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetComplexMarketDataResponse;  }> {
     ...
     * @param effectiveAt The effectiveAt datetime or cut label at which to list the ComplexMarketData. Defaults to latest if not specified.
     ...
     */
    public async listComplexMarketData (asAt?: Date, effectiveAt?: string, page?: string, limit?: number, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, filter?: string, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfListComplexMarketDataWithMetaDataResponse;  }> {
     ...
     * @param asAt The asAt datetime at which to retrieve the complex market data. Defaults to return the latest version if not specified.
     */
    public async upsertAppendComplexMarketData (scope: string, appendComplexMarketDataRequest: AppendComplexMarketDataRequest, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
