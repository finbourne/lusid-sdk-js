...
export class CorporateActionSourcesApi {
     ...
     */
    public batchUpsertCorporateActions (scope: string, code: string, createCorporateAction?: Array<CreateCorporateAction>) : Promise<{ response: http.ClientResponse; body: UpsertCorporateActionsResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createCorporateAction, "Array<CreateCorporateAction>")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: UpsertCorporateActionsResponse;  }>((resolve, reject) => {
     ...
     */
    public createCorporateActionSource (createCorporateActionSourceRequest: CreateCorporateActionSourceRequest) : Promise<{ response: http.ClientResponse; body: CorporateActionSource;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: CorporateActionSource;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public deleteCorporateActionSource (scope: string, code: string, effectiveAt?: Date) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
     ...
     */
    public getCorporateActions (scope: string, code: string, fromEffectiveAt?: Date, toEffectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfCorporateAction;  }> {
        const localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/corporateactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfCorporateAction;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public listCorporateActionSources (effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfCorporateActionSource;  }> {
        const localVarPath = this.basePath + '/api/corporateactionsources';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfCorporateActionSource;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
