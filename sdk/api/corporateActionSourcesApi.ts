...
export class CorporateActionSourcesApi {
     ...
     */
    public async batchUpsertCorporateActions (scope: string, code: string, actions?: Array<CreateCorporateAction>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertCorporateActionsResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(actions, "Array<CreateCorporateAction>")
        };
     ...
     */
    public async deleteCorporateActionSource (scope: string, code: string, effectiveAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     */
    public async getCorporateActions (scope: string, code: string, fromEffectiveAt?: Date, toEffectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfCorporateAction;  }> {
        const localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/corporateactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public async listCorporateActionSources (effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfCorporateActionSource;  }> {
        const localVarPath = this.basePath + '/api/corporateactionsources';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
