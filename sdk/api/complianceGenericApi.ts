...
export class ComplianceGenericApi {
     ...
     * @summary [EARLY ACCESS] DeleteComplianceRule2: Delete compliance rule.
     ...
     */
    public async getComplianceRule2 (scope: string, code: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/generic/rules/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EARLY ACCESS] GetComplianceRunSummary: Get compliance summary results.
    ...
    public async getComplianceRunSummary (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunSummary;  }> {
        const localVarPath = this.basePath + '/api/compliance/generic/runs/summary/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async listComplianceRules2 (asAt?: Date, page?: string, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceRuleResponse;  }> {
     ...
     * @summary [EARLY ACCESS] ListComplianceRuns: List historical Compliance RunIds
     * @param asAt Optional. The time at which to get results from. Default : latest
     ...
     */
    public async listComplianceRuns (asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceRunInfoV2;  }> {
        const localVarPath = this.basePath + '/api/compliance/generic/runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
     ...
     * @summary [EARLY ACCESS] RunGenericCompliance: Kick off the compliance check process
     ...
     */
    public async runGenericCompliance (runScope: string, ruleScope: string, isPreTrade: boolean, recipeIdScope: string, recipeIdCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunInfoV2;  }> {
        const localVarPath = this.basePath + '/api/compliance/generic/runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        if (runScope === null || runScope === undefined) {
            throw new Error('Required parameter runScope was null or undefined when calling runGenericCompliance.');
        }

        // verify required parameter 'ruleScope' is not null or undefined
        if (ruleScope === null || ruleScope === undefined) {
            throw new Error('Required parameter ruleScope was null or undefined when calling runGenericCompliance.');
        }

        // verify required parameter 'isPreTrade' is not null or undefined
        if (isPreTrade === null || isPreTrade === undefined) {
            throw new Error('Required parameter isPreTrade was null or undefined when calling runGenericCompliance.');
        }

        // verify required parameter 'recipeIdScope' is not null or undefined
        if (recipeIdScope === null || recipeIdScope === undefined) {
            throw new Error('Required parameter recipeIdScope was null or undefined when calling runGenericCompliance.');
        }

        // verify required parameter 'recipeIdCode' is not null or undefined
        if (recipeIdCode === null || recipeIdCode === undefined) {
            throw new Error('Required parameter recipeIdCode was null or undefined when calling runGenericCompliance.');
        }
