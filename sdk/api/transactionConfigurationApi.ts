...
export class TransactionConfigurationApi {
     ...
     */
    public async getSideDefinition (side: string, scope?: string, asAt?: Date, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SideDefinition;  }> {
     ...
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt. If this is provided, timelineScope and timelineCode must also be provided.
     */
    public async getTransactionType (source: string, type: string, asAt?: Date, scope?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionType;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}/{type}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)))
            .replace('{' + 'type' + '}', encodeURIComponent(String(type)));
        let localVarQueryParameters: any = {};
     ...
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt. If this is provided, timelineScope and timelineCode must also be provided.
     */
    public async listSideDefinitions (asAt?: Date, scope?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfSideDefinition;  }> {
     ...
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt. If this is provided, timelineScope and timelineCode must also be provided.
     */
    public async listTransactionTypes (asAt?: Date, scope?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<TransactionType>; };  }> {
