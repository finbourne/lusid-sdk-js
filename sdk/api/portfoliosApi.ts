...
export class PortfoliosApi {
     ...
     */
    public deletePortfolio (scope: string, code: string, effectiveAt?: Date) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
     ...
     */
    public deletePortfolioProperties (scope: string, code: string, effectiveAt?: Date, portfolioPropertyKeys?: Array<string>) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
     ...
     */
    public getPortfolio (scope: string, code: string, effectiveAt?: Date, asAt?: Date) : Promise<{ response: http.ClientResponse; body: Portfolio;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public getPortfolioCommands (scope: string, code: string, fromAsAt?: Date, toAsAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfProcessedCommand;  }> {
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     */
    public getPortfolioProperties (scope: string, code: string, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number) : Promise<{ response: http.ClientResponse; body: PortfolioProperties;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: PortfolioProperties;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public listPortfolios (effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, query?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolio;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolio;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public listPortfoliosForScope (scope: string, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string) : Promise<{ response: http.ClientResponse; body: ResourceListOfPortfolio;  }> {
     ...
     */
    public updatePortfolio (scope: string, code: string, effectiveAt?: Date, updatePortfolioRequest?: UpdatePortfolioRequest) : Promise<{ response: http.ClientResponse; body: Portfolio;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param requestBody The property values to be upserted to the portfolio
     */
    public upsertPortfolioProperties (scope: string, code: string, effectiveAt?: Date, requestBody?: { [key: string]: PropertyValue; }) : Promise<{ response: http.ClientResponse; body: PortfolioProperties;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: PropertyValue; }")
        };
