...
export class PortfoliosApi {
     ...
     */
    public async deletePortfolio (scope: string, code: string, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     */
    public async deletePortfolioProperties (scope: string, code: string, effectiveAt?: string, portfolioPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     */
    public async getPortfolioProperties (scope: string, code: string, effectiveAt?: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PortfolioProperties;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async listPortfolios (effectiveAt?: string, asAt?: Date, page?: string, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, query?: string, portfolioPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolio;  }> {
     ...
     * @param portfolioPropertyKeys Optional. Keys of the properties to be decorated on to the portfolio
     */
    public async listPortfoliosForScope (scope: string, effectiveAt?: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, portfolioPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolio;  }> {
