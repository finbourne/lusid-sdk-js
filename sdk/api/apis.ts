...
export const APIS = [ApplicationMetadataApi, CutLabelDefinitionsApi, DataTypesApi, DerivedTransactionPortfoliosApi, InstrumentsApi, LoginApi, PortfolioGroupsApi, PortfoliosApi, PropertyDefinitionsApi, ReconciliationsApi, ReferencePortfolioApi, ScopesApi, SystemConfigurationApi, TransactionPortfoliosApi];
