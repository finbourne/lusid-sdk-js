...
export class TransactionPortfoliosApi {
     ...
     */
    public async buildTransactions (scope: string, code: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, propertyKeys?: Array<string>, filter?: string, parameters?: TransactionQueryParameters, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfOutputTransaction;  }> {
