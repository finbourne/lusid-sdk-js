...
export class TransactionPortfoliosApi {
    ...
    public async addTransactionProperty (scope: string, code: string, transactionId: string, transactionProperties: { [key: string]: PerpetualPropertyValue; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AddTransactionPropertyResponse;  }> {
        ...
        if (transactionProperties === null || transactionProperties === undefined) {
            throw new Error('Required parameter transactionProperties was null or undefined when calling addTransactionProperty.');
        }
    ...
    public async deleteExecutions (scope: string, code: string, executionIds: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        ...
        if (executionIds === null || executionIds === undefined) {
            throw new Error('Required parameter executionIds was null or undefined when calling deleteExecutions.');
        }
    ...
    public async deleteTransactions (scope: string, code: string, transactionIds: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        ...
        if (transactionIds === null || transactionIds === undefined) {
            throw new Error('Required parameter transactionIds was null or undefined when calling deleteTransactions.');
        }
