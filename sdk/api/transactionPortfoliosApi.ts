...
export class TransactionPortfoliosApi {
     ...
     * @param requestBody Transaction properties values
     */
    public addTransactionProperty (scope: string, code: string, transactionId: string, requestBody?: { [key: string]: PerpetualPropertyValue; }) : Promise<{ response: http.ClientResponse; body: AddTransactionPropertyResponse;  }> {
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling addTransactionProperty.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling addTransactionProperty.');
        }

        // verify required parameter 'transactionId' is not null or undefined
        if (transactionId === null || transactionId === undefined) {
            throw new Error('Required parameter transactionId was null or undefined when calling addTransactionProperty.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: PerpetualPropertyValue; }")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: AddTransactionPropertyResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "AddTransactionPropertyResponse");
     ...
     * @param adjustHoldingRequest The selected set of holdings adjustments
     */
    public adjustHoldings (scope: string, code: string, effectiveAt: Date, adjustHoldingRequest?: Array<AdjustHoldingRequest>) : Promise<{ response: http.ClientResponse; body: AdjustHolding;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: AdjustHolding;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param transactionQueryParameters Optional. Transaction query parameters
     */
    public buildTransactions (scope: string, code: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>, filter?: string, transactionQueryParameters?: TransactionQueryParameters) : Promise<{ response: http.ClientResponse; body: VersionedResourceListOfOutputTransaction;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: VersionedResourceListOfOutputTransaction;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param effectiveAt The effective date of the change
     */
    public cancelAdjustHoldings (scope: string, code: string, effectiveAt: Date) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'effectiveAt' + '}', encodeURIComponent(String(effectiveAt)));
     ...
     * @param createTransactionPortfolioRequest The transaction portfolio definition
     */
    public createPortfolio (scope: string, createTransactionPortfolioRequest?: CreateTransactionPortfolioRequest) : Promise<{ response: http.ClientResponse; body: Portfolio;  }> {
     ...
     */
    public deleteExecutions (scope: string, code: string, executionIds?: Array<string>) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteExecutions.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteExecutions.');
        }
     ...
     */
    public deletePropertyFromTransaction (scope: string, code: string, transactionId: string, transactionPropertyKey?: string) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions/{transactionId}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'transactionId' + '}', encodeURIComponent(String(transactionId)));
     ...
     */
    public deleteTransactions (scope: string, code: string, transactionIds?: Array<string>) : Promise<{ response: http.ClientResponse; body: DeletedEntityResponse;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteTransactions.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteTransactions.');
        }
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    public getDetails (scope: string, code: string, effectiveAt?: Date, asAt?: Date) : Promise<{ response: http.ClientResponse; body: PortfolioDetails;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: PortfolioDetails;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getHoldings (scope: string, code: string, byTaxlots?: boolean, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>) : Promise<{ response: http.ClientResponse; body: VersionedResourceListOfPortfolioHolding;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: VersionedResourceListOfPortfolioHolding;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    public getHoldingsAdjustment (scope: string, code: string, effectiveAt: Date, asAt?: Date) : Promise<{ response: http.ClientResponse; body: HoldingsAdjustment;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: HoldingsAdjustment;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public getTransactions (scope: string, code: string, fromTransactionDate?: Date, toTransactionDate?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>, filter?: string) : Promise<{ response: http.ClientResponse; body: VersionedResourceListOfTransaction;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        if (fromTransactionDate !== undefined) {
            localVarQueryParameters['fromTransactionDate'] = ObjectSerializer.serialize(fromTransactionDate, "Date");
        }

        if (toTransactionDate !== undefined) {
            localVarQueryParameters['toTransactionDate'] = ObjectSerializer.serialize(toTransactionDate, "Date");
        }
        ...
        return new Promise<{ response: http.ClientResponse; body: VersionedResourceListOfTransaction;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    public listHoldingsAdjustments (scope: string, code: string, fromEffectiveAt?: Date, toEffectiveAt?: Date, asAt?: Date) : Promise<{ response: http.ClientResponse; body: ResourceListOfHoldingsAdjustmentHeader;  }> {
        ...
        if (fromEffectiveAt !== undefined) {
            localVarQueryParameters['fromEffectiveAt'] = ObjectSerializer.serialize(fromEffectiveAt, "Date");
        }

        if (toEffectiveAt !== undefined) {
            localVarQueryParameters['toEffectiveAt'] = ObjectSerializer.serialize(toEffectiveAt, "Date");
        }
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfHoldingsAdjustmentHeader;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param effectiveAt The effective date of the change
     * @param adjustHoldingRequest The complete set of holdings adjustments for the portfolio
     */
    public setHoldings (scope: string, code: string, effectiveAt: Date, adjustHoldingRequest?: Array<AdjustHoldingRequest>) : Promise<{ response: http.ClientResponse; body: AdjustHolding;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'effectiveAt' + '}', encodeURIComponent(String(effectiveAt)));
     ...
     * @param scope The scope of the portfolio
     * @param code The code of the portfolio
     * @param executionRequest The executions to be updated
     */
    public upsertExecutions (scope: string, code: string, executionRequest?: Array<ExecutionRequest>) : Promise<{ response: http.ClientResponse; body: UpsertPortfolioExecutionsResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/executions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: UpsertPortfolioExecutionsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param createPortfolioDetails The set of details for the portfolio
     */
    public upsertPortfolioDetails (scope: string, code: string, effectiveAt?: Date, createPortfolioDetails?: CreatePortfolioDetails) : Promise<{ response: http.ClientResponse; body: PortfolioDetails;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/details'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param transactionRequest The transactions to be upserted
     */
    public upsertTransactions (scope: string, code: string, transactionRequest?: Array<TransactionRequest>) : Promise<{ response: http.ClientResponse; body: UpsertPortfolioTransactionsResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: UpsertPortfolioTransactionsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
