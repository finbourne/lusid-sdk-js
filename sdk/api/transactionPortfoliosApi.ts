...
export class TransactionPortfoliosApi {
     ...
     */
    public async addTransactionProperty (scope: string, code: string, transactionId: string, transactionProperties?: { [key: string]: PerpetualPropertyValue; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AddTransactionPropertyResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(transactionProperties, "{ [key: string]: PerpetualPropertyValue; }")
        };
        ...
        return new Promise<{ response: http.IncomingMessage; body: AddTransactionPropertyResponse;  }>((resolve, reject) => {
     ...
     */
    public async adjustHoldings (scope: string, code: string, effectiveAt: Date, holdingAdjustments?: Array<AdjustHoldingRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AdjustHolding;  }> {
     ...
     */
    public async buildTransactions (scope: string, code: string, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>, filter?: string, parameters?: TransactionQueryParameters, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfOutputTransaction;  }> {
     ...
     * @param effectiveAt The effective date of the change
     */
    public async cancelAdjustHoldings (scope: string, code: string, effectiveAt: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'effectiveAt' + '}', encodeURIComponent(String(effectiveAt)));
     ...
     */
    public async deleteExecutions (scope: string, code: string, executionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     */
    public async deleteTransactions (scope: string, code: string, transactionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    public async getDetails (scope: string, code: string, effectiveAt?: Date, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PortfolioDetails;  }> {
     ...
     */
    public async getHoldings (scope: string, code: string, byTaxlots?: boolean, effectiveAt?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfPortfolioHolding;  }> {
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    public async getHoldingsAdjustment (scope: string, code: string, effectiveAt: Date, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HoldingsAdjustment;  }> {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public async getTransactions (scope: string, code: string, fromTransactionDate?: Date, toTransactionDate?: Date, asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, instrumentPropertyKeys?: Array<string>, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransaction;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param asAt Optional. The AsAt date of the data
     */
    public async listHoldingsAdjustments (scope: string, code: string, fromEffectiveAt?: Date, toEffectiveAt?: Date, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfHoldingsAdjustmentHeader;  }> {
     ...
     */
    public async setHoldings (scope: string, code: string, effectiveAt: Date, holdingAdjustments?: Array<AdjustHoldingRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AdjustHolding;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/{effectiveAt}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'effectiveAt' + '}', encodeURIComponent(String(effectiveAt)));
     ...
     */
    public async upsertPortfolioDetails (scope: string, code: string, effectiveAt?: Date, details?: CreatePortfolioDetails, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PortfolioDetails;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/details'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
