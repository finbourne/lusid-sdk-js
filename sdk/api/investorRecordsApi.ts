...
export class InvestorRecordsApi {
     ...
     * @summary [EARLY ACCESS] DeleteInvestorRecordAccessMetadata: Delete an Investor Record Access Metadata entry.
     * @param identifierType Code of the investor record identifier type.
     * @param identifierValue Code of the investor record under specified identifier type\&#39;s scope and code.
     ...
     */
    public async deleteInvestorRecordAccessMetadata (identifierType: string, identifierValue: string, metadataKey: string, scope: string, identifierScope: string, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/investorrecords/{identifierType}/{identifierValue}/metadata/{metadataKey}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)))
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling deleteInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling deleteInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'metadataKey' is not null or undefined
        if (metadataKey === null || metadataKey === undefined) {
            throw new Error('Required parameter metadataKey was null or undefined when calling deleteInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling deleteInvestorRecordAccessMetadata.');
        }
     ...
     * @summary [EARLY ACCESS] GetAllInvestorRecordAccessMetadata: Get Access Metadata rules for an Investor Record.
     * @param identifierType Code of the investor record identifier type.
     * @param identifierValue Code of the investor record under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investor record entity.
     * @param identifierScope Scope of the investor record identifier type.
     ...
     */
    public async getAllInvestorRecordAccessMetadata (identifierType: string, identifierValue: string, scope: string, identifierScope: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        const localVarPath = this.basePath + '/api/investorrecords/{identifierType}/{identifierValue}/metadata'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling getAllInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling getAllInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getAllInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling getAllInvestorRecordAccessMetadata.');
        }
     ...
     * @summary [EARLY ACCESS] GetInvestorRecordRelationships: Get Investor Record relationships
     * @param identifierType Code of the investor record identifier type.
     * @param identifierValue Code of the investor record under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investor record entity.
     * @param identifierScope Scope of the investor record identifier type.
    ...
    public async getInvestorRecordRelationships (identifierType: string, identifierValue: string, scope: string, identifierScope: string, effectiveAt?: string, asAt?: Date, filter?: string, identifierTypes?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfRelationship;  }> {
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling getInvestorRecordRelationships.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling getInvestorRecordRelationships.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getInvestorRecordRelationships.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling getInvestorRecordRelationships.');
        }
     ...
     * @summary [EARLY ACCESS] PatchInvestorRecordAccessMetadata: Patch Access Metadata rules for an Investor Record.
     * @param identifierType Code of the investor record identifier type.
     * @param identifierValue Code of the investor record under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investor record entity.
     * @param identifierScope Scope of the investor record identifier type.
    ...
    public async patchInvestorRecordAccessMetadata (identifierType: string, identifierValue: string, scope: string, identifierScope: string, accessMetadataOperation: Array<AccessMetadataOperation>, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling patchInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling patchInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling patchInvestorRecordAccessMetadata.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling patchInvestorRecordAccessMetadata.');
        }
        ...
        if (accessMetadataOperation === null || accessMetadataOperation === undefined) {
            throw new Error('Required parameter accessMetadataOperation was null or undefined when calling patchInvestorRecordAccessMetadata.');
        }
