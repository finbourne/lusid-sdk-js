...
export class InstrumentsApi {
     ...
     */
    public deleteInstrument (identifierType: string, identifier: string) : Promise<{ response: http.ClientResponse; body: DeleteInstrumentResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: DeleteInstrumentResponse;  }>((resolve, reject) => {
     ...
     */
    public findInstruments (effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>, property?: Array<Property>) : Promise<{ response: http.ClientResponse; body: ResourceListOfInstrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/$find';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(property, "Array<Property>")
        };
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfInstrument;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    public getInstrument (identifierType: string, identifier: string, effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>) : Promise<{ response: http.ClientResponse; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: Instrument;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getInstrumentIdentifiers () : Promise<{ response: http.ClientResponse; body: ResourceListOfString;  }> {
        const localVarPath = this.basePath + '/api/instruments/identifiers';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfString;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    public getInstruments (identifierType: string, requestBody: Array<string>, effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>) : Promise<{ response: http.ClientResponse; body: GetInstrumentsResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: GetInstrumentsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    public listInstruments (asAt?: Date, effectiveAt?: Date, page?: string, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>) : Promise<{ response: http.ClientResponse; body: ResourceListOfInstrument;  }> {
     ...
     * @param requestBody The identifiers of the instruments to get
     */
    public matchInstruments (identifierType?: string, requestBody?: Array<string>) : Promise<{ response: http.ClientResponse; body: MatchInstrumentsResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments/$match';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: MatchInstrumentsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "MatchInstrumentsResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     */
    public updateInstrumentIdentifier (identifierType: string, identifier: string, updateInstrumentIdentifierRequest?: UpdateInstrumentIdentifierRequest) : Promise<{ response: http.ClientResponse; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
     ...
     */
    public upsertInstruments (requestBody?: { [key: string]: InstrumentDefinition; }) : Promise<{ response: http.ClientResponse; body: UpsertInstrumentsResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: UpsertInstrumentsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public upsertInstrumentsProperties (upsertInstrumentPropertyRequest?: Array<UpsertInstrumentPropertyRequest>) : Promise<{ response: http.ClientResponse; body: UpsertInstrumentPropertiesResponse;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: UpsertInstrumentPropertiesResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
