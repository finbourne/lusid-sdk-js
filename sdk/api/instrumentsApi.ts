...
export class InstrumentsApi {
     ...
     */
    public async findInstruments (effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>, aliases?: Array<Property>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrument;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(aliases, "Array<Property>")
        };
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    public async getInstrument (identifierType: string, identifier: string, effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async getInstrumentIdentifiers (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfString;  }> {
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    public async getInstruments (identifierType: string, identifiers: Array<string>, effectiveAt?: Date, asAt?: Date, instrumentPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetInstrumentsResponse;  }> {
     ...
     * @param instrumentPropertyKeys Optional. Keys of the properties to be decorated on to the instrument
     */
    public async listInstruments (asAt?: Date, effectiveAt?: Date, page?: string, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrument;  }> {
     ...
     * @param identifiers The identifiers of the instruments to get
     */
    public async matchInstruments (identifierType?: string, identifiers?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MatchInstrumentsResponse;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: MatchInstrumentsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
