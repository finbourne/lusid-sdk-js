...
export class InstrumentsApi {
     ...
     */
    public async getInstrumentIdentifiers (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrumentIdTypeDescriptor;  }> {
