...
export class InstrumentsApi {
     ...
     * @param dataModelScope The optional scope of a Custom Data Model to use.
     * @param dataModelCode The optional code of a Custom Data Model to use.
     * @param timelineScope The optional scope of a timeline to use for post-close activity.
     * @param timelineCode The optional code of a timeline to use for post-close activity.
     * @param closedPeriodId The optional id of a closed period within the timeline to view.
     */
    public async getInstrument (identifierType: string, identifier: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, scope?: string, relationshipDefinitionIds?: Array<string>, dataModelScope?: string, dataModelCode?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
     ...
     * @param dataModelCode The optional code of a Custom Data Model to use.
     */
    public async getInstruments (identifierType: string, requestBody: Array<string>, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, scope?: string, relationshipDefinitionIds?: Array<string>, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetInstrumentsResponse;  }> {
     ...
     * @param timelineScope The scope of the timeline to use for PCA (Post Close Activity) support.
     * @param timelineCode The code of the timeline to use for PCA (Post Close Activity) support.
     * @param closedPeriodId The id of the closed period on the timeline to use for PCA (Post Close Activity) support.
     */
    public async listInstruments (asAt?: Date, effectiveAt?: string, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>, scope?: string, relationshipDefinitionIds?: Array<string>, dataModelScope?: string, dataModelCode?: string, membershipType?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfInstrument;  }> {
