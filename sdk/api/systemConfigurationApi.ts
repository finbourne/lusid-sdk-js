...
export class SystemConfigurationApi {
     ...
     */
    public createConfigurationTransactionType (transactionConfigurationDataRequest?: TransactionConfigurationDataRequest) : Promise<{ response: http.ClientResponse; body: ResourceListOfTransactionConfigurationData;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfTransactionConfigurationData;  }>((resolve, reject) => {
     ...
     */
    public listConfigurationTransactionTypes () : Promise<{ response: http.ClientResponse; body: ResourceListOfTransactionConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * @param transactionConfigurationDataRequest The complete set of transaction type definitions
     */
    public setConfigurationTransactionTypes (transactionConfigurationDataRequest?: Array<TransactionConfigurationDataRequest>) : Promise<{ response: http.ClientResponse; body: ResourceListOfTransactionConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(transactionConfigurationDataRequest, "Array<TransactionConfigurationDataRequest>")
        };
