...
export class RelationalDatasetDefinitionApi {
     ...
     * @summary [EARLY ACCESS] UpdateRelationalDatasetDetails: Update Relational Dataset Details: DisplayName, Description and ApplicableEntityTypes
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     ...
     * @summary [EARLY ACCESS] UpdateRelationalDatasetFieldSchema: Update Relational Dataset Field Schema
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
