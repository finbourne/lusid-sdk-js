...
export class RelationalDatasetDefinitionApi {
     ...
     * @summary CreateRelationalDatasetDefinition: Create a Relational Dataset Definition
     ...
     * @summary DeleteRelationalDatasetDefinition: Delete a Relational Dataset Definition
     ...
     * @summary GetRelationalDatasetDefinition: Get a Relational Dataset Definition
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     ...
     * @summary ListRelationalDatasetDefinitions: List Relational Dataset Definitions
     ...
     * @summary UpdateRelationalDatasetDefinition: Update a Relational Dataset Definition
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     ...
     * @summary UpdateRelationalDatasetDetails: Update Relational Dataset Details: DisplayName, Description and ApplicableEntityTypes
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     * @param updateRelationalDatasetDetails The updated details of the relational dataset.
     */
    public async updateRelationalDatasetDetails (scope: string, code: string, updateRelationalDatasetDetails?: UpdateRelationalDatasetDetails, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelationalDatasetDefinition;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasetdefinitions/{scope}/{code}/details/$update'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateRelationalDatasetDetails.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateRelationalDatasetDetails.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateRelationalDatasetDetails, "UpdateRelationalDatasetDetails")
        };
     ...
     * @summary UpdateRelationalDatasetFieldSchema: Update Relational Dataset Field Schema
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     * @param updateRelationalDatasetFieldSchema Relational dataset fields to add, update or remove.
     */
    public async updateRelationalDatasetFieldSchema (scope: string, code: string, updateRelationalDatasetFieldSchema?: UpdateRelationalDatasetFieldSchema, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelationalDatasetDefinition;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasetdefinitions/{scope}/{code}/fieldschema/$update'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateRelationalDatasetFieldSchema.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateRelationalDatasetFieldSchema.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateRelationalDatasetFieldSchema, "UpdateRelationalDatasetFieldSchema")
        };
