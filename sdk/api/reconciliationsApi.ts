...
export class ReconciliationsApi {
     ...
     */
    public reconcileHoldings (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, portfoliosReconciliationRequest?: PortfoliosReconciliationRequest) : Promise<{ response: http.ClientResponse; body: ResourceListOfReconciliationBreak;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: ResourceListOfReconciliationBreak;  }>((resolve, reject) => {
     ...
     */
    public reconcileValuation (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, valuationsReconciliationRequest?: ValuationsReconciliationRequest) : Promise<{ response: http.ClientResponse; body: ResourceListOfReconciliationBreak;  }> {
