...
import { PagedResourceListOfGetSubscriptionResponse } from '../model/pagedResourceListOfGetSubscriptionResponse';
import { UpsertSingleStructuredDataResponse } from '../model/upsertSingleStructuredDataResponse';
import { UpsertSubscriptionRequest } from '../model/upsertSubscriptionRequest';
...
export class SubscriptionsApi {
     ...
     * @summary [EARLY ACCESS] DeleteSubscription: Delete a Subscription, assuming that it is present.
     * @param scope The scope of the Subscription to delete.
     * @param code The Subscription to delete.
     */
    public async deleteSubscription (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/subscriptions/holdings/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteSubscription.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteSubscription.');
        }
     ...
     * @summary [EARLY ACCESS] GetSubscription: Get Subscription
     * @param scope The scope of the Subscription to retrieve.
     * @param code The code of the Subscription to retrieve.
     * @param asAt The asAt datetime at which to retrieve the Subscription. Defaults to return the latest version if not specified.
     */
    public async getSubscription (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetSubscriptionResponse;  }> {
        const localVarPath = this.basePath + '/api/subscriptions/holdings/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getSubscription.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getSubscription.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetSubscriptionResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @summary [EARLY ACCESS] ListSubscriptions: List the set of Subscription definitions
     * @param scope The scope to list subscriptions for.
     * @param asAt The asAt datetime at which to list the subscriptions. Defaults to latest if not specified.
     ...
     */
    public async listSubscriptions (scope: string, asAt?: Date, filter?: string, limit?: number, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetSubscriptionResponse;  }> {
        const localVarPath = this.basePath + '/api/subscriptions/holdings/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling listSubscriptions.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetSubscriptionResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfGetSubscriptionResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpsertSubscription: Upsert a Subscription. This creates or updates the subscription definition in LUSID.
     * @param upsertSubscriptionRequest The Subscription to update or insert
     */
    public async upsertSubscription (upsertSubscriptionRequest: UpsertSubscriptionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/subscriptions/holdings';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'upsertSubscriptionRequest' is not null or undefined
        if (upsertSubscriptionRequest === null || upsertSubscriptionRequest === undefined) {
            throw new Error('Required parameter upsertSubscriptionRequest was null or undefined when calling upsertSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertSubscriptionRequest, "UpsertSubscriptionRequest")
        };
