...
export class SubscriptionsApi {
    ...
    public async deleteSubscription (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/subscriptions/{scope}/{code}'
    ...
    public async listSubscriptions (scope: string, asAt?: Date, filter?: string, limit?: number, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetSubscriptionResponse;  }> {
        const localVarPath = this.basePath + '/api/subscriptions/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
    ...
    public async upsertSubscription (upsertSubscriptionRequest: UpsertSubscriptionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/subscriptions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
