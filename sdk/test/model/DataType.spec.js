...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.DataType();
  });
  ...
  describe('DataType', function() {
    it('should create an instance of DataType', function() {
      ...
      //var instance = new LusidSdk.DataType();
      //expect(instance).to.be.a(LusidSdk.DataType);
    });
    ...
    it('should have the property typeValueRange (base name: "typeValueRange")', function() {
      // uncomment below and update the code to test the property typeValueRange
      //var instance = new LusidSdk.DataType();
      //expect(instance).to.be();
    });
    ...
    it('should have the property acceptableValues (base name: "acceptableValues")', function() {
      // uncomment below and update the code to test the property acceptableValues
      //var instance = new LusidSdk.DataType();
      //expect(instance).to.be();
    });

    it('should have the property unitSchema (base name: "unitSchema")', function() {
      // uncomment below and update the code to test the property unitSchema
      //var instance = new LusidSdk.DataType();
      //expect(instance).to.be();
    });

    it('should have the property acceptableUnits (base name: "acceptableUnits")', function() {
      // uncomment below and update the code to test the property acceptableUnits
      //var instance = new LusidSdk.DataType();
      //expect(instance).to.be();
    });
