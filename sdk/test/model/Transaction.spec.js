...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.LusidSdk);
  }
}(this, function(expect, LusidSdk) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new LusidSdk.Transaction();
  });
  ...
  describe('Transaction', function() {
    it('should create an instance of Transaction', function() {
      ...
      //var instance = new LusidSdk.Transaction();
      //expect(instance).to.be.a(LusidSdk.Transaction);
    });
    ...
    it('should have the property instrumentIdentifiers (base name: "instrumentIdentifiers")', function() {
      // uncomment below and update the code to test the property instrumentIdentifiers
      //var instance = new LusidSdk.Transaction();
      //expect(instance).to.be();
    });

    it('should have the property instrumentUid (base name: "instrumentUid")', function() {
      // uncomment below and update the code to test the property instrumentUid
      //var instance = new LusidSdk.Transaction();
      //expect(instance).to.be();
    });
    ...
    it('should have the property totalConsideration (base name: "totalConsideration")', function() {
      // uncomment below and update the code to test the property totalConsideration
      //var instance = new LusidSdk.Transaction();
      //expect(instance).to.be();
    });
    ...
    it('should have the property counterpartyId (base name: "counterpartyId")', function() {
      // uncomment below and update the code to test the property counterpartyId
      //var instance = new LusidSdk.Transaction();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nettingSet (base name: "nettingSet")', function() {
      // uncomment below and update the code to test the property nettingSet
      //var instance = new LusidSdk.Transaction();
      //expect(instance).to.be();
    });
