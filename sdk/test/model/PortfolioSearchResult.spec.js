...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.PortfolioSearchResult();
  });
  ...
  describe('PortfolioSearchResult', function() {
    it('should create an instance of PortfolioSearchResult', function() {
      // uncomment below and update the code to test PortfolioSearchResult
      //var instance = new LusidSdk.PortfolioSearchResult();
      //expect(instance).to.be.a(LusidSdk.PortfolioSearchResult);
    });
    ...
    it('should have the property isDerived (base name: "isDerived")', function() {
      // uncomment below and update the code to test the property isDerived
      //var instance = new LusidSdk.PortfolioSearchResult();
      //expect(instance).to.be();
    });
    ...
    it('should have the property parentPortfolioId (base name: "parentPortfolioId")', function() {
      // uncomment below and update the code to test the property parentPortfolioId
      //var instance = new LusidSdk.PortfolioSearchResult();
      //expect(instance).to.be();
    });
